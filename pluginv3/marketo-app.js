          ...
          if (mktoLogo1
            ...
            if (mktoLogo1) {
              if (mktoLogo1.style.width == "auto") {
                ...
                console.log("Marketo App > Overlaying: Landing Page Company Logo 1 Max Height = " + mktoLogo1.style.height);
                ...
                console.log("Marketo App > Overlaying: Landing Page Company Logo 1 Max Width = " + mktoLogo1.style.width);
              } else if (mktoLogo1.width == "auto") {
                mktoLogo1.style.setProperty("max-height", mktoLogo1.height + "px");
                mktoLogo1.style.setProperty("width", "auto");
                console.log("Marketo App > Overlaying: Landing Page Company Logo 1 Max Height = " + mktoLogo1.height);
              } else if (mktoLogo1.height == "auto") {
                mktoLogo1.style.setProperty("max-width", mktoLogo1.width + "px");
                mktoLogo1.style.setProperty("height", "auto");
                console.log("Marketo App > Overlaying: Landing Page Company Logo 1 Max Width = " + mktoLogo1.width);
              } else {
                mktoLogo1.style.setProperty("max-height", mktoLogo1.height + "px");
                mktoLogo1.style.setProperty("width", "auto");
                console.log("Marketo App > Overlaying: Landing Page Company Logo 1 Max Height = " + mktoLogo1.height);
            ...
            if (mktoLogo2) {
              if (mktoLogo2.style.width == "auto") {
                ...
                console.log("Marketo App > Overlaying: Landing Page Company Logo 2 Max Height = " + mktoLogo2.style.height);
                ...
                console.log("Marketo App > Overlaying: Landing Page Company Logo 2 Max Width = " + mktoLogo2.style.width);
              } else if (mktoLogo2.width == "auto") {
                mktoLogo2.style.setProperty("max-height", mktoLogo2.height + "px");
                mktoLogo2.style.setProperty("width", "auto");
                console.log("Marketo App > Overlaying: Landing Page Company Logo 2 Max Height = " + mktoLogo2.height);
              } else if (mktoLogo2.height == "auto") {
                mktoLogo2.style.setProperty("max-width", mktoLogo2.width + "px");
                mktoLogo2.style.setProperty("height", "auto");
                console.log("Marketo App > Overlaying: Landing Page Company Logo 2 Max Width = " + mktoLogo2.width);
              } else {
                mktoLogo2.style.setProperty("max-height", mktoLogo2.height + "px");
                mktoLogo2.style.setProperty("width", "auto");
                console.log("Marketo App > Overlaying: Landing Page Company Logo 2 Max Height = " + mktoLogo2.height);
          ...
          if (mktoLogo1
            ...
            if (mktoLogo1) {
              if (mktoLogo1.style.width == "auto") {
                mktoLogo1.style.setProperty("max-height", mktoLogo1.style.height);
                mktoLogo1.style.setProperty("width", "auto");
                console.log("Marketo App > Overlaying: Email 2.0 Company Logo 1 Max Height = " + mktoLogo1.style.height);
              } else if (mktoLogo1.style.height == "auto") {
                mktoLogo1.style.setProperty("max-width", mktoLogo1.style.width);
                mktoLogo1.style.setProperty("height", "auto");
                console.log("Marketo App > Overlaying: Email 2.0 Company Logo 1 Max Width = " + mktoLogo1.style.width);
              } else if (mktoLogo1.width == "auto") {
                mktoLogo1.style.setProperty("max-height", mktoLogo1.height + "px");
                mktoLogo1.style.setProperty("width", "auto");
                console.log("Marketo App > Overlaying: Email 2.0 Company Logo 1 Max Height = " + mktoLogo1.height);
              } else if (mktoLogo1.height == "auto") {
                mktoLogo1.style.setProperty("max-width", mktoLogo1.width + "px");
                mktoLogo1.style.setProperty("height", "auto");
                console.log("Marketo App > Overlaying: Email 2.0 Company Logo 1 Max Width = " + mktoLogo1.width);
              } else {
                mktoLogo1.style.setProperty("max-height", mktoLogo1.height + "px");
                mktoLogo1.style.setProperty("width", "auto");
                console.log("Marketo App > Overlaying: Email 2.0 Company Logo 1 Max Height = " + mktoLogo1.height);
            ...
            if (mktoLogo2) {
              if (mktoLogo2.style.width == "auto") {
                mktoLogo2.style.setProperty("max-height", mktoLogo2.style.height);
                mktoLogo2.style.setProperty("width", "auto");
                console.log("Marketo App > Overlaying: Email 2.0 Company Logo 2 Max Height = " + mktoLogo2.style.height);
              } else if (mktoLogo2.style.height == "auto") {
                mktoLogo2.style.setProperty("max-width", mktoLogo2.style.width);
                mktoLogo2.style.setProperty("height", "auto");
                console.log("Marketo App > Overlaying: Email 2.0 Company Logo 2 Max Width = " + mktoLogo2.style.width);
              } else if (mktoLogo2.width == "auto") {
                mktoLogo2.style.setProperty("max-height", mktoLogo2.height + "px");
                mktoLogo2.style.setProperty("width", "auto");
                console.log("Marketo App > Overlaying: Email 2.0 Company Logo 2 Max Height = " + mktoLogo2.height);
              } else if (mktoLogo2.height == "auto") {
                mktoLogo2.style.setProperty("max-width", mktoLogo2.width + "px");
                mktoLogo2.style.setProperty("height", "auto");
                console.log("Marketo App > Overlaying: Email 2.0 Company Logo 2 Max Width = " + mktoLogo2.width);
              } else {
                mktoLogo2.style.setProperty("max-height", mktoLogo2.height + "px");
                mktoLogo2.style.setProperty("width", "auto");
                console.log("Marketo App > Overlaying: Email 2.0 Company Logo 2 Max Height = " + mktoLogo2.height);
