...
APP.overrideHomeTiles = function (restoreEmailInsightsTile) {
  ...
  if (typeof(MktCanvas) !== "undefined"
    ...
    if (!nextGenUxTile) {
      ...
      nextGenUxTileEl.innerHTML = '<em id="nextGenUxTile-btnWrap"><a id="nextGenUxTile-btnEl" href="' + "https://marketo.invisionapp.com/share/V2FQQBSYUPX" + '" class="x4-btn-center" target="_blank" role="link" style="width: 150px; height: 150px;"><span id="nextGenUxTile-btnInnerEl" class="x4-btn-inner" style="width: 150px; height: 150px; line-height: 150px;">Next Gen UX</span><span id="nextGenUxTile-btnIconEl" class="x4-btn-icon mki3-mercury-svg"></span></a></em>';
