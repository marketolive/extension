...
APP.waitForResults = function (callback) {
  var isGoogleSearchDone = window.setInterval(function () {
    if (
      ...
      (document.getElementById('tads') && document.getElementById('tads').getElementsByClassName('uEierd').length > 0)
    ) {
...
APP.insertAd = function (ad) {
  ...
  if (document.getElementById('tads')) {
    ...
    var adSection = document.getElementById('tads').getElementsByClassName('uEierd')[0],
      ...
      adHtml =
        '<div><div class="cUezCb luh4tb O9g5cc uUPGi"><div class="d5oMvf"><a class="Krnil" href="' +
        ad.link +
        '"><br><div class="cfxYMc JfZTW c4Djg MUxGbd v0nnCb" role="heading">' +
        ad.title +
        '</div><div class="abuKkc"><span class="jpu5Q VqFMTc p8AiDd">Ad<span style="padding:0 5px">·</span></span><span class="Zu0yb LWAWHf qzEoUe">' +
        ad.linkText +
        '</span><span class="NVWord e1ycic"></span></div></a><div class="abuKkc zMz9yb"><span class="jpu5Q NVWord VqFMTc p8AiDd">Ad<span style="padding:0 5px">·</span></span><span class="Zu0yb LWAWHf NVWord qzEoUe">' +
        ad.linkText +
        '</span><span class="e1ycic"><span jscontroller="PekE8b" id="aiis1" class="aii"><g-dropdown-menu jscontroller="DqdCgd"><g-popup><div jsname="oYxtQd" class="rIbAWc hide-focus-ring"><div class="YMEk9e TxG06d" title="Why this ad?" aria-label="Why this ad?" role="button" tabindex="0"><span class="YauQSc"></span></div></div></g-popup></g-dropdown-menu></span></span></div></div><div><div class="MUxGbd yDYNvb lyLwlc"><span>' +
        ad.text +
  ...
  if (numOfBottomLinks > 0) {
    ...
    for (var ii = 1; ii < adTextSplit.length; ii++) {
      adHtml +=
        '<div style="border-color: rgb(84, 84, 84); color: rgb(84, 84, 84); font-family: Roboto, arial, sans-serif; font-size: 13px; height: 18px; line-height: 18px; list-style-type: none; outline-color: rgb(84, 84, 84); overflow: hidden; text-align: left; text-decoration: none solid rgb(84, 84, 84); text-overflow: ellipsis; white-space: nowrap; width: 600px; column-rule-color: rgb(84, 84, 84); -webkit-locale: &quot;en&quot;; perspective-origin: 300px 9px; -webkit-text-emphasis-color: rgb(84, 84, 84); -webkit-text-fill-color: rgb(84, 84, 84); -webkit-text-stroke-color: rgb(84, 84, 84); transform-origin: 300px 9px 0px; caret-color: rgb(84, 84, 84);">' +
        adTextSplit[ii] +
        '</div>'
    }
