...
APP.insertAd = function (ad) {
  ...
  if (document.getElementById("tads")) {
    ...
    adHtml = '<h3><a href="' + ad.link + '" id="ad-link" class="r-iClGEAjvi27Y">' + ad.title + '</a></h3><div class="ads-visurl"><span class="Z98Wse">Ad</span><cite id="ad-link-text" class="_WGk">' + ad.linkText + '</cite><g-bubble class="action-menu ab_ctl r-iHprqp_90NYo"><a href="#" class="g-bbll"><span class="mn-dwn-arw"></span></a></g-bubble></div><div id="ad-main-text" class="ellip ads-creative">' + adTextSplit[0] + '</div>',
    bottomLinksHtml = '';
