...
function reloadCompany(webRequest){console.log("Background > Reloading: Company Logo & Color");var setAssetData,queryInfo={"currentWindow":true,"url":mktoDesignerMatchPattern},message={"action":"newCompany","assetType":"","assetView":""};setAssetData=function(tab){if(tab.url.search("#"+mktoEmailDesignerFragment+"[0-9]+$")!=-1){count=0;message.assetType="email";message.assetView="edit";}
