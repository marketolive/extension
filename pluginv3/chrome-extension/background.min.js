...
function reloadCompany(tabId){console.log("Background > Reloading: Company Logo & Color");var queryInfo={"currentWindow":true,"url":mktoDesignerMatchPattern},message={"action":"newCompany","assetType":"","assetView":""};if(tabId){chrome.tabs.get(tabId,function(tab){if(tab.url.search("#"+mktoEmailDesignerFragment+"[0-9]+$")!=-1){message.assetType="email";message.assetView="edit";}
else if(tab.url.search("#"+mktoEmailPreviewFragmentRegex)!=-1||tab.url.search("#"+mktoEmailPreviewFragment+"[0-9]+$")!=-1){message.assetType="email";message.assetView="preview";}
