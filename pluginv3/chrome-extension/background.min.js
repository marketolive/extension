...
function reloadCompany(tabId){console.log("Background > Reloading: Company Logo & Color");var queryInfo={"currentWindow":true,"url":mktoDesignerMatchPattern},message={"action":"newCompany","assetType":"","assetView":""};if(tabId){chrome.tabs.get(tabId,function(tab){console.log("Background > Getting Tab: "+tab.url);if(tab.url.search("#"+mktoEmailDesignerFragment+"[0-9]+$")!=-1){message.assetType="email";message.assetView="edit";}
