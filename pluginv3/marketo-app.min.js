...
APP.overrideDeliverabilityToolsMenuItem=function(){console.log("Marketo App > Overriding: Deliverability Superball Menu Item");var superBallMenuItems,currSuperBallMenuItemSpanTags,currSuperBallMenuItemAtags,deliverabilityToolsMenuItem,communityMenuItemNum,communityMenuItemSpanTags,communityMenuItemAtags,ii,jj;MktPage.showSuperMenu();if(MktCanvas.getEl().dom.ownerDocument.body.childNodes[17].id=="ext4-ext-gen1024"){superBallMenuItems=MktCanvas.getEl().dom.ownerDocument.body.childNodes[17].childNodes[1].childNodes[0].childNodes[1].childNodes[1].childNodes;}
...
communityMenuItemAtags=superBallMenuItems[communityMenuItemNum].getElementsByTagName("a");for(jj=0;jj<communityMenuItemAtags.length;jj++){if(communityMenuItemAtags[jj].href.search("/guide/displaySuccessContent\\?contentTag=main_MarketoCommunityHome$")!=-1){communityMenuItemAtags[jj].href="https://250ok.com/login";break;}}}}
