...
if(deliverabilityToolsMenuItem){deliverabilityToolsMenuItem.href=mktoEmailDeliverabilityToolsLink;deliverabilityToolsMenuItem.onclick=function(){APP.heapTrack("track",{name:"Deliverability Tools",assetName:"Demo Account",assetType:"Home Tile"});};deliverabilityToolsMenuItem.update();}else{clonedMenuItem=menu.items.items[0].cloneConfig();clonedMenuItem.setText("Deliverability Tools");clonedMenuItem.setIconCls("mki3-mail-sealed-svg");clonedMenuItem.href=mktoEmailDeliverabilityToolsLink;clonedMenuItem.hrefTarget="_blank";clonedMenuItem.onclick=function(){APP.heapTrack("track",{name:"Deliverability Tools",assetName:"Demo Account",assetType:"Home Tile"});};clonedMenuItem.update();menu.add(clonedMenuItem);}}}
