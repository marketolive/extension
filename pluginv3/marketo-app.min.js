...
else{console.log("Marketo App > Location: Designers/Wizards");switch(currCompFragment){case mktoEmailDesignerFragment:if(currUrlFragment.search(mktoEmailPreviewFragmentRegex)==-1){console.log("Marketo App > Location: Email Editor");APP.disableDesignerSaving("email","edit");}
else{console.log("Marketo App > Location: Email Previewer");APP.disableDesignerSaving("email","preview");}
break;case mktoFormWizardFragment:console.log("Marketo App > Location: Form Wizard");APP.disableDesignerSaving("form","edit");break;case mktoMobilePushNotificationWizardFragment:console.log("Marketo App > Location: Push Notification Wizard");APP.disableDesignerSaving("pushNotification","edit");break;case mktoInAppMessageWizardFragment:console.log("Marketo App > Location: In-App Message Wizard");APP.disableDesignerSaving("inAppMessage","edit");break;case mktoSocialAppWizardFragment:console.log("Marketo App > Location: Social App Wizard");APP.disableDesignerSaving("socialApp","edit");break;case mktoSmsMessageDesignerFragment:console.log("Marketo App > Location: SMS Message Editor");APP.disableDesignerSaving("smsMessage","edit");break;case mktoABtestWizardFragment:console.log("Marketo App > Location: A/B Test Wizard");APP.disableDesignerSaving("abTest");break;case mktoEmailTestWizardFragment:console.log("Marketo App > Location: Email Test Group Wizard");APP.disableDesignerSaving("abTest");break;default:break;}}
