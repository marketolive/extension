...
heapEvent.workspaceName=APP.getWorkspaceName(assetNode.accessZoneId);if(assetNode.accessZoneId.toString().search(mktoGoldenWorkspacesMatch)!=-1){heapEvent.name=heapEvent.workspaceName;if(heapEvent.workspaceName=="Admin"){heapEvent.workspaceId=0;}}else if(assetNode.accessZoneId==mktoUserWorkspaceId){heapEvent.name=heapEvent.workspaceName;heapEvent.userFolder=userName;}else{heapEvent.name="User's Workspace"}
