...
break;case mktoLandingPageDesignerFragment:console.log("Callback for email editor");Ext4.getStore('LandingPage').load(lpParameters);break;case mktoFormWizardFragment:console.log("Callback for form editor");Ext4.getStore('Form').load(loadParameters);break;case mktoMobilePushNotificationWizardFragment:console.log("Callback for push editor");Ext4.getStore('MobilePushNotification').load(loadParameters);break;case mktoSocialAppWizardFragment:console.log("Callback for social editor");Ext4.getStore('SocialApp').load(loadParameters);break;case mktoABtestWizardFragment:console.log("Callback for social editor");Ext4.getStore('TestGroup').load(loadParameters);break;default:currAssetZoneId=-1;break;}}
