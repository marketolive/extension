...
currNode=currNode.parentNode;}}}
return toBeDisabled;break;}}
APP.disableMenus=function(){console.log("Marketo App > Disabling: Menus");var prevMarketingNewEventMenu=Mkt.app.MarketingActivities.Toolbar.getNewEventMenuButton;Mkt.app.MarketingActivities.Toolbar.getNewEventMenuButton=function(){console.log("Marketo App > Executing: Disabling New menu for Marketing, Nurture, Event, and Email Batch Programs in Marketing Activities");prevMarketingNewEventMenu.apply(this,arguments);return{text:MktLang.getStr('mktMaMenu.New'),iconCls:'mkiBooksBlue',xtype:'mkttbbutton',menu:MktMaMenu.maMenu(),handler:function(button){var canvas=MktCanvas.getActiveTab(),disableMenu=APP.evaluateMenu("button",null,null,canvas,null);button.menu.items.each(function(item){item.setDisabled(disableMenu);});}};}
var prevMarketingNewMenu=Mkt.app.MarketingActivities.Toolbar.getNewMenuButton;Mkt.app.MarketingActivities.Toolbar.getNewMenuButton=function(){console.log("Marketo App > Executing: Disabling New menu for Folders and Smart Campaigns in Marketing Activities");prevMarketingNewMenu.apply(this,arguments);return{text:MktLang.getStr('mktMaMenu.New'),iconCls:'mkiBooksBlue',xtype:'mkttbbutton',menu:MktMaMenu.maMenu(),handler:function(button){var canvas=MktCanvas.getActiveTab(),disableMenu=APP.evaluateMenu("button",null,null,canvas,null);button.menu.items.each(function(item){item.setDisabled(disableMenu);});}};}
var prevDesignNewMenu=Mkt.app.DesignStudio.Toolbar.getNewMenuButton;Mkt.app.DesignStudio.Toolbar.getNewMenuButton=function(){console.log("Marketo App > Executing: Disabling New menu for ALL in Design Studio");prevDesignNewMenu.apply(this,arguments);return{text:MktLang.getStr('mktDsMenu.New'),iconCls:'mkiColorsCmyk',xtype:'mkttbbutton',menu:MktMaMenu.maMenu(),handler:function(button){var canvas=MktCanvas.getActiveTab(),disableMenu=APP.evaluateMenu("button",null,null,canvas,null);button.menu.items.each(function(item){item.setDisabled(disableMenu);});}};}
var prevActionsMenu=Mkt.menus.marketingEvent.Toolbar.preShowMarketingProgramActions;Mkt.menus.marketingEvent.Toolbar.preShowMarketingProgramActions=Mkt.menus.marketingEvent.Toolbar.preShowMarketingEventActions=function(menu){console.log("Marketo App > Executing: Disabling Actions menu for Marketing, Nurture, Event, and Email Batch Programs in Marketing Activities");prevActionsMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("button",null,null,canvas,null),itemsToDisable=["cloneMarketingProgram","cloneMarketingEvent","cloneNurtureProgram","cloneEmailBatchProgram","deleteMarketingProgram","deleteMarketingEvent","deleteNurtureProgram","deleteEmailBatchProgram","testNurtureProgram","eventSchedule","entryRescheduleEntries","sfdcCampaignSync","refreshFromWebinarProvider",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});}
var prevRightClickMenu=MktMaMenu.preShowProgramActionsMenu;MktMaMenu.preShowProgramActionsMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click menu for Marketing, Nurture, Event, and Email Batch Programs in Marketing Activities");prevRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["newSmartCampaign","newLocalAsset","createNewMarketingProgram","createProgramFolder","renameProgramFolder","deleteProgramFolder","convertToArchiveFolder","convertToCampaignFolder","scClone","cloneMarketingProgram","cloneMarketingEvent","cloneNurtureProgram","cloneEmailBatchProgram","scArchive","deleteMarketingProgram","deleteMarketingEvent","deleteNurtureProgram","deleteEmailBatchProgram","scMove","scActivate","scAbort","scClearPalette","scClearSmartList","scClearFlow","shareProgramFolder","progGenerateRef","checkForCorruptEmails"];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevEmailRightClickMenu=MktDsMenu.preShowEmailMenu;MktDsMenu.preShowEmailMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click menu for Emails in Marketing Activities");prevEmailRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["emailApprove","emailUnapprove","emailClone","emailDelete","emailMove","emailNewTest","emailDraftSendTest","emailDraftApprove","emailApproveTest","emailDiscardTest"];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevLandingPageRightClickMenu=MktDsMenu.preShowPageMenu;MktDsMenu.preShowPageMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click menu for Landing Pages in Marketing Activities");prevLandingPageRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["pageApprove","pageUnapprove","pageConvertToTestGroup","pageClone","pageDelete","urlTools","pageMove","pageDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevFormRightClickMenu=MktDsMenu.preShowFormMenu;MktDsMenu.preShowFormMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click menu for Forms in Marketing Activities");prevFormRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["formApprove","formClone","formDelete","formMove","formDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSocialAppRightClickMenu=MktDsMenu.preShowSocialAppMenu;MktDsMenu.preShowSocialAppMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click menu for Social Apps in Marketing Activities");prevSocialAppRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["socialAppApprove","socialAppClone","socialAppDelete","socialAppDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSocialAppActionsMenu=Mkt3.controller.socialApp.SocialApp.prototype.loadToolbar;Mkt3.controller.socialApp.SocialApp.prototype.loadToolbar=function(menu,attr){console.log("Marketo App > Executing: Disabling Actions menu for Social Apps in Marketing Activities");prevSocialAppActionsMenu.apply(this,arguments);var disable=APP.evaluateMenu("socialAppToolbar",null,null,null,this),mItems=Ext4.ComponentQuery.query("socialAppToolbar contextMenu [action=approve],"+"socialAppToolbar contextMenu [action=clone],"+"socialAppToolbar contextMenu [action=delete],"+"socialAppToolbar contextMenu [action=editDraft],"+"socialAppToolbar contextMenu [action=previewDraft],"+"socialAppToolbar contextMenu [action=approveDraft],");mItems.forEach(function(item){if(item){item.setDisabled(disable);}});return menu;}
var prevPushNotificationRightClickMenu=MktDsMenu.preShowPushNotificationMenu;MktDsMenu.preShowPushNotificationMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click menu for Push Notifications in Marketing Activities");prevPushNotificationRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["pushNotificationApprove","pushNotificationUnapprove","pushNotificationDelete","pushNotificationDraftEdit","pushNotificationDraftSendSample","pushNotificationDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevPushNotificationActionsMenu=Mkt3.controller.mobilePushNotification.MobilePushNotification.prototype.loadToolbar;Mkt3.controller.mobilePushNotification.MobilePushNotification.prototype.loadToolbar=function(menu,attr){console.log("Marketo App > Executing: Disabling Actions menu for Push Notifications in Marketing Activities");prevPushNotificationActionsMenu.apply(this,arguments);var disable=APP.evaluateMenu("mobilePushNotification",null,null,null,this),mItems=Ext4.ComponentQuery.query("mobilePushNotification contextMenu [action=approve],"+"mobilePushNotification contextMenu [action=unapprove],"+"mobilePushNotification contextMenu [action=clone],"+"mobilePushNotification contextMenu [action=delete],"+"mobilePushNotification contextMenu [action=editDraft],"+"mobilePushNotification contextMenu [action=sendDraftSample],"+"mobilePushNotification contextMenu [action=approveDraft],");mItems.forEach(function(item){if(item){item.setDisabled(disable);}});return menu;}
var prevDesignStudioContextMenu=MktDsMenu.preShowContextMenu;MktDsMenu.preShowContextMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click menu for ALL in Design Studio");prevDesignStudioContextMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["newLandingPage","newTestGroup","newPageTemplate","pageTemplateImport","newForm","newVideoShare","newShareButton","newReferralOffer","newEmail","newEmailTemplate","newSnippet","uploadImage","share","createFolder","renameFolder","deleteFolder","convertToArchiveFolder","convertToFolder",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevLandingPageTemplateMenu=MktDsMenu.preShowTemplateMenu;MktDsMenu.preShowTemplateMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click and Actions menus for Landing Page Templates in Design Studio");prevLandingPageTemplateMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["approvePageTemplate","unapprovePageTemplate","clonePageTemplate","pageTemplateDelete","approveDraftPageTemplate",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevEmailTemplateMenu=MktDsMenu.preShowEmailTemplateMenu;MktDsMenu.preShowEmailTemplateMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click and Actions menus for Email Templates in Design Studio");prevEmailTemplateMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["emailTemplateApprove","emailTemplateUnapprove","emailTemplateClone","emailTemplateDelete","emailTemplateDraftSendTest","emailTemplateDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSnippetMenu=MktDsMenu.preShowSnippetMenu;MktDsMenu.preShowSnippetMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click and Actions menus for Snippets in Design Studio");prevSnippetMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["snippetApprove","snippetUnapprove","snippetClone","snippetDelete","snippetDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevImageMenu=MktDsMenu.preShowImageMenu;MktDsMenu.preShowImageMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click and Actions menus for Images in Design Studio");prevImageMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["uploadImage","imageDelete","replaceImage",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
...
var prevLeadDatabaseContextMenu=MktLeadDbMenu.preShowContextMenu;MktLeadDbMenu.preShowContextMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click menu for System Smart Lists, Smart Lists, Lists, Segments in Lead Database");prevLeadDatabaseContextMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["cloneSmartlist","cloneList","deleteList","showSupportHistory","showSupportUsagePerf","showSmartListProcessorDiag","showSmartListProcessorOverride",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevListMenu=MktLeadDbMenu.preShowListListMenu;MktLeadDbMenu.preShowListListMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click and Actions menus for Lists in Lead Database");prevListMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["cloneSmartlist","cloneList","deleteList","showSupportHistory","showSupportUsagePerf","showSmartListProcessorDiag","showSmartListProcessorOverride",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSegmentationMenu=MktLeadDbMenu.preShowSegmentationMenu;MktLeadDbMenu.preShowSegmentationMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click and Actions menus for Segmentations in Lead Database");prevSegmentationMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["createDraftSegmentation","approveSegmentation","unapproveSegmentation","deleteSegmentation","approveDraftSegmentation",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSegmentationFolderMenu=MktLeadDbMenu.preShowSegmentationFolderMenu;MktLeadDbMenu.preShowSegmentationFolderMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click and Actions menus for Segmentation Folders in Lead Database");prevSegmentationFolderMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["newSegmentation","share","createFolder","renameFolder","deleteFolder","convertToArchiveFolder","convertToFolder",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSmartListMenu=MktLeadDbMenu.preShowUserListMenu;MktLeadDbMenu.preShowUserListMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click and Actions menus for Smart Lists and Segments in Lead Database");prevSmartListMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["cloneSmartlist","cloneList","deleteList",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevReportMenu=MktAnalyticsMenu.preShowReportMenu;MktAnalyticsMenu.preShowReportMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click menu for Analyzers and Reports in Analytics");prevReportMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["cloneReport","deleteReport","moveReport",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevReportFolderMenu=MktAnalyticsMenu.preshowReportFolderMenu;MktAnalyticsMenu.preshowReportFolderMenu=function(menu,attr){console.log("Marketo App > Executing: Disabling Right-click menu for Folders in Analytics");prevReportFolderMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=APP.evaluateMenu("tree",attr,menu,canvas,null),itemsToDisable=["createFolder","renameFolder","deleteFolder","convertToArchiveFolder","convertToFolder","newRcm","share","moveReport",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
Mkt.widgets.ToolbarButton.prototype.showMenu=function(){console.log("Marketo App > Executing: Disabling Toolbar Button menus for ALL assets except for Social Apps and Push Notifications in ALL");var canvas=MktCanvas.getActiveTab();if(APP.evaluateMenu("button",null,null,canvas,null)){var ii;if(this.menu.itemId=="leadDbLeadMenu"){for(ii=0;ii<this.menu.items.items.length;ii++){if(typeof(this.menu.items.items[ii].menu)!="undefined"){var jj;for(jj=0;jj<this.menu.items.items[ii].menu.items.items.length;jj++){this.menu.items.items[ii].menu.items.items[jj].disable(true);}}}}
