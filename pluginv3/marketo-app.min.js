...
heapEvent.name=heapEventName;heapTrack("track",heapEvent);}};var heapTrack=function(action,event){var isHeapAnalytics=window.setInterval(function(){if(typeof(heap)!=="undefined"){console.log("Marketo App > Loaded: Heap Analytics");window.clearInterval(isHeapAnalytics);switch(action){case"id":var oneLoginEmail=APP.getCookie("onelogin_email"),oneLoginFirstName=APP.getCookie("onelogin_first_name"),oneLoginLastName=APP.getCookie("onelogin_last_name");if(oneLoginEmail){heap.identify(oneLoginEmail);}
