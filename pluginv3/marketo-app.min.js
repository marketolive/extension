...
chrome.runtime.sendMessage(extensionId,{action:"setMktoCookies",mktoUserId:MktPage.userid,mktoName:MktPage.userName.replace(/ ?\[[^\]]+\]/,""),mktoRole:mktoRole});if(MktPage.userid=="lmcrae.demo@marketo.com"){chrome.runtime.sendMessage(extensionId,{action:"mktoLiveMessage",id:"Louis Stinks",title:"Louis Loves Eggplants",notify:"Why does Louis love eggplants, I don't know!",requireInteraction:true});}}
