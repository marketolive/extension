...
APP.overlayEmail=function(action){console.log("Marketo App > Overlaying: Email");var isEmailEditor2,clearOverlayVars,overlay,isMktoImgReplaced=isMktoTextReplaced=isMktoSubTextReplaced=isMktoButtonReplaced=isMktoEmail1Replaced=editorPrevReady=isDesktopPreviewReplaced=isPhonePreviewReplaced=false,dayNames=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],monthNames=["JAN","FEB","MAR","APR","MAY","JUNE","JULY","AUG","SEPT","OCT","NOV","DEC"],date=new Date(),dayOfWeek=dayNames[date.getDay()],month=monthNames[date.getMonth()],dayOfMonth,year=date.getFullYear(),logoMktoNameRegex=new RegExp("logo","i"),mainTitleMktoNameRegex=new RegExp("main title|mainTitle|main-title","i"),subTitleMktoNameRegex=new RegExp("subtitle|sub-title","i"),buttonTextRegex=new RegExp("signup|sign up|call to action|cta","i"),logo=APP.getCookie("logo"),color=APP.getCookie("color"),company,companyName,loopCount=0,editorRepeatReadyCount=0,emailDesktopPreviewCount=0,emailPhonePreviewCount=0;switch(date.getDate()){case 1:dayOfMonth="1st";break;case 2:dayOfMonth="2nd";break;case 3:dayOfMonth="3rd";break;default:dayOfMonth=date.getDate()+"th";break;}
...
return false;}
isEmailEditor2=window.setInterval(function(){if(action=="edit"){console.log("Marketo App > Overlaying: Email Editor");if(document.getElementsByTagName("iframe")[0]&&document.getElementsByTagName("iframe")[0].contentWindow&&document.getElementsByTagName("iframe")[0].contentWindow.document&&document.getElementsByTagName("iframe")[0].contentWindow.document.readyState=="complete"){if(overlay(document.getElementsByTagName("iframe")[0].contentWindow.document)||editorRepeatReadyCount>=5000){console.log("Marketo App > Overlayed: Email Editor = "+editorRepeatReadyCount);console.log("Marketo App > Overlaying: Email Interval is Cleared");window.clearInterval(isEmailEditor2);clearOverlayVars();editorRepeatReadyCount=0;}
...
else if(action=="preview"){console.log("Marketo App > Overlaying: Email Previewer");if(!isDesktopPreviewReplaced&&document.getElementsByTagName("iframe")[2]&&document.getElementsByTagName("iframe")[2].contentWindow&&document.getElementsByTagName("iframe")[2].contentWindow.document&&document.getElementsByTagName("iframe")[2].contentWindow.document.readyState=="complete"){emailDesktopPreviewCount++;if(overlay(document.getElementsByTagName("iframe")[2].contentWindow.document)){console.log("Marketo App > Overlayed: Email Desktop Preview = "+emailDesktopPreviewCount);isDesktopPreviewReplaced=true;emailDesktopPreviewCount=0;}}
if(!isPhonePreviewReplaced&&document.getElementsByTagName("iframe")[3]&&document.getElementsByTagName("iframe")[3].contentWindow&&document.getElementsByTagName("iframe")[3].contentWindow.document&&document.getElementsByTagName("iframe")[3].contentWindow.document.readyState=="complete"){emailPhonePreviewCount++;if(overlay(document.getElementsByTagName("iframe")[3].contentWindow.document)){console.log("Marketo App > Overlayed: Email Phone Preview = "+emailPhonePreviewCount);isPhonePreviewReplaced=true;emailPhonePreviewCount=0;}}
if((isPhonePreviewReplaced&&isDesktopPreviewReplaced)||loopCount>6000){console.log("Marketo App > Overlaying: Email Interval is Cleared");window.clearInterval(isEmailEditor2);clearOverlayVars();}}},0);}
