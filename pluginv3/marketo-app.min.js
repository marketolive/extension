...
overlay=function(emailDocument){var em=emailDocument;console.log(emailDocument);if(emailDocument!=null){var emailBody=emailDocument.getElementsByTagName("body")[0],logoSwapCompany=emailDocument.getElementById("logo-swap-company"),logoSwapContainer=emailDocument.getElementById("logo-swap-container"),logoSwapCompanyContainer=emailDocument.getElementById("logo-swap-company-container"),logoBkg=emailDocument.getElementById("logo-bkg"),buttonBkg=emailDocument.getElementById("button-bkg");console.log(emailBody);if(emailBody!=null){var mktoImgs=emailBody.getElementsByClassName("mktoImg"),mktoTexts=emailBody.getElementsByClassName("mktoText"),mktoButtons=emailBody.getElementsByClassName("secondary-font button");}
if(!isMktoImgReplaced&&mktoImgs){var currMktoImg,currMktoImgMktoName,currMktoImgTag;for(ii=0;ii<mktoImgs.length;ii++){currMktoImg=mktoImgs[ii];currMktoImgMktoName=currMktoImg.getAttribute("mktoname");if(currMktoImgMktoName&&currMktoImgMktoName.search(logoMktoNameRegex)!=-1){currMktoImgTag=currMktoImg.getElementsByTagName("img")[0];if(currMktoImgTag&&currMktoImgTag.src){console.log("Marketo App > Overlaying: Email 2.0 Company Logo");currMktoImgTag.setAttribute("src",logo);isMktoImgReplaced=true;break;}}}}
