...
else if(itemToHide.action=="setDisabled"){item.setDisabled(disable);}}});}};}};APP.disableDesignerSaving=function(assetType,mode){console.log("Marketo App > Disabling: Designer (Edit/Preview) Saving & Toolbar Menus for "+assetType);var isDesignerAsset;isAppController=window.setInterval(function(){if(typeof(Mkt3)!=="undefined"&&Mkt3&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get){window.clearInterval(isAppController);var disableDesignerAsset,assetNode,menuItems;disableDesignerAsset=function(assetNode,menuItems,disableFunc){var heapEvent={name:assetNode.text,assetType:assetNode.compType,assetId:assetNode.id,assetArea:"Designer/Wizard",workspaceId:assetNode.accessZoneId};if(assetNode.text.search(".")!=-1){heapEvent.assetName=assetNode.text.split(".")[1];}
else{heapEvent.assetName=assetNode.text;}
heapTrack("track",heapEvent);if(assetNode.accessZoneId.toString().search(mktoGoldenWorkspacesMatch)!=-1||APP.getCookie("toggleState")=="false"){if(disableFunc){disableFunc();}
if(typeof(Ext4)!=="undefined"&&Ext4&&Ext4.ComponentQuery&&Ext4.ComponentQuery.query){var mItems=Ext4.ComponentQuery.query(menuItems.toString());if(mItems){console.log("Marketo App > Disabling Designer Toolbar Menus");mItems.forEach(function(item){if(item){item.setDisabled(true);}});}}}};switch(assetType){case"landingPage":switch(mode){case"edit":var isLandingPageEditor=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage").getLandingPage().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage").getLandingPage().getNodeJson()){console.log("Marketo App > Disabling: Landing Page Editor: Saving & Toolbar Menus");window.clearInterval(isLandingPageEditor);assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage").getLandingPage().getNodeJson();menuItems=["lpEditor menu [action=approveAndClose]","lpEditor menu [action=disableMobileVersion]","lpEditor menu [action=uploadImage]","lpEditor menu [action=grabImages]",];disableDesignerAsset(assetNode,menuItems,APP.disablePropertyPanelSaving);}},0);break;case"preview":var isLandingPagePreviewer=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.previewer.LandingPage").getLandingPage().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.previewer.LandingPage").getLandingPage().getNodeJson()){console.log("Marketo App > Disabling: Landing Page Previewer: Saving & Toolbar Menus");window.clearInterval(isLandingPagePreviewer);assetNode=Mkt3.app.controllers.get("Mkt3.controller.previewer.LandingPage").getLandingPage().getNodeJson();menuItems=["landingPagePreviewer menu [action=approveAndClose]",];disableDesignerAsset(assetNode,menuItems);}},0);break;}
break;case"email":switch(mode){case"edit":var isEmailEditor=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor").getEmail().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor").getEmail().getNodeJson()){console.log("Marketo App > Disabling: Email Editor: Saving & Toolbar Menus");window.clearInterval(isEmailEditor);assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor").getEmail().getNodeJson();menuItems=["emailEditor2 menu [action=approveEmail]","emailEditor2 menu [action=sendTestEmail]","emailEditor2 menu [action=uploadImage]","emailEditor2 menu [action=grabImages]","emailEditor2 menu [action=saveAsTemplate]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);}},0);break;case"preview":var isEmailPreviewer=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.editor.email2.Preview").getEmail().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.editor.email2.Preview").getEmail().getNodeJson()){console.log("Marketo App > Disabling: Email Previewer: Saving & Toolbar Menus");window.clearInterval(isEmailPreviewer);assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.email2.Preview").getEmail().getNodeJson();menuItems=["email2EditorPreviewToolbar [action=sendSampleEmail]","emailPreview menu [action=approveEmail]","emailPreview menu [action=sendSampleEmail]",];disableDesignerAsset(assetNode,menuItems);}},0);break;}
break;case"form":switch(mode){case"edit":var isFormEditor=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.editor.Form").getForm().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.editor.Form").getForm().getNodeJson()){console.log("Marketo App > Disabling: Form Editor: Saving & Toolbar Menus");window.clearInterval(isFormEditor);assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.Form").getForm().getNodeJson();menuItems=["formEditor toolbar [action=approveAndClose]","formEditor toolbar [action=finish]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);}},0);break;case"preview":var isFormPreviewer=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.previewer.Form").getForm().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.previewer.Form").getForm().getNodeJson()){console.log("Marketo App > Disabling: Form Previewer: Saving & Toolbar Menus");window.clearInterval(isFormPreviewer);assetNode=Mkt3.app.controllers.get("Mkt3.controller.previewer.Form").getForm().getNodeJson();menuItems=[];disableDesignerAsset(assetNode,menuItems);}},0);break;}
break;case"pushNotification":switch(mode){case"edit":var isPushNotificationEditor=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.editor.mobilePushNotification.MobilePushNotification").getMobilePushNotification().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.editor.mobilePushNotification.MobilePushNotification").getMobilePushNotification().getNodeJson()){console.log("Marketo App > Disabling: Push Notification Editor: Saving & Toolbar Menus");window.clearInterval(isPushNotificationEditor);assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.mobilePushNotification.MobilePushNotification").getMobilePushNotification().getNodeJson();menuItems=["mobilePushNotificationEditor toolbar [action=sendDraftSample]","mobilePushNotificationEditor toolbar [action=finish]","mobilePushNotificationEditor toolbar [action=approveAndClose]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);}},0);break;case"preview":var isPushNotificationPreview=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.previewer.MobilePushNotification").getMobilePushNotification().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.previewer.MobilePushNotification").getMobilePushNotification().getNodeJson()){console.log("Marketo App > Disabling: Push Notification Previewer: Saving & Toolbar Menus");window.clearInterval(isPushNotificationPreview);assetNode=Mkt3.app.controllers.get("Mkt3.controller.previewer.MobilePushNotification").getMobilePushNotification().getNodeJson();menuItems=["mobilePushNotificationPreviewer toolbar [action=sendDraftSample]",];disableDesignerAsset(assetNode,menuItems);}},0);break;}
break;case"inAppMessage":switch(mode){case"edit":var isInAppMessageEditor=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.editor.inAppMessage.InAppMessage").getInAppMessage().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.editor.inAppMessage.InAppMessage").getInAppMessage().getNodeJson()){console.log("Marketo App > Disabling: In-App Message Editor: Saving & Toolbar Menus");window.clearInterval(isInAppMessageEditor);assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.inAppMessage.InAppMessage").getInAppMessage().getNodeJson();menuItems=["inAppMessageEditor toolbar [action=sendSample]","inAppMessageEditor menu [action=sendSample]","inAppMessageEditor menu [action=approveAndClose]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);}},0);break;case"preview":var isInAppMessagePreviewer=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.previewer.InAppMessage").getInAppMessage().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.previewer.InAppMessage").getInAppMessage().getNodeJson()){console.log("Marketo App > Disabling: In-App Message Previewer: Saving & Toolbar Menus");window.clearInterval(isInAppMessagePreviewer);assetNode=Mkt3.app.controllers.get("Mkt3.controller.previewer.InAppMessage").getInAppMessage().getNodeJson();menuItems=["inAppMessagePreviewer toolbar [action=approveAndClose]",];disableDesignerAsset(assetNode,menuItems);}},0);break;default:break;}
break;case"smsMessage":switch(mode){case"edit":var isSmsMessageEditor=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.editor.SmsMessage").getSmsMessage().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.editor.SmsMessage").getSmsMessage().getNodeJson()){console.log("Marketo App > Disabling: SMS Message Editor: Saving & Toolbar Menus");window.clearInterval(isSmsMessageEditor);assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.SmsMessage").getSmsMessage().getNodeJson();menuItems=["smsMessageEditor menu [action=approveAndClose]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);}},0);break;case"preview":break;}
break;case"socialApp":switch(mode){case"edit":var isSocialAppEditor=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.editor.SocialApp").getSocialApp().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.editor.SocialApp").getSocialApp().getNodeJson()){console.log("Marketo App > Disabling: Social App Editor: Saving & Toolbar Menus");window.clearInterval(isSocialAppEditor);assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.SocialApp").getSocialApp().getNodeJson();menuItems=["socialAppEditor toolbar [action=approveAndClose]","socialAppEditor toolbar [action=finish]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);}},0);break;case"preview":var isSocialAppPreviewer=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.previewer.SocialApp").getSocialApp().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.previewer.SocialApp").getSocialApp().getNodeJson()){console.log("Marketo App > Disabling: Social App Previewer: Saving & Toolbar Menus");window.clearInterval(isSocialAppPreviewer);assetNode=Mkt3.app.controllers.get("Mkt3.controller.previewer.SocialApp").getSocialApp().getNodeJson();menuItems=[];disableDesignerAsset(assetNode,menuItems);}},0);break;}
break;case"abTest":switch(mode){case"edit":var isAbTestEditor=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.editor.testGroup.TestGroup").getTestGroup().getNodeJson())!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.editor.testGroup.TestGroup").getTestGroup().getNodeJson()){console.log("Marketo App > Disabling: A/B Test Editor: Saving & Toolbar Menus");window.clearInterval(isAbTestEditor);assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.testGroup.TestGroup").getTestGroup().getNodeJson();menuItems=["testGroupEditor toolbar[action=finish]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);}},0);break;case"preview":break;}
break;}}},0);};APP.disableFormSaveButtons=function(){console.log("Marketo App > Disabling: Form Window Save Buttons");if(typeof(Ext4)!=="undefined"&&Ext4.Component&&Ext4.Component.prototype&&Ext4.Component.prototype.show){Ext4.Component.prototype.show=function(animateTarget,cb,scope){console.log("Marketo App > Executing: Disable Form Window Save Buttons");if(this.getXType()=="createNamedAccountForm"||this.getXType()=="addToAccountListForm"||this.getXType()=="createAccountListForm"||this.getXType()=="adminUserInviteWizard"||this.getXType()=="adminEditLicensesForm"||this.getXType()=="adminSubscriptionInformationForm"||this.getXType()=="deleteZoneForm"||this.getXType()=="adminTinyMceSettingForm"||this.getXType()=="emailEditorSettingsForm"||this.getXType()=="emailAddMultipleDomainForm"||this.getXType()=="adminAddDomainForm"||this.getXType()=="adminScoreSettingsForm"||this.getXType()=="adminCrmFieldSettingsForm"||this.getXType()=="adminFieldHtmlEncodeForm"||this.getXType()=="mktocustomactivityActivityTypeForm"||this.getXType()=="mktocustomactivityActivityTypeEditForm"||this.getXType()=="mktocustomactivityActivityTypeFormStepThree"||this.getXType()=="mktocustomobjectObjectForm"||this.getXType()=="mktocustomobjectFieldForm"||this.getXType()=="adminSpecifyPluginContactForm"||this.getXType()=="wildcardRedirectForm"||this.getXType()=="mktowsEditIpRestrictionForm"||this.getXType()=="launchpointServiceIntegrationSettingsForm"||this.getXType()=="vespaAppForm"||this.getXType()=="vespaSendForm"||this.getXType()=="vespaConfigurePushAccessForm"||this.getXType()=="vespaNewDeviceForm"||this.getXType()=="adminTagsAddCalendarEntryTypeForm"||this.getXType()=="featureSwitchForm"){var mItems=this.query("[action=submit],");if(mItems){mItems.forEach(function(item){if(item){item.setDisabled(true);}});}}
...
if(!currCompFragment||currCompFragment.search(mktoDesignersFragmentMatch)==-1){if(accountString.search(mktoAccountStringsMatch)!=-1){APP.discardDrafts(accountString);APP.overrideTreeNodeExpand();APP.overrideTreeNodeCollapse();APP.overrideSaving();APP.disableDragAndDrop();APP.disableMenus();APP.hideToolbarItems();APP.disableFormSaveButtons();APP.disableAdminSaveButtons();APP.overrideSmartCampaignSaving();APP.trackTreeNodeSelection();APP.overrideUpdatePortletOrder();APP.overrideNewProgramCreate();APP.overrideAssetSaveEdit();APP.overrideNewAssetCreate();APP.overrideNewFolders();APP.overrideRenamingFolders();APP.hideFoldersOnImport();APP.disableConfirmationMessage();}
...
if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;if(currCompFragment.search(mktoDesignersFragmentMatch)!=-1){console.log("Marketo App > Location: Designers/Wizards");switch(currCompFragment){case mktoLandingPageEditFragment:console.log("Marketo App > Location: Landing Page Editor");APP.disableDesignerSaving("landingPage","edit");break;case mktoLandingPagePreviewFragment:console.log("Marketo App > Location: Landing Page Previewer");APP.disableDesignerSaving("landingPage","preview");break;case mktoLandingPagePreviewDraftFragment:console.log("Marketo App > Location: Landing Page Draft Previewer");APP.disableDesignerSaving("landingPage","preview");break;case mktoEmailEditFragment:if(currUrlFragment.search(mktoEmailPreviewFragmentRegex)==-1){console.log("Marketo App > Location: Email Editor");APP.disableDesignerSaving("email","edit");}
else{console.log("Marketo App > Location: Email Previewer");APP.disableDesignerSaving("email","preview");}
break;case mktoFormEditFragment:console.log("Marketo App > Location: Form Editor");APP.disableDesignerSaving("form","edit");break;case mktoFormPreviewFragment:console.log("Marketo App > Location: Form Previewer");APP.disableDesignerSaving("form","preview");break;case mktoFormPreviewDraftFragment:console.log("Marketo App > Location: Form Draft Previewer");APP.disableDesignerSaving("form","preview");break;case mktoPushNotificationEditFragment:console.log("Marketo App > Location: Push Notification Editor");APP.disableDesignerSaving("pushNotification","edit");break;case mktoMobilePushNotificationPreviewFragment:console.log("Marketo App > Location: Push Notification Previewer");APP.disableDesignerSaving("pushNotification","preview");break;case mktoInAppMessageEditFragment:console.log("Marketo App > Location: In-App Message Editor");APP.disableDesignerSaving("inAppMessage","edit");break;case mktoInAppMessagePreviewFragment:console.log("Marketo App > Location: In-App Message Previewer");APP.disableDesignerSaving("inAppMessage","preview");break;case mktoSmsMessageEditFragment:console.log("Marketo App > Location: SMS Message Editor");APP.disableDesignerSaving("smsMessage","edit");break;case mktoSocialAppEditFragment:console.log("Marketo App > Location: Social App Editor");APP.disableDesignerSaving("socialApp","edit");break;case mktoSocialAppPreviewFragment:console.log("Marketo App > Location: Social App Previewer");APP.disableDesignerSaving("socialApp","preview");break;case mktoAbTestEditFragment:console.log("Marketo App > Location: A/B Test Wizard");APP.disableDesignerSaving("abTest");break;case mktoEmailTestGroupEditFragment:console.log("Marketo App > Location: Email Test Group Wizard");APP.disableDesignerSaving("abTest");break;default:break;}}}}}},0);};APP.overrideSuperballMenuItems();heapTrack("id");}},0);