...
else if(action=="preview"){console.log("Marketo App > Overlaying: Email Previewer");if(overlay(document.getElementsByTagName("iframe")[0].contentWindow.document)){console.log("Marketo App > Overlaying: Email Interval is Cleared");window.clearInterval(isEmailEditor2);}}},0);}
