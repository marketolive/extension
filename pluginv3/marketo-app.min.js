...
if(deliverabilityToolsMenuItem){var origMenuItemOnClick=deliverabilityToolsMenuItem.onClick;deliverabilityToolsMenuItem.onClick=function(e){origMenuItemOnClick.apply(this,arguments);APP.heapTrack("track",{name:"Deliverability Tools",assetName:"Demo Account",assetType:"Home Tile"});};deliverabilityToolsMenuItem.href=mktoEmailDeliverabilityToolsLink;deliverabilityToolsMenuItem.update();}else{clonedMenuItem=menu.items.items[0].cloneConfig();clonedMenuItem.setText("Deliverability Tools");clonedMenuItem.setIconCls("mki3-mail-sealed-svg");clonedMenuItem.href=mktoEmailDeliverabilityToolsLink;clonedMenuItem.hrefTarget="_blank";var origMenuItemOnClick=clonedMenuItem.onClick;clonedMenuItem.onClick=function(e){origMenuItemOnClick.apply(this,arguments);APP.heapTrack("track",{name:"Deliverability Tools",assetName:"Demo Account",assetType:"Home Tile"});};clonedMenuItem.update();menu.add(clonedMenuItem);}
if(seoMenuItem){var origMenuItemOnClick=seoMenuItem.onClick;seoMenuItem.onClick=function(e){origMenuItemOnClick.apply(this,arguments);APP.heapTrack("track",{name:"SEO",assetName:"Home",assetType:"Home Tile"});};}}}
