...
APP.overrideDeliverabilityToolsMenuItem=function(){MktPage.showSuperMenu();var isMktSuperBallMenu=window.setInterval(function(){if(MktCanvas.getEl().dom.ownerDocument.body.childNodes[17].id=="ext4-ext-gen1024"||MktCanvas.getEl().dom.ownerDocument.body.childNodes[18].id=="ext4-ext-gen1024"){window.clearInterval(isMktSuperBallMenu);console.log("Marketo App > Overriding: Deliverability Superball Menu Item");var superBallMenuItems,currSuperBallMenuItemSpanTags,currSuperBallMenuItemAtags,deliverabilityToolsMenuItem,communityMenuItemNum,communityMenuItemSpanTags,communityMenuItemAtags,ii,jj;if(MktCanvas.getEl().dom.ownerDocument.body.childNodes[17].id=="ext4-ext-gen1024"){var isMktSuperBallMenu1=window.setInterval(function(){if(typeof(MktCanvas.getEl().dom.ownerDocument.body.childNodes[17].childNodes[1].childNodes[0].childNodes[1].childNodes[1].childNodes)!=="undefined"){window.clearInterval(isMktSuperBallMenu1);superBallMenuItems=MktCanvas.getEl().dom.ownerDocument.body.childNodes[17].childNodes[1].childNodes[0].childNodes[1].childNodes[1].childNodes;console.log("superBallMenuItems(17) = "+superBallMenuItems);}},0);}
else if(MktCanvas.getEl().dom.ownerDocument.body.childNodes[18].id=="ext4-ext-gen1024"){var isMktSuperBallMenu2=window.setInterval(function(){if(typeof(MktCanvas.getEl().dom.ownerDocument.body.childNodes[18].childNodes[1].childNodes[0].childNodes[1].childNodes[1].childNodes)!=="undefined"){window.clearInterval(isMktSuperBallMenu2);superBallMenuItems=MktCanvas.getEl().dom.ownerDocument.body.childNodes[18].childNodes[1].childNodes[0].childNodes[1].childNodes[1].childNodes;console.log("superBallMenuItems(18) = "+superBallMenuItems);}},0);}
for(ii=0;ii<superBallMenuItems.length;ii++){currSuperBallMenuItemSpanTags=superBallMenuItems[ii].getElementsByTagName("span");for(jj=0;jj<currSuperBallMenuItemSpanTags.length;jj++){if(currSuperBallMenuItemSpanTags[jj].innerHTML=="My Marketo"){superBallMenuItems[ii].click();break;}
else if(currSuperBallMenuItemSpanTags[jj].innerHTML=="Deliverability Tools"){deliverabilityToolsMenuItem=superBallMenuItems[ii];break;}
else if(currSuperBallMenuItemSpanTags[jj].innerHTML=="Community"){communityMenuItemNum=ii;break;}}
currSuperBallMenuItemAtags=superBallMenuItems[ii].getElementsByTagName("a");for(jj=0;jj<currSuperBallMenuItemAtags.length;jj++){if(currSuperBallMenuItemAtags[jj].href.search("/homepage/sso\\?sso=250ok$")!=-1){currSuperBallMenuItemAtags[jj].href="https://250ok.com/login";break;}}}
if(deliverabilityToolsMenuItem==null&&communityMenuItemNum!=null){communityMenuItemSpanTags=superBallMenuItems[communityMenuItemNum].getElementsByTagName("span");for(jj=0;jj<communityMenuItemSpanTags.length;jj++){if(communityMenuItemSpanTags[jj].innerHTML=="Community"){communityMenuItemSpanTags[jj].innerHTML="Deliverability Tools";break;}}
communityMenuItemAtags=superBallMenuItems[communityMenuItemNum].getElementsByTagName("a");for(jj=0;jj<communityMenuItemAtags.length;jj++){if(communityMenuItemAtags[jj].href.search("/guide/displaySuccessContent\\?contentTag=main_MarketoCommunityHome$")!=-1){communityMenuItemAtags[jj].href="https://250ok.com/login";break;}}}}},0);}
...
var prevActionsMenu=Mkt.menus.marketingEvent.Toolbar.preShowMarketingProgramActions;Mkt.menus.marketingEvent.Toolbar.preShowMarketingProgramActions=Mkt.menus.marketingEvent.Toolbar.preShowMarketingEventActions=function(menu){prevActionsMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId),itemsToDisable=["cloneMarketingProgram","cloneMarketingEvent","cloneNurtureProgram","cloneEmailBatchProgram","deleteMarketingProgram","deleteMarketingEvent","deleteNurtureProgram","deleteEmailBatchProgram","testNurtureProgram","eventSchedule","entryRescheduleEntries","sfdcCampaignSync","refreshFromWebinarProvider",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});}
var prevRightClickMenu=MktMaMenu.preShowProgramActionsMenu;MktMaMenu.preShowProgramActionsMenu=function(menu,attr){prevRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["newSmartCampaign","newLocalAsset","createNewMarketingProgram","createProgramFolder","renameProgramFolder","deleteProgramFolder","convertToArchiveFolder","convertToCampaignFolder","scClone","cloneMarketingProgram","cloneMarketingEvent","cloneNurtureProgram","cloneEmailBatchProgram","scArchive","deleteMarketingProgram","deleteMarketingEvent","deleteNurtureProgram","deleteEmailBatchProgram","scMove","scActivate","scAbort","scClearPalette","scClearSmartList","scClearFlow","shareProgramFolder","progGenerateRef","checkForCorruptEmails"];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevEmailRightClickMenu=MktDsMenu.preShowEmailMenu;MktDsMenu.preShowEmailMenu=function(menu,attr){prevEmailRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["emailApprove","emailUnapprove","emailClone","emailDelete","emailMove","emailNewTest","emailDraftSendTest","emailDraftApprove","emailApproveTest","emailDiscardTest"];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevLandingPageRightClickMenu=MktDsMenu.preShowPageMenu;MktDsMenu.preShowPageMenu=function(menu,attr){prevLandingPageRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["pageApprove","pageUnapprove","pageConvertToTestGroup","pageClone","pageDelete","urlTools","pageMove","pageDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevFormRightClickMenu=MktDsMenu.preShowFormMenu;MktDsMenu.preShowFormMenu=function(menu,attr){prevFormRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["formApprove","formClone","formDelete","formMove","formDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSocialAppRightClickMenu=MktDsMenu.preShowSocialAppMenu;MktDsMenu.preShowSocialAppMenu=function(menu,attr){prevSocialAppRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["socialAppApprove","socialAppClone","socialAppDelete","socialAppDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSocialAppActionsMenu=Mkt3.controller.socialApp.SocialApp.prototype.loadToolbar;Mkt3.controller.socialApp.SocialApp.prototype.loadToolbar=function(menu,attr){prevSocialAppActionsMenu.apply(this,arguments);var disable=(this.getSocialApp().get('zoneId')==1||this.getSocialApp().get('zoneId')==mktoJapaneseWorkspaceId),mItems=Ext4.ComponentQuery.query("socialAppToolbar contextMenu [action=approve],"+"socialAppToolbar contextMenu [action=clone],"+"socialAppToolbar contextMenu [action=delete],"+"socialAppToolbar contextMenu [action=editDraft],"+"socialAppToolbar contextMenu [action=previewDraft],"+"socialAppToolbar contextMenu [action=approveDraft],");mItems.forEach(function(item){if(item){item.setDisabled(disable);}});return menu;}
var prevPushNotificationRightClickMenu=MktDsMenu.preShowPushNotificationMenu;MktDsMenu.preShowPushNotificationMenu=function(menu,attr){prevPushNotificationRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["pushNotificationApprove","pushNotificationUnapprove","pushNotificationDelete","pushNotificationDraftEdit","pushNotificationDraftSendSample","pushNotificationDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevPushNotificationActionsMenu=Mkt3.controller.mobilePushNotification.MobilePushNotification.prototype.loadToolbar;Mkt3.controller.mobilePushNotification.MobilePushNotification.prototype.loadToolbar=function(menu,attr){prevPushNotificationActionsMenu.apply(this,arguments);var disable=(this.getSocialApp().get('zoneId')==1||this.getSocialApp().get('zoneId')==mktoJapaneseWorkspaceId),mItems=Ext4.ComponentQuery.query("mobilePushNotification contextMenu [action=approve],"+"mobilePushNotification contextMenu [action=unapprove],"+"mobilePushNotification contextMenu [action=clone],"+"mobilePushNotification contextMenu [action=delete],"+"mobilePushNotification contextMenu [action=editDraft],"+"mobilePushNotification contextMenu [action=sendDraftSample],"+"mobilePushNotification contextMenu [action=approveDraft],");mItems.forEach(function(item){if(item){item.setDisabled(disable);}});return menu;}
var prevDesignStudioContextMenu=MktDsMenu.preShowContextMenu;MktDsMenu.preShowContextMenu=function(menu,attr){prevDesignStudioContextMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["newLandingPage","newTestGroup","newPageTemplate","pageTemplateImport","newForm","newVideoShare","newShareButton","newReferralOffer","newEmail","newEmailTemplate","newSnippet","uploadImage","share","createFolder","renameFolder","deleteFolder","convertToArchiveFolder","convertToFolder",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevLandingPageTemplateMenu=MktDsMenu.preShowTemplateMenu;MktDsMenu.preShowTemplateMenu=function(menu,attr){prevLandingPageTemplateMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["approvePageTemplate","unapprovePageTemplate","clonePageTemplate","pageTemplateDelete","approveDraftPageTemplate",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevEmailTemplateMenu=MktDsMenu.preShowEmailTemplateMenu;MktDsMenu.preShowEmailTemplateMenu=function(menu,attr){prevEmailTemplateMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["emailTemplateApprove","emailTemplateUnapprove","emailTemplateClone","emailTemplateDelete","emailTemplateDraftSendTest","emailTemplateDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSnippetMenu=MktDsMenu.preShowSnippetMenu;MktDsMenu.preShowSnippetMenu=function(menu,attr){prevSnippetMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["snippetApprove","snippetUnapprove","snippetClone","snippetDelete","snippetDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevImageMenu=MktDsMenu.preShowImageMenu;MktDsMenu.preShowImageMenu=function(menu,attr){prevImageMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["uploadImage","imageDelete","replaceImage",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevLeadDatabaseContextMenu=MktLeadDbMenu.preShowContextMenu;MktLeadDbMenu.preShowContextMenu=function(menu,attr){prevLeadDatabaseContextMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["cloneSmartlist","cloneList","deleteList","showSupportHistory","showSupportUsagePerf","showSmartListProcessorDiag","showSmartListProcessorOverride",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevListMenu=MktLeadDbMenu.preShowListListMenu;MktLeadDbMenu.preShowListListMenu=function(menu,attr){prevListMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["cloneSmartlist","cloneList","deleteList","showSupportHistory","showSupportUsagePerf","showSmartListProcessorDiag","showSmartListProcessorOverride",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSegmentationMenu=MktLeadDbMenu.preShowSegmentationMenu;MktLeadDbMenu.preShowSegmentationMenu=function(menu,attr){prevSegmentationMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["createDraftSegmentation","approveSegmentation","unapproveSegmentation","deleteSegmentation","approveDraftSegmentation",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSegmentationFolderMenu=MktLeadDbMenu.preShowSegmentationFolderMenu;MktLeadDbMenu.preShowSegmentationFolderMenu=function(menu,attr){prevSegmentationFolderMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["newSegmentation","share","createFolder","renameFolder","deleteFolder","convertToArchiveFolder","convertToFolder",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSmartListMenu=MktLeadDbMenu.preShowUserListMenu;MktLeadDbMenu.preShowUserListMenu=function(menu,attr){prevSmartListMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["cloneSmartlist","cloneList","deleteList",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevReportMenu=MktAnalyticsMenu.preShowReportMenu;MktAnalyticsMenu.preShowReportMenu=function(menu,attr){prevReportMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["cloneReport","deleteReport","moveReport",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevReportFolderMenu=MktAnalyticsMenu.preshowReportFolderMenu;MktAnalyticsMenu.preshowReportFolderMenu=function(menu,attr){prevReportFolderMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr&&attr.accessZoneId&&(attr.accessZoneId==1||attr.accessZoneId==mktoJapaneseWorkspaceId))||(attr&&attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr||!attr.accessZoneId&&menu&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&(menu.currNode.attributes.accessZoneId==1||menu.currNode.attributes.accessZoneId==mktoJapaneseWorkspaceId))||(!menu||!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&(canvas.config.accessZoneId==1||canvas.config.accessZoneId==mktoJapaneseWorkspaceId)),itemsToDisable=["createFolder","renameFolder","deleteFolder","convertToArchiveFolder","convertToFolder","newRcm","share","moveReport",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
Mkt.widgets.ToolbarButton.prototype.showMenu=function(){var ii;if(MktCanvas&&MktCanvas.getActiveTab()&&MktCanvas.getActiveTab().config&&MktCanvas.getActiveTab().config.accessZoneId&&(MktCanvas.getActiveTab().config.accessZoneId==1||MktCanvas.getActiveTab().config.accessZoneId==mktoJapaneseWorkspaceId)){if(this.menu.itemId=="leadDbLeadMenu"){for(ii=0;ii<this.menu.items.items.length;ii++){if(typeof(this.menu.items.items[ii].menu)!="undefined"){var jj;for(jj=0;jj<this.menu.items.items[ii].menu.items.items.length;jj++){this.menu.items.items[ii].menu.items.items[jj].disable(true);}}}}
...
window.onhashchange=function(){if(currUrlFragment==mktoMyMarketoFragment){APP.overrideDeliverabilityToolsTile();}}}
