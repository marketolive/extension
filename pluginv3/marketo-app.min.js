...
overlay=function(emailDocument){if(emailDocument!=null){var emailBody=emailDocument.getElementsByTagName("body")[0],logoSwapCompany=emailDocument.getElementById("logo-swap-company"),logoSwapContainer=emailDocument.getElementById("logo-swap-container"),logoSwapCompanyContainer=emailDocument.getElementById("logo-swap-company-container"),logoBkg=emailDocument.getElementById("logo-bkg"),buttonBkg=emailDocument.getElementById("button-bkg");if(emailBody!=null){var mktoImgs=emailBody.getElementsByClassName("mktoImg"),mktoTexts=emailBody.getElementsByClassName("mktoText"),mktoButtons=emailBody.getElementsByClassName("secondary-font button");}
...
else if(action=="preview"){console.log("Marketo App > Overlaying: Email Previewer");console.log(document.getElementsByTagName("iframe"));if(!isDesktopPreviewReplaced&&overlay(document.getElementsByTagName("iframe")[2].contentWindow.document)){isDesktopPreviewReplaced=true;}
