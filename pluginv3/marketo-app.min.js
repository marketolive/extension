...
var isLandingPageDesigner=window.setInterval(function(){if(Mkt3&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage")&&Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage").getLandingPage()&&(Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage").getLandingPage().get("zoneId")==mktoDefaultWorkspaceId||Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage").getLandingPage().get("zoneId")==mktoJapaneseWorkspaceId)){console.log("Marketo App > Loaded: Landing Page Designer");window.clearInterval(isLandingPageDesigner);APP.disablePropertyPanelSaving();}},0);return;}
