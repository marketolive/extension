...
if(userId&&userId.search(adminUserNamesMatch)!=-1){console.log("Marketo App > User: Admin");APP.disableDemoPluginCheck();APP.applyMassClone();if(toggleState!="false"){return;}else{console.log("Marketo App > User: Admin is now a normal user");}}
