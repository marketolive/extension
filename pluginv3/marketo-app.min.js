...
window.clearInterval(h),APP.disablePropertyPanelSaving())},0);return}console.log("Marketo App > Location: Designers/Wizards");var f="EME15464",M="EME14240",v="EME13924",P="EME20327",b="EME20350",N="EME20329",A={filters:[{property:"id",value:Mkt3.DL.dl.compId}],callback:function(e){e.forEach(function(e){if(e.get("zoneId")){var t=e.get("zoneId");console.log("Marketo App > currAssetWorkspaceId = "+t),(t==mktoDefaultWorkspaceId||t==mktoJapaneseWorkspaceId||"false"==APP.getCookie("priv"))&&APP.disableSaving()}})}};switch(o){case mktoEmailDesignerFragment:switch(Ext4&&Ext4.getStore("Email")&&Ext4.getStore("Email").load&&(console.log("Callback for Email Editor"),Ext4.getStore("Email").load(A)),a){case f:APP.overlayEmailDesigner();break;case P:APP.overlayEmailDesigner();break;case b:APP.overlayEmailDesigner();break;case N:APP.overlayEmailDesigner();break;case M:APP.overlayEmailDesigner();break;case v:APP.overlayEmailDesigner()}break;case mktoFormWizardFragment:Ext4&&Ext4.getStore("Form")&&Ext4.getStore("Form").load&&(console.log("Callback for Form Editor"),Ext4.getStore("Form").load(A));break;case mktoMobilePushNotificationWizardFragment:Ext4&&Ext4.getStore("MobilePushNotification")&&Ext4.getStore("MobilePushNotification").load&&(console.log("Callback for Push Notification Editor"),Ext4.getStore("MobilePushNotification").load(A));break;case mktoSocialAppWizardFragment:Ext4&&Ext4.getStore("SocialApp")&&Ext4.getStore("SocialApp").load&&(console.log("Callback for Social App Editor"),Ext4.getStore("SocialApp").load(A));break;case mktoABtestWizardFragment:var y=window.setInterval(function(){Mkt3&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor")&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor()&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record&&(Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record.get("zoneId")==mktoDefaultWorkspaceId||Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record.get("zoneId")==mktoJapaneseWorkspaceId)&&(console.log("Marketo App > Location: A/B Test Wizard"),window.clearInterval(y),APP.disableSaving())},0);break;case mktoEmailTestWizardFragment:var E=window.setInterval(function(){Mkt3&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor")&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor()&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record&&(Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record.get("zoneId")==mktoDefaultWorkspaceId||Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record.get("zoneId")==mktoJapaneseWorkspaceId)&&(console.log("Marketo App > Location: Email Test Group Wizard"),window.clearInterval(E),APP.disableSaving())},0)}}window.onhashchange=function(){console.log("Window: Hash Changed"),currentUrl=window.location.href,a=Mkt3.DL.getDlToken(),Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode&&(o=Mkt3.DL.dl.dlCompCode),a==mktoMyMarketoFragment?APP.overrideDeliverabilityToolsTile():a==mktoMarketingActivitiesDefaultFragment||a==mktoMarketingActivitiesMarketingFragment||a==mktoMarketingActivitiesJapaneseFragment||a==mktoLeadDatabaseDefaultFragment||a==mktoLeadDatabaseMarketingFragment||a==mktoLeadDatabaseJapaneseFragment?APP.disableButtons():a==mktoAnalyticsFragment&&APP.overrideAnalyticsTiles(),o!=mktoEmailDesignerFragment&&o!=mktoEmailPreviewFragment&&o!=mktoLandingPageDesignerFragment&&o!=mktoLandingPagePreviewFragment&&o!=mktoFormWizardFragment&&o!=mktoMobilePushNotificationWizardFragment&&o!=mktoSocialAppWizardFragment&&o!=mktoABtestWizardFragment&&o!=mktoEmailTestWizardFragment&&a!=mktoMyMarketoFragment&&(a==mktoOppInfluenceAnalyzerFragment||a==mktoProgramAnalyzerFragment||a==mktoModeler106Fragment||a==mktoModeler106abFragment||a==mktoSuccessPathAnalyzerFragment)&&(console.log("Marketo App > Location: Analytics"),APP.injectAnalyzerNavBar())}}else APP.overrideDeliverabilityToolsMenuItem(),a==mktoMyMarketoFragment&&APP.overrideDeliverabilityToolsTile(),window.onhashchange=function(){a=Mkt3.DL.getDlToken(),a==mktoMyMarketoFragment&&APP.overrideDeliverabilityToolsTile()};APP.overrideDeliverabilityToolsMenuItem()}},0)}