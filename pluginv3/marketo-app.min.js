...
if(deliverabilityToolsMenuItem){deliverabilityToolsMenuItem.href=mktoEmailDeliverabilityToolsLink;deliverabilityToolsMenuItem.setAttribute("onclick",'APP.heapTrack("track", {name: "Deliverability Tools", assetName: "Demo Account", assetType: "Home Tile"});');deliverabilityToolsMenuItem.update();}else{clonedMenuItem=menu.items.items[0].cloneConfig();clonedMenuItem.setText("Deliverability Tools");clonedMenuItem.setIconCls("mki3-mail-sealed-svg");clonedMenuItem.href=mktoEmailDeliverabilityToolsLink;clonedMenuItem.hrefTarget="_blank";clonedMenuItem.setAttribute("onclick",'APP.heapTrack("track", {name: "Deliverability Tools", assetName: "Demo Account", assetType: "Home Tile"});');clonedMenuItem.update();menu.add(clonedMenuItem);}
if(seoMenuItem){seoMenuItem.setAttribute("onclick",'APP.heapTrack("track", {name: "SEO", assetName: "Home", assetType: "Home Tile"});');}}}
