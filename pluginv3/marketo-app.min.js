...
if(chrome.runtime.lastError){console.log("Marketo App > checkBadExtension Msg > Error: "+chrome.runtime.lastError);}});}else{APP.validateDemoExtensionCheck(false);}
if(chrome.runtime.lastError){console.log("Marketo App > checkExtensionVersion Msg > Error: "+chrome.runtime.lastError);}});if(MktPage.userid&&MktPage.userName){var mktoRole=MktPage.userName.match(/\[[^\]]+\]/);if(mktoRole!=null){mktoRole=mktoRole[0].replace(/^\[([^\]]+)]$/,"$1");}
...
if(chrome.runtime.lastError){console.log("Marketo App > checkMktoCookie Msg > Error: "+chrome.runtime.lastError);}});}else{APP.disableRequests();}
