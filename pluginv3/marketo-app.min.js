...
break;case"abTest":switch(mode){case"edit":var isAbTestEditor=window.setInterval(function(){if(typeof(Mkt3.app.controllers.get("Mkt3.controller.editor.testGroup.TestGroup"))!=="undefined"&&Mkt3.app.controllers.get("Mkt3.controller.editor.testGroup.TestGroup")&&Mkt3.app.controllers.get("Mkt3.controller.editor.testGroup.TestGroup").getTestGroup()&&Mkt3.app.controllers.get("Mkt3.controller.editor.testGroup.TestGroup").getTestGroup().getNodeJson()){console.log("Marketo App > Disabling: A/B Test Editor: Saving & Toolbar Menus");window.clearInterval(isAbTestEditor);assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.testGroup.TestGroup").getTestGroup().getNodeJson();menuItems=["testGroupEditor toolbar[action=finish]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);}},0);break;case"preview":break;}
...
if(oneLoginFirstName&&oneLoginLastName){console.log("Marketo App > Heap Analytics ID: "+oneLoginFirstName+" "+oneLoginLastName);heap.addUserProperties({Name:oneLoginFirstName+" "+oneLoginLastName});}
else if(MktPage&&MktPage.userName){console.log("Marketo App > Heap Analytics ID: "+MktPage.userName);heap.addUserProperties({Name:MktPage.userName});}
break;case"track":var heapApp,heapArea,heapEventProps;if(MktPage&&MktPage.friendlyName){heapApp=MktPage.friendlyName;}
