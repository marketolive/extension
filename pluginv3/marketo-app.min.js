...
var params={compId:this.programId,portletOrdering:Ext.encode(newPortletOrder)};MktSession.ajaxRequest('marketingEvent/orderLocalAssetPortlets',{serializeParms:params,localAssetManager:this,portletOrdering:newPortletOrder,onMySuccess:this.updatePortletOrderSuccess});}else{console.log("Marketo App > Disabling: Updating of Portlet Order");}};}};APP.overrideTreeNodeExpand=function(){console.log("Marketo App > Overriding: Tree Node Expand");if(typeof(MktAsyncTreeNode)!=="undefined"&&MktAsyncTreeNode&&MktAsyncTreeNode.prototype&&MktAsyncTreeNode.prototype.expand&&userName){MktAsyncTreeNode.prototype.expand=function(){var attr=this.attributes,ii;if(this.text==userWorkspaceName||(this.parentNode.text==userWorkspaceName&&this.attributes.system==true)||(this.parentNode.parentNode!=null&&this.parentNode.parentNode.text==userWorkspaceName&&this.attributes.system==true)){for(ii=0;ii<this.childNodes.length;ii++){if(this.childNodes[ii].attributes.system==false){if(this.childNodes[ii].text.toLowerCase()!==userName){this.childNodes[ii].hidden=true;}else{}}}}
if(attr.folder){if(attr.cancelFirstExpand){delete this.attributes.cancelFirstExpand;}else if(this.childNodes&&this.childNodes.length>0&&!attr.mktExpanded){if(this.text!=userWorkspaceName&&this.parentNode.text!=userWorkspaceName&&this.parentNode.parentNode!=null&&this.parentNode.parentNode.text!=userWorkspaceName){MktFolder.saveExpandState(this,true);}}}
...
{var me=this,menuItems=["[action=submit]",],mItems=this.query(menuItems.toString());if(mItems){mItems.forEach(function(item){if(item){item.setDisabled(true);if(me.getXType()=="emailAddMultipleDomainForm"){item.stayDisabled=true;}}});}}
...
formField.destroy({scope:this,callback:function(field,response){if(response.success){if(formFieldWidget){formFieldWidget.destroy();}}}});this.renumberWidgets();};}};APP.openAdBridgeModal=function(){console.log("Marketo App > Opening: Ad Bridge Modal Window");var isAdBridgeSmartList=window.setInterval(function(){if(typeof(document.getElementsByClassName("x-btn-text mkiUserTarget")[0])!=="undefined"){window.clearInterval(isAdBridgeSmartList);if(document&&document.getElementsByClassName("x-btn-text mkiUserTarget")&&document.getElementsByClassName("x-btn-text mkiUserTarget")[0]&&document.getElementsByClassName("x-btn-text mkiUserTarget")[0].type=="button"){console.log("Marketo App > Executing: Open Ad Bridge Modal Window");document.getElementsByClassName("x-btn-text mkiUserTarget")[0].click();}}},0);};APP.discardLandingPageDrafts=function(lpIds){console.log("Marketo App > Discarding: Landing Page Drafts");if(typeof(mktLPLManager)!=="undefined"&&mktLPLManager&&mktLPLManager.doModifyPages){console.log("Marketo App > Executing: Discard Landing Page Drafts");var ii,lpMessageBox=Ext.MessageBox.show({title:"MarketoLive",msg:"Discarding Landing Page Drafts",progress:false,wait:false,width:270,closable:true});for(ii=0;ii<Object.keys(lpIds).length;ii++){var lpIdKey=Object.keys(lpIds)[ii],lpIdVal=lpIds[lpIdKey];mktLPLManager.doModifyPages('revert',{[lpIdKey]:lpIdVal});if(lpMessageBox&&lpMessageBox.hide){lpMessageBox.hide();}}
console.log("Marketo App > Finished: Discarding Landing Pages");}};APP.discardEmailDrafts=function(emIds){console.log("Marketo App > Discarding: Email Drafts");if(typeof(mktEmManager)!=="undefined"&&mktEmManager&&mktEmManager.discardDraft){console.log("Marketo App > Executing: Discard Email Drafts");var emMessageBox=Ext.MessageBox.show({title:"MarketoLive",msg:"Discarding Email Drafts",progress:false,wait:false,width:270,closable:true});mktEmManager.discardDraft(emIds);if(emMessageBox&&emMessageBox.hide){emMessageBox.hide();}}};APP.discardOtherDrafts=function(assetType,assetIds){console.log("Marketo App > Discarding: "+assetType+" Drafts");if(typeof(Ext4)!=="undefined"&&Ext4&&Ext4.getStore&&Ext4.create&&typeof(Mkt3)!=="undefined"&&Mkt3){console.log("Marketo App > Executing: Discard "+assetType+" Drafts");var assetStore=Ext4.getStore(assetType);if(MktMessage&&MktMessage.showSystemError){MktMessage.showSystemError=function(){};}
if(!assetStore){assetStore=Ext4.create('Mkt3.store.'+assetType,{storeId:assetType});}
assetStore.load({filters:[{property:'id',value:assetIds}],callback:function(assets){for(var i=0;i<assets.length;i++){var asset=assets[i];asset.discard(function(success){if(success){asset.updateNode();}},this);}}});}};APP.findWorkspace=function(workspaceAssetId){console.log("Marketo App > Finding: Workspace");var isfindWorkspaces=window.setInterval(function(){if(typeof(MktExplorer)!=="undefined"&&MktExplorer&&MktExplorer.getNodeById){window.clearInterval(isfindWorkspaces);if(MktExplorer.getNodeById(workspaceAssetId)!=null){return true;}else{return true;}}},0);};APP.discardDrafts=function(accountString,assetType){console.log("Marketo App > Discarding: Golden Assets for instance: "+accountString);var lpIds={},emIds=[],formIds=[],pushIds=[],inAppIds=[],smsIds=[],socIds=[];switch(accountString){case mktoAccountString106:if(APP.findWorkspace(mktoDefaultWorkspaceAssetId)){lpIds["dpageid_11826"]="dpageid_11826";lpIds["dpageid_11822"]="dpageid_11822";lpIds["dpageid_8819"]="dpageid_8819";lpIds["dpageid_8941"]="dpageid_8941";lpIds["dpageid_4876"]="dpageid_4876";lpIds["dpageid_4872"]="dpageid_4872";lpIds["dpageid_4874"]="dpageid_4874";emIds.push(15464);emIds.push(21424);emIds.push(20931);emIds.push(18113,18106,18111,18110);emIds.push(10010,10179,10180,12845,10181,10182,10183,10184);emIds.push(4894,3764,3765,3767,3766,3762);emIds.push(12818,12820,12819,12816,12811,12815,12812,12813,12814,12821,12817,12823);emIds.push(12900,12901,12899,12898);emIds.push(12902,12903,12904);formIds.push(3576,1749,1900);pushIds.push(29,23);inAppIds.push(309,446);smsIds.push(1);socIds.push(587,491,484);}else{console.log("Marketo App > NOT Discarding: Default Golden Assets - Workspace NOT Found");}
if(APP.findWorkspace(mktoJapaneseWorkspaceAssetId)){lpIds["dpageid_11856"]="dpageid_11856";lpIds["dpageid_12420"]="dpageid_12420";lpIds["dpageid_12418"]="dpageid_12418";lpIds["dpageid_11552"]="dpageid_11552";lpIds["dpageid_11550"]="dpageid_11550";lpIds["dpageid_11553"]="dpageid_11553";lpIds["dpageid_12345"]="dpageid_12345";lpIds["dpageid_11556"]="dpageid_11556";emIds.push(16474);emIds.push(18117,18118,18122,18119,18116,18123,18120,18121,18124);emIds.push(16118,16119,16120,16122,16121,16117);emIds.push(16331,16332,16338,16333,16123,16339,16335,16336,17868);emIds.push(16125,16129,16126,16124,16132,16131,16130,16128,16127,16133,16137,16136);emIds.push(18126);formIds.push(3018,3708,3020,3021);pushIds.push(99,216,103,218);socIds.push(853);}else{console.log("Marketo App > NOT Discarding: Japanese Golden Assets - Workspace NOT Found");}
if(APP.findWorkspace(mktoFinservWorkspaceAssetId)){lpIds["dpageid_13187"]="dpageid_13187";lpIds["dpageid_13185"]="dpageid_13185";lpIds["dpageid_12709"]="dpageid_12709";lpIds["dpageid_12720"]="dpageid_12720";lpIds["dpageid_12717"]="dpageid_12717";lpIds["dpageid_12719"]="dpageid_12719";emIds.push(22818)
emIds.push(20350,20368)
formIds.push(4970,4968,4969);formIds.push(3952,4476,3953);pushIds.push(465,189);inAppIds.push(464);inAppIds.push(448);socIds.push(1238,1239,1240,1241,1242);socIds.push(1091,1090,1093,1092,1094);}else{console.log("Marketo App > NOT Discarding: Financial Services Golden Assets - Workspace NOT Found");}
if(APP.findWorkspace(mktoHealthcareWorkspaceAssetId)){lpIds["dpageid_12569"]="dpageid_12569";lpIds["dpageid_12932"]="dpageid_12932";lpIds["dpageid_13165"]="dpageid_13165";lpIds["dpageid_12586"]="dpageid_12586";lpIds["dpageid_12517"]="dpageid_12517";emIds.push(20327,21812)
formIds.push(3816,3818,3828);pushIds.push(164);inAppIds.push(449);socIds.push(1021,1023,1025,1022,1020);}else{console.log("Marketo App > NOT Discarding: Healthcare Golden Assets - Workspace NOT Found");}
if(APP.findWorkspace(mktoHigherEdWorkspaceAssetId)){lpIds["dpageid_12250"]="dpageid_12250";lpIds["dpageid_12934"]="dpageid_12934";lpIds["dpageid_12401"]="dpageid_12401";lpIds["dpageid_13167"]="dpageid_13167";lpIds["dpageid_12248"]="dpageid_12248";lpIds["dpageid_12177"]="dpageid_12177";emIds.push(20329)
formIds.push(3313,4125,3559);pushIds.push(132);inAppIds.push(450);socIds.push(860,1024,861,859,858);}else{console.log("Marketo App > NOT Discarding: Higher Education Golden Assets - Workspace NOT Found");}
if(APP.findWorkspace(mktoManufacturingWorkspaceAssetId)){}
else{console.log("Marketo App > NOT Discarding: Manufacturing Golden Assets - Workspace NOT Found");}
if(APP.findWorkspace(mktoTravelLesiureWorkspaceAssetId)){}
else{console.log("Marketo App > NOT Discarding: Travel Lesiure Golden Assets - Workspace NOT Found");}
break;case mktoAccountString106d:if(APP.findWorkspace(mktoDefaultWorkspaceAssetId)){lpIds["dpageid_11826"]="dpageid_11826";lpIds["dpageid_11822"]="dpageid_11822";lpIds["dpageid_8819"]="dpageid_8819";lpIds["dpageid_8941"]="dpageid_8941";lpIds["dpageid_4876"]="dpageid_4876";lpIds["dpageid_4872"]="dpageid_4872";lpIds["dpageid_4874"]="dpageid_4874";emIds.push(15464);emIds.push(18113,18106,18111,18110);emIds.push(10010,10179,10180,12845,10181,10182,10183,10184);emIds.push(4894,3764,3765,3767,3766,3762);emIds.push(12818,12820,12819,12816,12811,12815,12812,12813,12814,12821,12817,12823);emIds.push(12900,12901,12899,12898);emIds.push(12902,12903,12904);formIds.push(3576,1749,1900);pushIds.push(29,23);socIds.push(586,587,491,484);}else{console.log("Marketo App > NOT Discarding: Default Golden Assets - Workspace NOT Found");}
...
APP.disableDemoPluginCheck();if(currUrlFragment==mktoMyMarketoFragment){APP.overrideHomeTiles();heapTrack("track",{name:"My Marketo",assetName:"Home"});}else if(currUrlFragment.search(mktoDisableButtonsFragmentMatch)!=-1){APP.disableButtons();}else if(currUrlFragment==mktoAnalyticsDefaultFragment){APP.overrideAnalyticsTiles();}else if(currUrlFragment.search(mktoAnalyzersFragmentMatch)!=-1){console.log("Marketo App > Location: Analytics");APP.injectAnalyzerNavBar();}else if(currUrlFragment==mktoAdBridgeSmartListFragment){console.log("Marketo App > Location: Ad Bridge Smart List");APP.openAdBridgeModal();}else if(currUrlFragment==mktoAdminSalesforceFragment){console.log("Marketo App > Location: Admin > Salesforce");APP.hideOtherToolbarItems([{id:"enableSync",action:"setVisible"}]);}else if(currUrlFragment==mktoAdminRcaCustomFieldSync){console.log("Marketo App > Location: Admin > Revenue Cycle Analytics > Custom Field Sync");APP.hideOtherToolbarItems([{id:"cadChangeButton",action:"setVisible"}]);}
