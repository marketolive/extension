...
if(Ext4&&Ext4.Component&&Ext4.Component.prototype&&Ext4.Component.prototype.show){Ext4.Component.prototype.show=function(animateTarget,cb,scope){console.log("Marketo App > Executing: Disable Create, Add, Save buttons in Form Windows");if(this.getXType()=="createNamedAccountForm"||this.getXType()=="addToAccountListForm"){var mItems=this.query("[action=submit],");mItems.forEach(function(item){if(item){item.setDisabled(true);}});}
