...
APP.overrideSaving=function(currUrlFragment){console.log("Marketo App > Overriding: Saving for Nurture Streams");if(Mkt3&&Mkt3.data&&Mkt3.data.Store&&Mkt3.data.Store.prototype&&Mkt3.data.Store.prototype.sync){var prevDataStoreSync=Mkt3.data.Store.prototype.sync;Mkt3.data.Store.prototype.sync=function(){console.log("Marketo App > Executing: Override Saving for Nurture Streams (sync)");if(currUrlFragment.search("^"+mktoCalendarFragment)!=-1){Mkt3.data.Store.prototype.sync=prevDataStoreSync;}
else{var disable;if(MktCanvas&&MktCanvas.getActiveTab()&&APP.getCookie("priv")!="false"){disable=APP.evaluateMenu("button",null,MktCanvas.getActiveTab(),null);}
