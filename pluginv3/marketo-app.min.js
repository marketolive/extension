...
APP.reloadProgramAnalyzer=function(){console.log("Marketo App > Reloading: Program Analyzer");if(MktCanvas&&MktCanvas.getActiveTab()&&MktCanvas.getActiveTab().config&&MktCanvas.getActiveTab().config.guideId=="analyzer_ProgramAnalyzer"){console.log("Marketo App > Executing: Reload Program Analyzer");MktCanvas.reloadActiveTab();}}
