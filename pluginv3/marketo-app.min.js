...
if(accountString==mktoAccountStringQe){APP.disableMenus();APP.hideToolbarItems();APP.disableFormSaveButtons();APP.disableAdminSaveButtons();}}else if(currCompFragment){console.log("Marketo App > Location: Designers, ABM Areas");switch(currCompFragment){case mktoAbmDiscoverMarketoCompaniesFragment:case mktoAbmDiscoverCrmAccountsFragment:case mktoAbmNamedAccountFragment:console.log("Marketo App > Location: Account Based Marketing Areas");APP.disableMenus();APP.hideToolbarItems();APP.disableFormSaveButtons();APP.disableAdminSaveButtons();APP.heapTrack("track",{name:"Last Loaded",assetName:"Page"});break;case mktoLandingPageEditFragment:console.log("Marketo App > Location: Landing Page Editor");APP.disableDesignerSaving("landingPage","edit");break;case mktoLandingPagePreviewFragment:console.log("Marketo App > Location: Landing Page Previewer");APP.disableDesignerSaving("landingPage","preview");break;case mktoLandingPagePreviewDraftFragment:console.log("Marketo App > Location: Landing Page Draft Previewer");APP.disableDesignerSaving("landingPage","preview");break;case mktoEmailEditFragment:if(currUrlFragment.search(mktoEmailPreviewFragmentRegex)==-1){console.log("Marketo App > Location: Email Editor");APP.disableDesignerSaving("email","edit");}else{console.log("Marketo App > Location: Email Previewer");APP.disableDesignerSaving("email","preview");}
