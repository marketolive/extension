...
else if(action=="preview"){console.log("Marketo App > Overlaying: Email Previewer");if(overlay(document.getElementsByTagName("iframe")[2].contentWindow.document)&&overlay(document.getElementsByTagName("iframe")[3].contentWindow.document)){console.log("Marketo App > Overlaying: Email Interval is Cleared");window.clearInterval(isEmailEditor2);}}},0);}
