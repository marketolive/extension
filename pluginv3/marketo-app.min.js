...
else if(currCompFragment==mktoEmailDesignerFragment&&Mkt3.DL.getToken().search("&isPreview")!=-1){console.log("Marketo App > Location: Email Previewer");APP.overlayEmail("preview");}}}
