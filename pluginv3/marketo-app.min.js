...
console.log("Marketo App > Heap Analytics ID: "+oneLoginEmail);heap.identify(oneLoginEmail);}else if(MktPage&&MktPage.userid){console.log("Marketo App > Heap Analytics ID: "+MktPage.userid);heap.identify(MktPage.userid);}
