...
else if(itemToHide.action=="setDisabled"){item.setDisabled(disable);}}});}};}};APP.disableDesignerSaving=function(assetType,mode){console.log("Marketo App > Disabling: Designer (Edit/Preview) Saving & Toolbar Menus for "+assetType);var heapTrackDesigner,isDesignerAsset;heapTrackDesigner=function(assetNode){var heapEvent={name:assetNode.text,assetType:assetNode.compType,assetId:assetNode.id,assetArea:"Designer/Wizard",workspaceId:assetNode.accessZoneId};if(assetNode.text.search(".")!=-1){heapEvent.assetName=assetNode.text.split(".")[1];}
else{heapEvent.assetName=assetNode.text;}
heapTrack("track",heapEvent);};isAppController=window.setInterval(function(){if(typeof(Mkt3)!=="undefined"&&Mkt3&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get){window.clearInterval(isAppController);var disableDesignerAsset=function(assetNode,menuItems,disableFunc){var isDesignerAsset=window.setInterval(function(){if(typeof(assetNode)!=="undefined"&&assetNode){window.clearInterval(isDesignerAsset);heapTrackDesigner(assetNode);if(disableFunc&&(assetNode.accessZoneId.toString().search(mktoGoldenWorkspacesMatch)!=-1||APP.getCookie("toggleState")=="false")){disableFunc();if(typeof(Ext4)!=="undefined"&&Ext4&&Ext4.ComponentQuery&&Ext4.ComponentQuery.query){var mItems=Ext4.ComponentQuery.query(menuItems);if(mItems){console.log("Marketo App > Disabling Designer Toolbar Menus");mItems.forEach(function(item){if(item){item.setDisabled(true);}});}}}}},0);};switch(assetType){var assetNode,menuItems;case"landingPage":switch(mode){case"edit":assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage").getLandingPage().getNodeJson();menuItems=["lpEditor menu [action=approveAndClose]","lpEditor menu [action=disableMobileVersion]","lpEditor menu [action=uploadImage]","lpEditor menu [action=grabImages]",];disableDesignerAsset(assetNode,menuItems,APP.disablePropertyPanelSaving);break;case"preview":assetNode=Mkt3.app.controllers.get("Mkt3.controller.previewer.LandingPage").getLandingPage().getNodeJson();menuItems=["landingPagePreviewer menu [action=approveAndClose]",];disableDesignerAsset(assetNode,menuItems);break;}
break;case"email":switch(mode){case"edit":assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor").getEmail().getNodeJson();menuItems=["emailEditor2 menu [action=approveEmail]","emailEditor2 menu [action=sendTestEmail]","emailEditor2 menu [action=uploadImage]","emailEditor2 menu [action=grabImages]","emailEditor2 menu [action=saveAsTemplate]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);break;case"preview":assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.email2.Preview").getEmail().getNodeJson();menuItems=["email2EditorPreviewToolbar [action=sendSampleEmail]","emailPreview menu [action=approveEmail]","emailPreview menu [action=sendSampleEmail]",];disableDesignerAsset(assetNode,menuItems);break;}
break;case"form":switch(mode){case"edit":assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.Form").getForm().getNodeJson();menuItems=["formEditor toolbar [action=approveAndClose]","formEditor toolbar [action=finish]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);break;case"preview":assetNode=Mkt3.app.controllers.get("Mkt3.controller.previewer.Form").getForm().getNodeJson();menuItems=[];disableDesignerAsset(assetNode,menuItems);break;}
break;case"pushNotification":switch(mode){case"edit":assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.mobilePushNotification.MobilePushNotification").getMobilePushNotification().getNodeJson();menuItems=["mobilePushNotificationEditor toolbar [action=sendDraftSample]","mobilePushNotificationEditor toolbar [action=finish]","mobilePushNotificationEditor toolbar [action=approveAndClose]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);break;case"preview":assetNode=Mkt3.app.controllers.get("Mkt3.controller.previewer.MobilePushNotification").getMobilePushNotification().getNodeJson();menuItems=["mobilePushNotificationPreviewer toolbar [action=sendDraftSample]",];disableDesignerAsset(assetNode,menuItems);break;}
break;case"inAppMessage":switch(mode){case"edit":assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.inAppMessage.InAppMessage").getInAppMessage().getNodeJson();menuItems=["inAppMessageEditor toolbar [action=sendSample],""inAppMessageEditor menu [action=sendSample]","inAppMessageEditor menu [action=approveAndClose]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);break;case"preview":assetNode=Mkt3.app.controllers.get("Mkt3.controller.previewer.InAppMessage").getInAppMessage().getNodeJson();menuItems=["inAppMessagePreviewer toolbar [action=approveAndClose]",];disableDesignerAsset(assetNode,menuItems);break;default:break;}
break;case"smsMessage":switch(mode){case"edit":assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.SmsMessage").getSmsMessage().getNodeJson();menuItems=["smsMessageEditor menu [action=approveAndClose]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);break;case"preview":break;}
break;case"socialApp":switch(mode){case"edit":assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.SocialApp").getSocialApp().getNodeJson();menuItems=["socialAppEditor toolbar [action=approveAndClose]","socialAppEditor toolbar [action=finish]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);break;case"preview":assetNode=Mkt3.app.controllers.get("Mkt3.controller.previewer.SocialApp").getSocialApp().getNodeJson();menuItems=[];disableDesignerAsset(assetNode,menuItems);break;default:break;}
break;case"abTest":switch(mode){case"edit":assetNode=Mkt3.app.controllers.get("Mkt3.controller.editor.testGroup.TestGroup").getTestGroup().getNodeJson();menuItems=["testGroupEditor toolbar[action=finish]",];disableDesignerAsset(assetNode,menuItems,APP.disableSaving);break;case"preview":break;}
