...
return false;}
if(action=="edit"){console.log("Marketo App > Overlaying: Email Editor");document.getElementsByTagName("iframe")[0].onload=function(){if(overlay(document.getElementsByTagName("iframe")[0].contentWindow.document)){console.log("Marketo App > Overlaying: Email Interval is Cleared");window.clearInterval(isEmailEditor2);clearOverlayVars();}}}
else if(action=="preview"){console.log("Marketo App > Overlaying: Email Previewer");document.getElementsByTagName("iframe")[2].onload=function(){if(!isDesktopPreviewReplaced&&document.getElementsByTagName("iframe")[2].contentWindow.document&&overlay(document.getElementsByTagName("iframe")[2].contentWindow.document)){isDesktopPreviewReplaced=true;}}
document.getElementsByTagName("iframe")[3].onload=function(){if(!isPhonePreviewReplaced&&document.getElementsByTagName("iframe")[3].contentWindow.document&&overlay(document.getElementsByTagName("iframe")[3].contentWindow.document)){console.log("Marketo App > Overlayed: Email Phone Preview");isPhonePreviewReplaced=true;}}
