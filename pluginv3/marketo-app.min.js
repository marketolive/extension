...
var workspaceId=MktCanvas.getActiveTab().config.accessZoneId;if(workspaceId==1||workspaceId==disableConfirmationMessage){if(hasChanges&&showTriggerWarning){Ext4.Msg.confirmDelete({title:title,msg:msg,minHeight:300,fn:function(buttonId){if(buttonId==='ok'){this._doClose();}},scope:this});}
