...
break;case mktoABtestWizardFragment:console.log("Marketo App > Location: A/B Test Wizard");var isABtestWizard=window.setInterval(function(){if(typeof(Mkt3)!=="undefined"&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor")&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor()&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record&&(Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record.get("zoneId").toString().search(mktoGoldenWorkspacesMatch)!=-1)){console.log("Marketo App > Loaded: A/B Test Wizard");window.clearInterval(isABtestWizard);APP.disableSaving();}},0);break;case mktoEmailTestWizardFragment:console.log("Marketo App > Location: Email Test Group Wizard");var isEmailTestWizard=window.setInterval(function(){if(typeof(Mkt3)!=="undefined"&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor")&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor()&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record&&(Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record.get("zoneId").toString().search(mktoGoldenWorkspacesMatch)!=-1)){console.log("Marketo App > Loaded: Email Test Group Wizard");window.clearInterval(isEmailTestWizard);APP.disableSaving();}},0);break;default:break;}}
