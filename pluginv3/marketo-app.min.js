...
if(currUrlFragment.search(mktoReportFragmentRegex)!=-1){console.log("Marketo App > Location: Fullscreen Report");APP.disableAnalyticsSaving("report");}else if(currUrlFragment.search(mktoModelerFragmentRegex)!=-1){if(currentUrl.search("?")!=-1&&currentUrl.split("?")[1].search(mktoModelerPreviewFragmentRegex)==-1){console.log("Marketo App > Location: Revenue Cycle Model Editor");APP.disableAnalyticsSaving("model","edit");}else{console.log("Marketo App > Location: Revenue Cycle Model Previewer");APP.disableAnalyticsSaving("model","preview");}}}}
