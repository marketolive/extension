...
APP.overrideTreeNodeExpand=function(){console.log("Marketo App > Overriding: Tree Node Expand");MktAsyncTreeNode.prototype.expand=function(){console.log("Marketo App > Executing: Tree Node Expand");var attr=this.attributes,ii;if(this.text==userWorkspaceName||(this.parentNode.text==userWorkspaceName&&this.attributes.system==true)){var userId=MktPage.userid,userName;if(userId.search("\.demo@marketo.com$")!=-1){userName=userId.split(".demo")[0];}
else{userName=userId.split("@")[0];}
for(ii=0;ii<this.childNodes.length;ii++){if(this.childNodes[ii].attributes.system==false){if(this.childNodes[ii].text!==userName){this.childNodes[ii].hidden=true;}
else{}}}}
...
APP.overrideTreeNodeCollapse=function(){console.log("Marketo App > Overriding: Tree Node Collapse");MktAsyncTreeNode.prototype.collapse=function(){console.log("Marketo App > Executing: Tree Node Collapse");var attr=this.attributes,ii;if(this.text==userWorkspaceName||(this.parentNode.text==userWorkspaceName&&this.attributes.system==true)){var userId=MktPage.userid,userName;if(userId.search("\.demo@marketo.com$")!=-1){userName=userId.split(".demo")[0];}
else{userName=userId.split("@")[0];}
for(ii=0;ii<this.childNodes.length;ii++){if(this.childNodes[ii].attributes.system==false){if(this.childNodes[ii].text!==userName){this.childNodes[ii].ui.elNode.hidden=true;}
else{}}}}
...
APP.overrideNewProgramCreate=function(){console.log("Marketo App > Overriding: New Program Creation");Mkt.widgets.ModalForm.prototype.okButtonHandler=function(){console.log("Marketo App > Executing: New Program Creation");if(MktCanvas.getActiveTab().config.accessZoneId!=1){if(this.title=="New Program"){var userId=MktPage.userid,userName,ii;if(userId.search("\.demo@marketo.com$")!=-1){userName=userId.split(".demo")[0];}
else{userName=userId.split("@")[0];}
if(this.items.items[2].fieldLabel=="Name"){if(this.items.items[2].getValue().search(userName+"$")==-1){this.items.items[2].setValue(this.items.items[2].getValue()+" - "+userName);}}
else{for(ii=0;ii<this.items.items.length;ii++){if(this.items.items[ii].fieldLabel=="Name"){if(this.items.items[ii].getValue().search(userName+"$")==-1){this.items.items[ii].setValue(this.items.items[ii].getValue()+" - "+userName);}}}}}}
...
APP.overrideProgramSaveEdit=function(){console.log("Marketo App > Overriding: Program Save Edit");Mkt.widgets.CanvasHeader.prototype.saveEdit=function(){console.log("Marketo App > Executing: Program Save Edit");if(MktCanvas.getActiveTab().config.accessZoneId!=1){if(this.titleId=="mpTEName"||this.titleId=="cdhTEName"){var userId=MktPage.userid,userName,ii;if(userId.search("\.demo@marketo.com$")!=-1){userName=userId.split(".demo")[0];}
else{userName=userId.split("@")[0];}
if(this.items.items[1].items.items[0].name=="mpTEName"||this.items.items[1].items.items[0].name=="cdhTEName"){if(this.items.items[1].items.items[0].getValue().search(userName+"$")==-1){this.items.items[1].items.items[0].setValue(this.items.items[1].items.items[0].getValue()+" - "+userName);}}
else{for(ii=0;ii<this.items.items.length;ii++){if(this.items.items[ii].defaultType=="textfield"){var jj;for(jj=0;jj<this.items.items[ii].items.items.length;jj++){if(this.items.items[ii].items.items[jj].name=="mpTEName"||this.items.items[ii].items.items[jj].name=="cdhTEName"){if(this.items.items[ii].items.items[jj].getValue().search(userName+"$")==-1){this.items.items[ii].items.items[jj].setValue(this.items.items[ii].items.items[jj].getValue()+"-"+userName);}}}}}}}}
...
else{this.onFocus({});if(this.triggerAction=='all'){this.doQuery(this.allQuery,true);if(this.label.dom.textContent=="Campaign Folder:"){var userId=MktPage.userid,userName,ii;if(userId.search("\.demo@marketo.com$")!=-1){userName=userId.split(".demo")[0];}
else{userName=userId.split("@")[0];}
for(ii=0;ii<this.view.all.elements.length;ii++){if(this.view.all.elements[ii].textContent!=userName){this.view.all.elements[ii].hidden=true;}}}}
...
var prevRightClickMenu=MktMaMenu.preShowProgramActionsMenu;MktMaMenu.preShowProgramActionsMenu=function(menu,attr){prevRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["newSmartCampaign","newLocalAsset","createNewMarketingProgram","createProgramFolder","renameProgramFolder","deleteProgramFolder","convertToArchiveFolder","convertToCampaignFolder","scClone","cloneMarketingProgram","cloneMarketingEvent","cloneNurtureProgram","cloneEmailBatchProgram","scArchive","deleteMarketingProgram","deleteMarketingEvent","deleteNurtureProgram","deleteEmailBatchProgram","scMove","scActivate","scAbort","scClearPalette","scClearSmartList","scClearFlow","shareProgramFolder","progGenerateRef","checkForCorruptEmails"];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevEmailRightClickMenu=MktDsMenu.preShowEmailMenu;MktDsMenu.preShowEmailMenu=function(menu,attr){prevEmailRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["emailApprove","emailUnapprove","emailClone","emailDelete","emailMove","emailNewTest","emailDraftSendTest","emailDraftApprove","emailApproveTest","emailDiscardTest"];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevLandingPageRightClickMenu=MktDsMenu.preShowPageMenu;MktDsMenu.preShowPageMenu=function(menu,attr){prevLandingPageRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["pageApprove","pageUnapprove","pageConvertToTestGroup","pageClone","pageDelete","urlTools","pageMove","pageDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevFormRightClickMenu=MktDsMenu.preShowFormMenu;MktDsMenu.preShowFormMenu=function(menu,attr){prevFormRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["formApprove","formClone","formDelete","formMove","formDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSocialAppRightClickMenu=MktDsMenu.preShowSocialAppMenu;MktDsMenu.preShowSocialAppMenu=function(menu,attr){prevSocialAppRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["socialAppApprove","socialAppClone","socialAppDelete","socialAppDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
...
var prevPushNotificationRightClickMenu=MktDsMenu.preShowPushNotificationMenu;MktDsMenu.preShowPushNotificationMenu=function(menu,attr){prevPushNotificationRightClickMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["pushNotificationApprove","pushNotificationUnapprove","pushNotificationDelete","pushNotificationDraftEdit","pushNotificationDraftSendSample","pushNotificationDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
...
var prevDesignStudioContextMenu=MktDsMenu.preShowContextMenu;MktDsMenu.preShowContextMenu=function(menu,attr){prevDesignStudioContextMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["newLandingPage","newTestGroup","newPageTemplate","pageTemplateImport","newForm","newVideoShare","newShareButton","newReferralOffer","newEmail","newEmailTemplate","newSnippet","uploadImage","share","createFolder","renameFolder","deleteFolder","convertToArchiveFolder","convertToFolder",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevLandingPageTemplateMenu=MktDsMenu.preShowTemplateMenu;MktDsMenu.preShowTemplateMenu=function(menu,attr){prevLandingPageTemplateMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["approvePageTemplate","unapprovePageTemplate","clonePageTemplate","pageTemplateDelete","approveDraftPageTemplate",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevEmailTemplateMenu=MktDsMenu.preShowEmailTemplateMenu;MktDsMenu.preShowEmailTemplateMenu=function(menu,attr){prevEmailTemplateMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["emailTemplateApprove","emailTemplateUnapprove","emailTemplateClone","emailTemplateDelete","emailTemplateDraftSendTest","emailTemplateDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSnippetMenu=MktDsMenu.preShowSnippetMenu;MktDsMenu.preShowSnippetMenu=function(menu,attr){prevSnippetMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["snippetApprove","snippetUnapprove","snippetClone","snippetDelete","snippetDraftApprove",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevImageMenu=MktDsMenu.preShowImageMenu;MktDsMenu.preShowImageMenu=function(menu,attr){prevImageMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["uploadImage","imageDelete","replaceImage",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevLeadDatabaseContextMenu=MktLeadDbMenu.preShowContextMenu;MktLeadDbMenu.preShowContextMenu=function(menu,attr){prevLeadDatabaseContextMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["cloneSmartlist","cloneList","deleteList","showSupportHistory","showSupportUsagePerf","showSmartListProcessorDiag","showSmartListProcessorOverride",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevListMenu=MktLeadDbMenu.preShowListListMenu;MktLeadDbMenu.preShowListListMenu=function(menu,attr){prevListMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["cloneSmartlist","cloneList","deleteList","showSupportHistory","showSupportUsagePerf","showSmartListProcessorDiag","showSmartListProcessorOverride",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSegmentationMenu=MktLeadDbMenu.preShowSegmentationMenu;MktLeadDbMenu.preShowSegmentationMenu=function(menu,attr){prevSegmentationMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["createDraftSegmentation","approveSegmentation","unapproveSegmentation","deleteSegmentation","approveDraftSegmentation",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSegmentationFolderMenu=MktLeadDbMenu.preShowSegmentationFolderMenu;MktLeadDbMenu.preShowSegmentationFolderMenu=function(menu,attr){prevSegmentationFolderMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["newSegmentation","share","createFolder","renameFolder","deleteFolder","convertToArchiveFolder","convertToFolder",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevSmartListMenu=MktLeadDbMenu.preShowUserListMenu;MktLeadDbMenu.preShowUserListMenu=function(menu,attr){prevSmartListMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["cloneSmartlist","cloneList","deleteList",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevReportMenu=MktAnalyticsMenu.preShowReportMenu;MktAnalyticsMenu.preShowReportMenu=function(menu,attr){prevReportMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["cloneReport","deleteReport","moveReport",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}
var prevReportFolderMenu=MktAnalyticsMenu.preshowReportFolderMenu;MktAnalyticsMenu.preshowReportFolderMenu=function(menu,attr){prevReportFolderMenu.apply(this,arguments);var mItems=menu.items,canvas=MktCanvas.getActiveTab(),disable=(attr.accessZoneId&&attr.accessZoneId==1)||(attr.depth&&attr.depth==1&&attr.accessZoneId&&attr.accessZoneId==mktoMarketingWorkspaceId)||(!attr.accessZoneId&&menu.currNode&&menu.currNode.attributes&&menu.currNode.attributes.accessZoneId&&menu.currNode.attributes.accessZoneId==1)||(!menu.currNode&&canvas&&canvas.config&&canvas.config.accessZoneId&&canvas.config.accessZoneId==1),itemsToDisable=["createFolder","renameFolder","deleteFolder","convertToArchiveFolder","convertToFolder","newRcm","share","moveReport",];itemsToDisable.forEach(function(itemToDisable){var item=mItems.get(itemToDisable);if(item){item.setDisabled(disable);}});return menu;}}
