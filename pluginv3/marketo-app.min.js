...
APP.reloadProgramAnalyzer=function(){console.log("Marketo App > Reloading: Program Analyzer");var isProgramAnalyzerTab=window.setInterval(function(){if(MktCanvas&&MktCanvas.getActiveTab()&&MktCanvas.getActiveTab().body&&MktCanvas.getActiveTab().body.dom){window.clearInterval(isProgramAnalyzerTab);console.log("DOM: "+MktCanvas.getActiveTab().body.dom);if(MktCanvas.getActiveTab().config&&MktCanvas.getActiveTab().config.guideId=="analyzer_ProgramAnalyzer"){console.log("Marketo App > Executing: Reload Program Analyzer");MktCanvas.reloadActiveTab();}}},0);}
