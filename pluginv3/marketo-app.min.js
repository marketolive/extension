...
APP.overrideDeliverabilityToolsMenuItem=function(){var isMktSuperBallMenu=window.setInterval(function(){if(typeof(MktCanvas.getEl().dom.ownerDocument.body.childNodes[17].childNodes[1].childNodes[0].childNodes[1].childNodes[1].childNodes)!=="undefined"||typeof(MktCanvas.getEl().dom.ownerDocument.body.childNodes[18].childNodes[1].childNodes[0].childNodes[1].childNodes[1].childNodes)!=="undefined"){window.clearInterval(isMktSuperBallMenu);console.log("Marketo App > Overriding: Deliverability Superball Menu Item");var superBallMenuItems,currSuperBallMenuItemSpanTags,currSuperBallMenuItemAtags,deliverabilityToolsMenuItem,communityMenuItemNum,communityMenuItemSpanTags,communityMenuItemAtags,ii,jj;MktPage.showSuperMenu();if(MktCanvas.getEl().dom.ownerDocument.body.childNodes[17].id=="ext4-ext-gen1024"){superBallMenuItems=MktCanvas.getEl().dom.ownerDocument.body.childNodes[17].childNodes[1].childNodes[0].childNodes[1].childNodes[1].childNodes;}
else if(MktCanvas.getEl().dom.ownerDocument.body.childNodes[18].id=="ext4-ext-gen1024"){superBallMenuItems=MktCanvas.getEl().dom.ownerDocument.body.childNodes[18].childNodes[1].childNodes[0].childNodes[1].childNodes[1].childNodes;}
