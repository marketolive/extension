...
if((isMktoButtonReplaced&&isMktoSubTextReplaced&&isMktoTextReplaced&&isMktoImgReplaced)||isMktoEmail1Replaced){return true;}}
else{return false;}}
...
else if(action=="preview"){console.log("Marketo App > Overlaying: Email Previewer");emailIframes=document.getElementsByTagName("iframe");if(overlay(emailIframes[0].contentWindow.document)&&overlay(emailIframes[1].contentWindow.document)){console.log("Marketo App > Overlaying: Email Interval is Cleared");window.clearInterval(isEmailEditor2);}}},0);}
...
window.onhashchange=function(){console.log("Marketo App > Window: Hash Changed");currentUrl=window.location.href;console.log("Marketo App > Window: URL = "+currentUrl);if(Mkt3&&Mkt3.DL&&Mkt3.DL.getDlToken()){var isNewUrlFragment=window.setInterval(function(){if(currUrlFragment!=Mkt3.DL.getDlToken()){window.clearInterval(isNewUrlFragment);currUrlFragment=Mkt3.DL.getDlToken();console.log("Marketo App > Window: URL Fragment = "+currUrlFragment);if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;console.log("Marketo App > Window: Comp Fragment = "+currCompFragment);}}},0);}
...
else if(currUrlFragment.search(mktoEmailPreviewFragmentRegex)!=-1){console.log("Marketo App > Location: Email Previewer");APP.overlayEmail("preview");}}}
