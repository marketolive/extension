...
if(event){heapEventProps={app:heapApp,assetName:event.assetName,assetId:event.assetId,assetType:event.assetType,assetPath:event.assetPath,workspaceId:event.workspaceId,workspaceName:event.workspaceName,area:"",url:currentUrl};if(event.assetArea){heapEventProps.area=event.assetArea;}
else{heapEventProps.area=heapArea;}
