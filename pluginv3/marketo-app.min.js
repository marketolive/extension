var devExtensionId="dokkjhbgengdlccldgjnbilajdbjlnhm",prodExtensionId="onibnnoghllldiecboelbpcaeggfiohl",extensionId=devExtensionId;{}
console.log("Marketo App > Running");window.mkto_live_extension_state="MarketoLive extension is alive!";var currentUrl=window.location.href,extensionMinVersion="5.0.0",mktoAppDomain="^https:\/\/app-[a-z0-9]+\.marketo\.com",mktoDesignerDomain="^https:\/\/[a-z0-9]+-[a-z0-9]+\.marketodesigner\.com",mktoDesignerHost="na-sjp.marketodesigner.com",mktoWizard=mktoAppDomain+"/m#",mktoEmailDesigner=mktoDesignerDomain+"/ds",mktoLandingPageDesigner=mktoDesignerDomain+"/lpeditor/",mktoEmailInsightsLink="http://www.marketolive.com/en/analytics/email-insights-summit-demo-1",mktoEmailDeliverabilityToolsLink="https://250ok.com/login?submit=true",mktoDemoAccountMatch="^mktodemoaccount",mktoMyMarketoFragment="MM0A1",mktoCalendarFragment="CAL",mktoAnalyticsFragment="AR",mktoReportFragmentRegex=new RegExp("^AR[^!]+!$","i"),mktoModelerFragmentRegex=new RegExp("^RCM[^!]+!$","i"),mktoAnalyticsFragmentMatch=new RegExp("^AR[^!]+!$|^RCM[^!]+!$","i"),mktoModelerPreviewFragmentRegex=new RegExp("preview=true&approved=true/#RCM[^!]+!$","i"),mktoAnalyticsDefaultFragment="AH0A1ZN17",mktoAccountBasedMarketingFragment="ABM0A1",mktoAdBridgeSmartListFragment="SL1119566B2LA1",mktoAdminSalesforceFragment="SF0A1",mktoAdminRcaCustomFieldSync="CFS0B2",mktoPersonDetailPath="/leadDatabase/loadLeadDetail",mktoDefaultDiyLandingPageResponsiveEditFragment="LPE11822",mktoDefaultWorkspaceAssetId="15",mktoJapaneseWorkspaceAssetId="19848",mktoFinservWorkspaceAssetId="20806",mktoHealthcareWorkspaceAssetId="20826",mktoHigherEdWorkspaceAssetId="20846",mktoManufacturingWorkspaceAssetId="26410",mktoTechnologyWorkspaceAssetId="26489",mktoTravelLesiureWorkspaceAssetId="27588",mktoUserWorkspaceId=172,userWorkspaceName="My Workspace",waitAfterDiscard=2000,restoreEmailInsights,origEmailInsightsTileLink,origEmailInsightsMenuItemLink,currUrlFragment,currCompFragment,userName,accountString,adminUserNamesMatch="^mktodemolivemaster@marketo\.com$|^admin(\.[a-z]{0,2})?@(marketolive.com$|mktodemoaccount)|^mktodemoaccount[a-z0-9]*@marketo\.com$|^marketodemo.*@gmail\.com$",mktoAccountStringMaster="mktodemolivemaster",mktoAccountStringQe="globalsales",mktoAccountString106="mktodemoaccount106",mktoAccountString106d="mktodemoaccount106d",mktoAccountStringsMatch="^"+mktoAccountString106+"$|^"+mktoAccountString106d+"$",mktoWorkingFoldersToHide=new RegExp("^(Manufacturing|Healthcare|Healthcare - backup|Telecommunications|Financial Services)$","i"),mktoOperationalFolders=new RegExp("^(_Operational|_Operations)","i"),mktoMasterMarketingActivitiesEnglishFragment="MA19A1",mktoMarketingActivitiesDefaultFragment="MA15A1",mktoMarketingActivitiesUserFragment="MA19802A1",mktoMarketingActivitiesJapaneseFragment="MA19848A1",mktoMarketingActivitiesFinservFragment="MA20806A1",mktoMarketingActivitiesHealthcareFragment="MA20826A1",mktoMarketingActivitiesHigherEdFragment="MA20846A1",mktoMarketingActivitiesManufacturingFragment="MA26410A1",mktoMarketingActivitiesTechnologyFragment="MA26489A1",mktoMarketingActivitiesTravelLeisureFragment="MA27588A1",mktoMasterLeadDatabaseEnglishFragment="ML0A1ZN5",mktoLeadDatabaseDefaultFragment="ML0A1ZN2",mktoLeadDatabaseUserFragment="ML0A1ZN19788",mktoLeadDatabaseJapaneseFragment="ML0A1ZN19834",mktoLeadDatabaseFinservFragment="ML0A1ZN20792",mktoLeadDatabaseHealthcareFragment="ML0A1ZN20812",mktoLeadDatabaseHigherEdFragment="ML0A1ZN20832",mktoLeadDatabaseManufacturingFragment="ML0A1ZN26396",mktoLeadDatabaseTechnologyFragment="ML0A1ZN26475",mktoLeadDatabaseTravelLeisureFragment="ML0A1ZN27574",mktoAdminEmailEmailFragment="EA0A1",mktoAdminWebServicesFragment="MW0A1",mktoDisableButtonsFragmentMatch="^("+mktoMasterMarketingActivitiesEnglishFragment+"|"+mktoMarketingActivitiesDefaultFragment+"|"+mktoMarketingActivitiesUserFragment+"|"+mktoMarketingActivitiesJapaneseFragment+"|"+mktoMarketingActivitiesFinservFragment+"|"+mktoMarketingActivitiesHealthcareFragment+"|"+mktoMarketingActivitiesHigherEdFragment+"|"+mktoMarketingActivitiesManufacturingFragment+"|"+mktoMarketingActivitiesTechnologyFragment+"|"+mktoMarketingActivitiesTravelLeisureFragment+"|"+mktoMasterLeadDatabaseEnglishFragment+"|"+mktoLeadDatabaseDefaultFragment+"|"+mktoLeadDatabaseUserFragment+"|"+mktoLeadDatabaseJapaneseFragment+"|"+mktoLeadDatabaseFinservFragment+"|"+mktoLeadDatabaseHealthcareFragment+"|"+mktoLeadDatabaseHigherEdFragment+"|"+mktoLeadDatabaseManufacturingFragment+"|"+mktoLeadDatabaseTechnologyFragment+"|"+mktoLeadDatabaseTravelLeisureFragment+"|"+mktoAdminEmailEmailFragment+"|"+mktoAdminWebServicesFragment+")$",mktoOppInfluenceAnalyzerFragment="AR1559A1!",mktoProgramAnalyzerFragment="AR1544A1!",mktoModelerFragment="RCM70A1!",mktoSuccessPathAnalyzerFragment="AR1682A1!",mktoAnalyzersFragmentMatch="^"+mktoOppInfluenceAnalyzerFragment+"$|^"+mktoProgramAnalyzerFragment+"$|^"+mktoModelerFragment+"$|^"+mktoSuccessPathAnalyzerFragment+"$",mktoMobilePushNotificationFragment="MPN",mktoInAppMessageFragment="IAM",mktoSmsMessageFragment="SMS",mktoSocialAppFragment="SOA",mktoOtherAssetsFragmentMatch="^"+mktoMobilePushNotificationFragment+"|^"+mktoInAppMessageFragment+"|^"+mktoSmsMessageFragment+"|^"+mktoSocialAppFragment,mktoAbmDiscoverMarketoCompaniesFragment="ABMDM",mktoAbmDiscoverCrmAccountsFragment="ABMDC",mktoAbmNamedAccountFragment="NA",mktoAbmImportNamedAccountsFragment="ABMIA",mktoAbmFragmentMatch="^("+mktoAbmDiscoverMarketoCompaniesFragment+"|"+mktoAbmDiscoverCrmAccountsFragment+"|"+mktoAbmNamedAccountFragment+"|"+mktoAbmImportNamedAccountsFragment+")$",mktoEmailEditFragment="EME",mktoEmailPreviewFragmentRegex=new RegExp("^EME[0-9]+&isPreview","i"),mktoEmailPreviewFragment2="EME[0-9]+&isPreview",mktoEmailPreviewFragment="EMP",mktoEmailTemplateEditFragment="EMTE",mktoLandingPageEditFragment="LPE",mktoLandingPagePreviewFragment="LPP",mktoLandingPagePreviewDraftFragment="LPPD",mktoLandingPageTemplateEditFragment="LPTE",mktoLandingPageTemplatePreviewFragment="LPTPD",mktoFormEditFragment="FOE",mktoFormPreviewFragment="FOP",mktoFormPreviewDraftFragment="FOPD",mktoPushNotificationEditFragment="MPNE",mktoMobilePushNotificationPreviewFragment="MPNP",mktoInAppMessageEditFragment="IAME",mktoInAppMessagePreviewFragment="IAMP",mktoSmsMessageEditFragment="SME",mktoSocialAppEditFragment="SOAE",mktoSocialAppPreviewFragment="SOAP",mktoAbTestEditFragment="EBE",mktoEmailTestGroupEditFragment="CCE",mktoSnippetEditFragment="SNE",mktoSnippetPreviewFragment="SNP",mktoDesignersFragmentMatch="^"+mktoEmailEditFragment+"$|^"+mktoEmailPreviewFragment2+"|^"+mktoEmailPreviewFragment+"$|^"+mktoEmailTemplateEditFragment+"$|^"+mktoLandingPageEditFragment+"$|^"+mktoLandingPagePreviewFragment+"$|^"+mktoLandingPagePreviewDraftFragment+"$|^"+mktoLandingPageTemplateEditFragment+"$|^"+mktoLandingPageTemplatePreviewFragment+"$|^"+mktoFormEditFragment+"$|^"+mktoFormPreviewFragment+"$|^"+mktoFormPreviewDraftFragment+"$|^"+mktoPushNotificationEditFragment+"$|^"+mktoMobilePushNotificationPreviewFragment+"$|^"+mktoInAppMessageEditFragment+"$|^"+mktoInAppMessagePreviewFragment+"$|^"+mktoSmsMessageEditFragment+"$|^"+mktoSocialAppEditFragment+"$|^"+mktoSocialAppPreviewFragment+"$|^"+mktoAbTestEditFragment+"$|^"+mktoEmailTestGroupEditFragment+"$|^"+mktoSnippetEditFragment+"$|^"+mktoSnippetPreviewFragment+"$",mktoDefaultWorkspaceId=1,mktoJapaneseWorkspaceId=173,mktoFinservWorkspaceId=174,mktoHealthcareWorkspaceId=175,mktoHigherEdWorkspaceId=176,mktoManufacturingWorkspaceId=184,mktoTechnologyWorkspaceId=185,mktoTravelLesiureWorkspaceId=186,mktoUnknownWorkspaceId=-1,mktoGoldenWorkspacesMatch="^"+mktoDefaultWorkspaceId+"$|^"+mktoJapaneseWorkspaceId+"$|^"+mktoFinservWorkspaceId+"$|^"+mktoHealthcareWorkspaceId+"$|^"+mktoHigherEdWorkspaceId+"$|^"+mktoManufacturingWorkspaceId+"$|^"+mktoTechnologyWorkspaceId+"$|^"+mktoTravelLesiureWorkspaceId+"$|^"+mktoUnknownWorkspaceId+"$",origMenuShowAtFunc,origExplorerPanelAddNode,origExplorerPanelRemoveNodes,origExplorerPanelUpdateNodeText,APP=APP||{};APP.getCookie=function(cookieName){console.log("Marketo App > Getting: Cookie "+cookieName);var name=cookieName+'=',cookies=document.cookie.split(';'),currCookie;for(var ii=0;ii<cookies.length;ii++){currCookie=cookies[ii].trim();if(currCookie.indexOf(name)==0){return currCookie.substring(name.length,currCookie.length);}}
console.log("Marketo App > Getting: Cookie "+cookieName+" not found");return null;};APP.webRequest=function(url,params,method,async,responseType,callback){var xmlHttp=new XMLHttpRequest(),result;xmlHttp.onreadystatechange=function(){if(callback&&xmlHttp.readyState==4&&xmlHttp.status==200)
result=callback(xmlHttp.response);}
if(async&&xmlHttp.responseType){xmlHttp.responseType=responseType;}
xmlHttp.open(method,url,async);xmlHttp.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=UTF-8");if(url.search(/^\//)!=-1||url.replace(/^[a-z]+:\/\/([^\/]+)\/?.*$/,"$1")==window.location.host){xmlHttp.setRequestHeader("X-Requested-With","XMLHttpRequest");}
xmlHttp.send(params);return result;};APP.formatText=function(text){var splitText=text.trim().split(" "),formattedText="";for(var ii=0;ii<splitText.length;ii++){if(ii!=0){formattedText+=" ";}
formattedText+=splitText[ii].charAt(0).toUpperCase()+splitText[ii].substring(1).toLowerCase();}
return formattedText;};APP.validateDemoExtensionCheck=function(isValidExtension){console.log("Marketo App > Validating: Demo Extension Check");if(isValidExtension){window.mkto_live_extension_state="MarketoLive extension is alive!";console.log("Marketo App > Validating: Demo Extension IS Valid");}else if(MktPage&&MktPage.validateDemoExtension){window.mkto_live_extension_state=null;MktPage.validateDemoExtension(new Date());console.log("Marketo App > Validating: Demo Extension IS NOT Valid");}};APP.getWorkspaceName=function(workspaceId){var workspaceName;switch(parseInt(workspaceId)){case mktoDefaultWorkspaceId:workspaceName="Default";break;case mktoJapaneseWorkspaceId:workspaceName="デモ";break;case mktoFinservWorkspaceId:workspaceName="Financial Services";break;case mktoHealthcareWorkspaceId:workspaceName="Healthcare";break;case mktoHigherEdWorkspaceId:workspaceName="Higher Education";break;case mktoManufacturingWorkspaceId:workspaceName="Manufacturing";break;case mktoTechnologyWorkspaceId:workspaceName="Technology";break;case mktoTravelLesiureWorkspaceId:workspaceName="Travel Leisure";break;case mktoUserWorkspaceId:workspaceName=userWorkspaceName;break;default:workspaceName="Unknown";break;}
return workspaceName;};APP.getAssetCompCode=function(compType){var compCode;switch(compType){case"Marketing Folder":compCode="MF";break;case"Marketing Program":compCode="PG";break;case"Marketing Event":compCode="ME";break;case"Nurture Program":compCode="NP";break;case"Email Batch Program":compCode="EBP";break;case"List":compCode="ST";break;case"Smart List":compCode="SL";break;case"Smart Campaign":compCode="SC";break;case"Landing Page Form":compCode="FO";break;case"Landing Page":compCode="LP";break;case"Landing Page Test Group":compCode="LP";break;case"Landing Page Template":compCode="LT";break;case"Email":compCode="EM";break;case"Test Group":compCode="TG";break;case"Email Template":compCode="ET";break;case"Social App":compCode="SOA";break;case"Mobile Push Notification":compCode="MPN";break;case"In-App Message":compCode="IAM";break;case"SMS Message":compCode="SMS";break;case"Segmentation":compCode="SG";break;case"Report":compCode="AR";break;case"Revenue Cycle Model":compCode="RCM";break;case"Snippet":compCode="SN";break;case"Image":compCode="FI";break;}
return compCode;};APP.trackTreeNodeEdits=function(){console.log("Marketo App > Tracking: Edits to Tree Nodes");var violationMsg={action:"mktoLiveMessage",id:"Not Permitted",title:"Not Permitted",notify:"",requireInteraction:true};if(typeof(Mkt)!=="undefined"&&Mkt&&Mkt.main&&Mkt.main.ExplorerPanel&&Mkt.main.ExplorerPanel.prototype&&Mkt.main.ExplorerPanel.prototype.addNode){if(typeof(origExplorerPanelAddNode)!=="function"){origExplorerPanelAddNode=Mkt.main.ExplorerPanel.prototype.addNode;}
Mkt.main.ExplorerPanel.prototype.addNode=function(parentId,nodeConfig,selected){if(nodeConfig&&((nodeConfig.z&&nodeConfig.z.toString().search(mktoGoldenWorkspacesMatch)!=-1)||(nodeConfig.accessZoneId&&nodeConfig.accessZoneId.toString().search(mktoGoldenWorkspacesMatch)!=-1))){var changedNodeInfo="\n>*Added Node:* "+nodeConfig.compType+" | "+nodeConfig.text+" | "+"https://"+window.location.host+"/#"+APP.getAssetCompCode(nodeConfig.compType)+nodeConfig.compId,workspaceId,workspaceName,workspaceInfo,userInfo,parentNodeInfo;if(nodeConfig.z){workspaceId=nodeConfig.z;workspaceName=APP.getWorkspaceName(nodeConfig.z);}else{workspaceId=nodeConfig.accessZoneId;workspaceName=APP.getWorkspaceName(nodeConfig.accessZoneId);}
workspaceInfo="\n>*Workspace:* "+workspaceName;if(MktPage&&MktPage.userName&&MktPage.userid){userInfo="\n>*User:* "+MktPage.userName+" ("+MktPage.userid+") ";}
if(this.getNodeById(parentId)&&this.getNodeById(parentId).attributes&&this.getNodeById(parentId).attributes.text&&this.getNodeById(parentId).attributes.compType&&this.getNodeById(parentId).attributes.compId){parentNodeInfo="\n>*Parent Node:* "+this.getNodeById(parentId).attributes.compType+" | "+this.getNodeById(parentId).attributes.text+" | "+"https://"+window.location.host+"/#"+APP.getAssetCompCode(this.getNodeById(parentId).attributes.compType)+this.getNodeById(parentId).attributes.compId;}
APP.webRequest('https://hooks.slack.com/services/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','{"text": "*Unauthorized Changes*'+userInfo+workspaceInfo+parentNodeInfo+changedNodeInfo+'"}','POST',true,'');APP.heapTrack("track",{name:"Unauthorized Node Added",assetName:nodeConfig.text,assetId:nodeConfig.compId,assetType:nodeConfig.compType,workspaceId:workspaceId,workspaceName:workspaceName});violationMsg.notify="Do not make changes to the "+workspaceName+" Workspace!",chrome.runtime.sendMessage(extensionId,violationMsg);}
origExplorerPanelAddNode.apply(this,arguments);};}else{console.log("Marketo App > Skipping: Track Adding Tree Nodes");}
if(typeof(Mkt)!=="undefined"&&Mkt&&Mkt.main&&Mkt.main.ExplorerPanel&&Mkt.main.ExplorerPanel.prototype&&Mkt.main.ExplorerPanel.prototype.removeNodes){if(typeof(origExplorerPanelRemoveNodes)!=="function"){origExplorerPanelRemoveNodes=Mkt.main.ExplorerPanel.prototype.removeNodes;}
Mkt.main.ExplorerPanel.prototype.removeNodes=function(nodeIds){if(this.getNodeById(nodeIds[0])&&this.getNodeById(nodeIds[0]).attributes&&this.getNodeById(nodeIds[0]).attributes.accessZoneId&&this.getNodeById(nodeIds[0]).attributes.accessZoneId.toString().search(mktoGoldenWorkspacesMatch)!=-1){var nodeConfig=this.getNodeById(nodeIds[0]).attributes,workspaceName=APP.getWorkspaceName(nodeConfig.accessZoneId),workspaceInfo="\n>*Workspace:* "+workspaceName,changedNodeInfo="\n>*Removed Node:* "+nodeConfig.compType+" | "+nodeConfig.text+" | "+"https://"+window.location.host+"/#"+APP.getAssetCompCode(nodeConfig.compType)+nodeConfig.compId,userInfo;if(MktPage&&MktPage.userName&&MktPage.userid){userInfo="\n>*User:* "+MktPage.userName+" ("+MktPage.userid+") ";}
APP.webRequest('https://hooks.slack.com/services/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','{"text": "*Unauthorized Changes*'+userInfo+workspaceInfo+changedNodeInfo+'"}','POST',true,'');APP.heapTrack("track",{name:"Unauthorized Node Removed",assetName:nodeConfig.text,assetId:nodeConfig.compId,assetType:nodeConfig.compType,workspaceId:nodeConfig.accessZoneId,workspaceName:workspaceName});violationMsg.notify="Do not make changes to the "+workspaceName+" Workspace!",chrome.runtime.sendMessage(extensionId,violationMsg);}
origExplorerPanelRemoveNodes.apply(this,arguments);};}else{console.log("Marketo App > Skipping: Track Removing Tree Nodes");}
if(typeof(Mkt)!=="undefined"&&Mkt&&Mkt.main&&Mkt.main.ExplorerPanel&&Mkt.main.ExplorerPanel.prototype&&Mkt.main.ExplorerPanel.prototype.updateNodeText){if(typeof(origExplorerPanelUpdateNodeText)!=="function"){origExplorerPanelUpdateNodeText=Mkt.main.ExplorerPanel.prototype.updateNodeText;}
Mkt.main.ExplorerPanel.prototype.updateNodeText=function(nodeId,text){if(this.getNodeById(nodeId)&&this.getNodeById(nodeId).attributes&&this.getNodeById(nodeId).attributes.accessZoneId&&this.getNodeById(nodeId).attributes.accessZoneId.toString().search(mktoGoldenWorkspacesMatch)!=-1){var nodeConfig=this.getNodeById(nodeId).attributes,workspaceName=APP.getWorkspaceName(nodeConfig.accessZoneId),workspaceInfo="\n>*Workspace:* "+workspaceName,changedNodeInfo="\n>*Renamed Node:* "+nodeConfig.compType+" | From '"+nodeConfig.text+"' to '"+text+"' | "+"https://"+window.location.host+"/#"+APP.getAssetCompCode(nodeConfig.compType)+nodeConfig.compId,userInfo;if(MktPage&&MktPage.userName&&MktPage.userid){userInfo="\n>*User:* "+MktPage.userName+" ("+MktPage.userid+") ";}
APP.webRequest('https://hooks.slack.com/services/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','{"text": "*Unauthorized Changes*'+userInfo+workspaceInfo+changedNodeInfo+'"}','POST',true,'');APP.heapTrack("track",{name:"Unauthorized Node Renamed",assetName:nodeConfig.text,assetId:nodeConfig.compId,assetType:nodeConfig.compType,workspaceId:nodeConfig.accessZoneId,workspaceName:workspaceName});violationMsg.notify="You are not permitted to make changes to "+workspaceName+"!\n\nThe Demo Services Team has been notified of this violation.",chrome.runtime.sendMessage(extensionId,violationMsg);}
origExplorerPanelUpdateNodeText.apply(this,arguments);};}else{console.log("Marketo App > Skipping: Track Renaming Tree Nodes");}};APP.disablePropertyPanelSaving=function(){console.log("Marketo App > Disabling: Saving of Landing Page Property Panel & Sync Error Message");if(typeof(Mkt3)!=="undefined"&&Mkt3&&Mkt3.controller&&Mkt3.controller.editor&&Mkt3.controller.editor.LandingPagePropertyPanel&&Mkt3.controller.editor.LandingPagePropertyPanel.prototype&&Mkt3.controller.editor.LandingPagePropertyPanel.prototype.fireSyncProperties){Mkt3.controller.editor.LandingPagePropertyPanel.prototype.fireSyncProperties=function(){console.log("Marketo App > Executing: Disable Saving of Landing Page Property Panel & Sync Error Message");};}};APP.disableConfirmationMessage=function(){console.log("Marketo App > Disabling: Smart Campaign Delete Confirmation Message");if(typeof(Mkt)!=="undefined"&&Mkt3&&Mkt.widgets&&Mkt.widgets.DataPanel&&Mkt.widgets.DataPanel.prototype&&Mkt.widgets.DataPanel.prototype.clickClose){Mkt.widgets.DataPanel.prototype.clickClose=function(){console.log("Marketo App > Executing: Disable Smart Campaign Delete Confirmation Message");var hasChanges=this.hasSettings(),showTriggerWarning=false;if(this.isSmartlist&&this.dpMeta.trigger){var triggerCount=this.dpMgr.getTriggers().length;if(triggerCount==1){showTriggerWarning=true;}}
...
getNewProgramAssetDetailsResponse=APP.cloneSmartCampaignState(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,scForceActivate);APP.setProgramReportFilter(getNewProgramAssetDetailsResponse,cloneToFolderId);}}}}else{currOrigProgramTreeNode=currTreeNode.children[jj];cloneProgramResponse=APP.cloneProgram(cloneToSuffix,cloneFolderResponse.JSONResults.actions[0].parameters[0][0].id,currOrigProgramTreeNode);if(cloneProgramResponse){getOrigProgramSettingsResponse=APP.getProgramSettings(currOrigProgramTreeNode);if(getOrigProgramSettingsResponse&&getOrigProgramSettingsResponse.data&&(inheritPeriodCost||numOfPeriodCostMonths>0)){APP.clonePeriodCost(getOrigProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,numOfPeriodCostMonths,parseInt(periodCostOffset),inheritPeriodCost);}
getNewProgramSettingsResponse=APP.getProgramSettings({"compId":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,"compType":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType});if(getNewProgramSettingsResponse&&getNewProgramSettingsResponse.data&&tagName&&tagValue){APP.setProgramTag(getNewProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,tagName,tagValue);}
if(cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType=="Nurture Program"){APP.cloneNurtureCadence(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId);}
getNewProgramAssetDetailsResponse=APP.cloneSmartCampaignState(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,scForceActivate);APP.setProgramReportFilter(getNewProgramAssetDetailsResponse,cloneToFolderId);}}}}}else{var currOrigProgramTreeNode=currTreeNode;cloneProgramResponse=APP.cloneProgram(cloneToSuffix,cloneToFolderId,currOrigProgramTreeNode);if(cloneProgramResponse){getOrigProgramSettingsResponse=APP.getProgramSettings(currOrigProgramTreeNode);if(getOrigProgramSettingsResponse&&getOrigProgramSettingsResponse.data&&(inheritPeriodCost||numOfPeriodCostMonths>0)){APP.clonePeriodCost(getOrigProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,numOfPeriodCostMonths,parseInt(periodCostOffset),inheritPeriodCost);}
getNewProgramSettingsResponse=APP.getProgramSettings({"compId":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,"compType":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType});if(getNewProgramSettingsResponse&&getNewProgramSettingsResponse.data&&tagName&&tagValue){APP.setProgramTag(getNewProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,tagName,tagValue);}
if(cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType=="Nurture Program"){APP.cloneNurtureCadence(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId);}
getNewProgramAssetDetailsResponse=APP.cloneSmartCampaignState(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,scForceActivate);APP.setProgramReportFilter(getNewProgramAssetDetailsResponse,cloneToFolderId);}}}}else{var currOrigProgramTreeNode=_this.currNode.attributes;cloneProgramResponse=APP.cloneProgram(cloneToSuffix,cloneToFolderId,currOrigProgramTreeNode);if(cloneProgramResponse){getOrigProgramSettingsResponse=APP.getProgramSettings(currOrigProgramTreeNode);if(getOrigProgramSettingsResponse&&getOrigProgramSettingsResponse.data&&(inheritPeriodCost||numOfPeriodCostMonths>0)){APP.clonePeriodCost(getOrigProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,numOfPeriodCostMonths,parseInt(periodCostOffset),inheritPeriodCost);}
getNewProgramSettingsResponse=APP.getProgramSettings({"compId":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,"compType":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType});if(getNewProgramSettingsResponse&&getNewProgramSettingsResponse.data&&tagName&&tagValue){APP.setProgramTag(getNewProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,tagName,tagValue);}
if(cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType=="Nurture Program"){APP.cloneNurtureCadence(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId);}
...
if(count>1000||(isSubtitleUpdated&&isTitleUpdated)){console.log("Marketo App > Updated: Landing Page Title & Subtitle: "+count);window.clearInterval(isLandingPageEditorComponentStore);}
...
if(waitForLoadMsg.isVisible()){window.setTimeout(function(){Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor").reloadEmail();waitForLoadMsg.hide();},7500);}};console.log("Marketo App > Editing: Email Variables");if(mode=="edit"){var isWebRequestSession=window.setInterval(function(){console.log("Marketo App > Waiting: Web Request Session Data");if(typeof(Mkt3)!=="undefined"&&Mkt3&&Mkt3.DL&&Mkt3.DL.dl&&Mkt3.DL.dl.compId&&typeof(MktSecurity)!=="undefined"&&MktSecurity&&MktSecurity.getXsrfId()&&typeof(Ext)!=="undefined"&&Ext&&Ext.id(null,':')){console.log("Marketo App > Editing: Email HTML");window.clearInterval(isWebRequestSession);editHtml();}},0);if(asset){editAssetVars(asset);}else{var isEmailEditorVariables=window.setInterval(function(){console.log("Marketo App > Waiting: Email Editor Variables");if(!waitForReloadMsg.isVisible()&&typeof(Mkt3)!=="undefined"&&Mkt3&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor")&&Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor").getEmail()&&Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor").getEmail().getVariableValues()&&Object.keys(Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor").getEmail().getVariableValues()).length!=0&&Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor").getEmail().setVariableValue){console.log("Marketo App > Editing: Email Editor Variables");window.clearInterval(isEmailEditorVariables);editAssetVars(Mkt3.app.controllers.get("Mkt3.controller.editor.email2.EmailEditor").getEmail());}},0);}}else if(mode=="preview"){console.log("Marketo App > Editing: Email Previewer Variables");}}};APP.disableAnalyticsSaving=function(assetType,mode){console.log("Marketo App > Disabling: Analytics Saving for "+assetType);var isAnalyticsAsset;isAnalyticsAsset=window.setInterval(function(){if(typeof(MktCanvas)!=="undefined"&&MktCanvas&&MktCanvas.getActiveTab()&&MktCanvas.getActiveTab().config&&MktCanvas.getActiveTab().config.accessZoneId){window.clearInterval(isAnalyticsAsset);var assetNode=MktCanvas.getActiveTab().config,heapEvent={name:"",assetName:"",assetType:assetNode.compType,assetId:assetNode.expNodeId,workspaceId:assetNode.accessZoneId,workspaceName:""},titleReplaceRegex=new RegExp("\\([^\\)]+\\)$");switch(mode){case"edit":APP.disableSaving();APP.disableMenus();APP.hideToolbarItems();APP.disableFormSaveButtons();heapEvent.assetArea="Editor";break;case"preview":APP.disableFormSaveButtons();heapEvent.assetArea="Previewer";break;default:APP.disableSaving();APP.disableMenus();APP.hideToolbarItems();APP.disableFormSaveButtons();heapEvent.assetArea="Full Screen";}
...
{var me=this,menuItems=["[action=submit]","[action=import]",],mItems=this.query(menuItems.toString());if(mItems){mItems.forEach(function(item){if(item){item.setDisabled(true);if(me.getXType()=="emailAddMultipleDomainForm"){item.stayDisabled=true;}}});}}
...
switch(assetType){case"landingPage":var canDiscardLandingPageDrafts=window.setInterval(function(){if(typeof(mktLPLManager)!=="undefined"&&mktLPLManager){window.clearInterval(canDiscardLandingPageDrafts);APP.discardLandingPageDrafts(lpIds);}},0);break;case"email":var canDiscardEmailDrafts=window.setInterval(function(){if(typeof(mktEmManager)!=="undefined"&&mktEmManager.discardDraft){window.clearInterval(canDiscardEmailDrafts);APP.discardEmailDrafts(emIds);}},0);break;case"other":var canDiscardOtherDrafts=window.setInterval(function(){if(typeof(Ext4)!=="undefined"&&Ext4&&Ext4.getStore&&Ext4.create&&typeof(Mkt3)!=="undefined"&&Mkt3){window.clearInterval(canDiscardOtherDrafts);APP.discardOtherDrafts("Form",formIds);APP.discardOtherDrafts("MobilePushNotification",pushIds);APP.discardOtherDrafts("InAppMessage",inAppIds);APP.discardOtherDrafts("SmsMessage",smsIds);APP.discardOtherDrafts("SocialApp",socIds);}},0);break;case"all":var canDiscardLandingPageDrafts,canDiscardEmailDrafts,canDiscardOtherDrafts;canDiscardLandingPageDrafts=window.setInterval(function(){if(typeof(mktLPLManager)!=="undefined"&&mktLPLManager){window.clearInterval(canDiscardLandingPageDrafts);APP.discardLandingPageDrafts(lpIds);}},0);canDiscardEmailDrafts=window.setInterval(function(){if(typeof(mktEmManager)!=="undefined"&&mktEmManager.discardDraft){window.clearInterval(canDiscardEmailDrafts);APP.discardEmailDrafts(emIds);}},0);canDiscardOtherDrafts=window.setInterval(function(){if(typeof(Ext4)!=="undefined"&&Ext4&&Ext4.getStore&&Ext4.create&&typeof(Mkt3)!=="undefined"&&Mkt3){window.clearInterval(canDiscardOtherDrafts);APP.discardOtherDrafts("Form",formIds);APP.discardOtherDrafts("MobilePushNotification",pushIds);APP.discardOtherDrafts("InAppMessage",inAppIds);APP.discardOtherDrafts("SmsMessage",smsIds);APP.discardOtherDrafts("SocialApp",socIds);}},0);break;}};APP.dateDiffInDays=function(a,b){var _MS_PER_DAY=1000*60*60*24,utc1=Date.UTC(a.getFullYear(),a.getMonth(),a.getDate()),utc2=Date.UTC(b.getFullYear(),b.getMonth(),b.getDate());return Math.floor((utc2-utc1)/_MS_PER_DAY);};APP.applyUserMgmt=function(){console.log("Marketo App > Executing: Applying User Management");APP.getUserRoles=function(language){var roles;switch(MktPage.savedState.custPrefix){case mktoAccountStringMaster:if(language=="日本語（日本）"){roles='[{"id":1,"allzones":false,"zones":[]},{"id":1003,"allzones":true,"zones":[]},{"id":101,"allzones":false,"zones":[]},{"id":1001,"allzones":false,"zones":[]},{"id":102,"allzones":false,"zones":[]},{"id":1002,"allzones":true,"zones":[]},{"id":25,"allzones":false,"zones":[]},{"id":24,"allzones":false,"zones":[]},{"id":2,"allzones":false,"zones":[]},{"id":103,"allzones":false,"zones":[]}]';}else{roles='[{"id":1,"allzones":false,"zones":[]},{"id":1003,"allzones":true,"zones":[]},{"id":101,"allzones":false,"zones":[]},{"id":1001,"allzones":false,"zones":[]},{"id":102,"allzones":false,"zones":[]},{"id":1002,"allzones":false,"zones":[{"id":1}]},{"id":25,"allzones":false,"zones":[]},{"id":24,"allzones":false,"zones":[]},{"id":2,"allzones":false,"zones":[]},{"id":103,"allzones":false,"zones":[]}]';}
break;case mktoAccountString106:if(language=="日本語（日本）"){roles='[{"id":1,"allzones":false,"zones":[]},{"id":113,"allzones":true,"zones":[{"id":"43"},{"id":"145"},{"id":"188"},{"id":"170"},{"id":"166"},{"id":"181"},{"id":"39"},{"id":"100"},{"id":"25"},{"id":"1"},{"id":"2"},{"id":"187"},{"id":"174"},{"id":"51"},{"id":"59"},{"id":"175"},{"id":"176"},{"id":"179"},{"id":"177"},{"id":"178"},{"id":"155"},{"id":"183"},{"id":"101"},{"id":"184"},{"id":"172"},{"id":"169"},{"id":"15"},{"id":"14"},{"id":"189"},{"id":"104"},{"id":"136"},{"id":"153"},{"id":"185"},{"id":"134"},{"id":"186"},{"id":"95"},{"id":"18"},{"id":"173"}]},{"id":104,"allzones":false,"zones":[]},{"id":107,"allzones":false,"zones":[]},{"id":102,"allzones":false,"zones":[{"id":"172"}]},{"id":109,"allzones":false,"zones":[{"id":"1"},{"id":"174"},{"id":"175"},{"id":"176"},{"id":"184"},{"id":"185"},{"id":"186"},{"id":"173"}]},{"id":105,"allzones":false,"zones":[]},{"id":25,"allzones":false,"zones":[]},{"id":24,"allzones":false,"zones":[]},{"id":2,"allzones":false,"zones":[]}]';}else{roles='[{"id":1,"allzones":false,"zones":[]},{"id":113,"allzones":true,"zones":[{"id":"43"},{"id":"145"},{"id":"188"},{"id":"170"},{"id":"166"},{"id":"181"},{"id":"39"},{"id":"100"},{"id":"25"},{"id":"1"},{"id":"2"},{"id":"187"},{"id":"174"},{"id":"51"},{"id":"59"},{"id":"175"},{"id":"176"},{"id":"179"},{"id":"177"},{"id":"178"},{"id":"155"},{"id":"183"},{"id":"101"},{"id":"184"},{"id":"172"},{"id":"169"},{"id":"15"},{"id":"14"},{"id":"189"},{"id":"104"},{"id":"136"},{"id":"153"},{"id":"185"},{"id":"134"},{"id":"186"},{"id":"95"},{"id":"18"},{"id":"173"}]},{"id":104,"allzones":false,"zones":[]},{"id":107,"allzones":false,"zones":[]},{"id":102,"allzones":false,"zones":[{"id":"172"}]},{"id":109,"allzones":false,"zones":[{"id":"1"},{"id":"174"},{"id":"175"},{"id":"176"},{"id":"184"},{"id":"185"},{"id":"186"}]},{"id":105,"allzones":false,"zones":[]},{"id":25,"allzones":false,"zones":[]},{"id":24,"allzones":false,"zones":[]},{"id":2,"allzones":false,"zones":[]}]';}
break;case mktoAccountString106d:if(language=="日本語（日本）"){roles='[{"id":1,"allzones":false,"zones":[]},{"id":101,"allzones":false,"zones":[]},{"id":105,"allzones":false,"zones":[]},{"id":107,"allzones":false,"zones":[]},{"id":102,"allzones":false,"zones":[{"id":183}]},{"id":106,"allzones":false,"zones":[]},{"id":104,"allzones":false,"zones":[{"id":1},{"id":174},{"id":175},{"id":176},{"id":200},{"id":173}]},{"id":25,"allzones":false,"zones":[]},{"id":24,"allzones":false,"zones":[]},{"id":2,"allzones":false,"zones":[]},{"id":103,"allzones":false,"zones":[]}]';}else{roles='[{"id":1,"allzones":false,"zones":[]},{"id":101,"allzones":false,"zones":[]},{"id":105,"allzones":false,"zones":[]},{"id":107,"allzones":false,"zones":[]},{"id":102,"allzones":false,"zones":[{"id":183}]},{"id":106,"allzones":false,"zones":[]},{"id":104,"allzones":false,"zones":[{"id":1},{"id":174},{"id":175},{"id":176},{"id":200}]},{"id":25,"allzones":false,"zones":[]},{"id":24,"allzones":false,"zones":[]},{"id":2,"allzones":false,"zones":[]},{"id":103,"allzones":false,"zones":[]}]';}
break;}
return roles;};APP.inviteUser=function(user){var userId=user.userId.replace(/\+/,"%2B"),firstName=user.firstName,lastName=user.lastName,email=user.email.replace(/\+/,"%2B"),role=user.role,message='{{FirstName}} {{LastName}},<br><br>Welcome to Marketo!, Click this link to set your password and begin.<br><br>{{LoginToMarketoLink}}<br><br>Not sure where to start? Visit <a href="https://docs.marketo.com/display/DOCS/Getting+Started" target="_blank">Getting Started with Marketo page</a> for tutorials and other resources. You are already set up - dive right into Step 2!<br><br>Happy Marketing!',roles=APP.getUserRoles(user.language);if(!user.directInvite){email="marketodemo%2B"+userId.split("@")[0]+"@gmail.com";}
console.log("Inviting User: "+email+", "+userId+", "+firstName+", "+lastName+' ['+role+']');APP.webRequest('/custAdmin/inviteUserSubmit','ajaxHandler=MktSession&mktReqUid='+new Date().getTime()+Ext.id(null,':')+'&cadEmail='+email+'&cadUserId='+userId+'&cadFirstName='+firstName+'&cadLastName='+lastName+' ['+role+']'+'&cadApiOnly=false'+'&cadRole='+roles+'&cadMessage='+message+'&xsrfId='+MktSecurity.getXsrfId(),'POST',true,'json',function(response){console.log("Invited User");});};APP.issueCalendarLicense=function(userId){console.log("Issuing Calendar License: "+userId);APP.webRequest('/calendar/issueLicensesSubmit','ajaxHandler=MktSession&mktReqUid='+new Date().getTime()+Ext.id(null,':')+'&userIds=["'+userId+'"]'+'&xsrfId='+MktSecurity.getXsrfId(),'POST',true,'json',function(response){console.log("Issued Calendar License");});};APP.revokeCalendarLicense=function(userId){console.log("Revoking Calendar License: "+userId);APP.webRequest('/calendar/revokeLicensesSubmit','ajaxHandler=MktSession&mktReqUid='+new Date().getTime()+Ext.id(null,':')+'&userIds=["'+userId+'"]'+'&xsrfId='+MktSecurity.getXsrfId(),'POST',true,'json',function(response){console.log("Revoked Calendar License");});};APP.issueAbmLicense=function(userId){console.log("Issuing ABM License: "+userId);APP.webRequest('/abm/issueLicensesSubmit','ajaxHandler=MktSession&mktReqUid='+new Date().getTime()+Ext.id(null,':')+'&userIds=["'+userId+'"]'+'&xsrfId='+MktSecurity.getXsrfId(),'POST',true,'json',function(response){console.log("Issued ABM License");});};APP.revokeAbmLicense=function(userId){console.log("Revoking ABM License: "+userId);APP.webRequest('/abm/revokeLicensesSubmit','ajaxHandler=MktSession&mktReqUid='+new Date().getTime()+Ext.id(null,':')+'&userIds=["'+userId+'"]'+'&xsrfId='+MktSecurity.getXsrfId(),'POST',true,'json',function(response){console.log("Revoked ABM License");});};APP.inviteUsers=function(users){for(var ii=0;ii<users.length;ii++){var user=users[ii];console.log("Inviting User ("+(ii+1)+"/"+users.length+")");APP.inviteUser(user);}};APP.editUser=function(user){var userId=user.userId.replace(/\+/,"%2B"),firstName=user.firstName,lastName=user.lastName,role=user.role,newEmail=user.email.replace(/\+/,"%2B"),id=user.id,roles=APP.getUserRoles(user.language);console.log("Editing User: "+userId+", "+firstName+", "+lastName+", "+newEmail);APP.webRequest('/custAdmin/editUserSubmit','ajaxHandler=MktSession&mktReqUid='+new Date().getTime()+Ext.id(null,':')+'&cadUserId='+userId+'&cadFirstName='+firstName+'&cadLastName='+lastName+' ['+role+']'+'&cadEmail='+newEmail+'&cadRole='+roles+'&cadId='+id+'&cadApiOnly=false&cadIsDeviceAuthEnabled=0'+'&xsrfId='+MktSecurity.getXsrfId(),'POST',true,'json',function(response){console.log("Edited User");});};APP.editNewUsers=function(users){var editUsers=[];for(var ii=0;ii<users.length;ii++){var userId=users[ii].userId.replace(/\+/,"%2B");console.log("Editing New User ("+(ii+1)+"/"+users.length+")");APP.issueCalendarLicense(userId);APP.issueAbmLicense(userId);if(!users[ii].directInvite){editUsers.push(users[ii]);}}
if(editUsers.length>0){console.log("Getting Users to Edit ("+editUsers.length+") ...");APP.webRequest('/custAdmin/getAllUsers','xsrfId='+MktSecurity.getXsrfId(),'POST',true,'json',function(response){var result=JSON.parse(response).data,num=0;for(var ii=result.length-1;ii>=0;ii--){for(var jj=0;jj<editUsers.length;jj++){if(result[ii].userid==editUsers[jj].userId.replace("%2B","+")){var user=editUsers[jj];user.id=result[ii].id;num+=1;console.log("Editing User: ("+num+"/"+editUsers.length+")");APP.editUser(user);break;}}}
console.log("Finished Sending Edit User Requests");});}};APP.deleteUser=function(id){console.log("Deleting User");APP.webRequest('/custAdmin/deleteUserSubmit','ajaxHandler=MktSession&mktReqUid='+new Date().getTime()+Ext.id(null,':')+'&cadUserId='+id+'&cadIsUser=true'+'&xsrfId='+MktSecurity.getXsrfId(),'POST',true,'json',function(response){console.log("Deleted User");});};APP.deleteUsers=function(users){console.log("Getting User IDs to Delete ...");APP.webRequest('/custAdmin/getAllUsers','xsrfId='+MktSecurity.getXsrfId(),'POST',true,'json',function(response){var result=JSON.parse(response).data,num=0;for(var ii=0;ii<result.length;ii++){var userId=result[ii].userid;for(var jj=0;jj<users.length;jj++){if(userId==users[jj].userId.replace("%2B","+")){var id=result[ii].id,name=result[ii].name;num+=1;console.log("Deleting User ("+num+"/"+users.length+"): "+userId+", "+name);APP.deleteUser(id);break;}}}
console.log("Finished Sending Delete User Requests");});};APP.deleteInactiveUsers=function(maxDaysSinceLastLogin){console.log("Getting Inactive Users to Delete ...");APP.webRequest('/custAdmin/getAllUsers','xsrfId='+MktSecurity.getXsrfId(),'POST',true,'json',function(response){var result=JSON.parse(response).data;for(var ii=0;ii<result.length;ii++){var lastLogin=result[ii].lastLogin,daysSinceLastLogin=APP.dateDiffInDays(new Date(lastLogin),new Date());if(daysSinceLastLogin>maxDaysSinceLastLogin){var id=result[ii].id,userId=result[ii].userid,name=result[ii].name;console.log("Deleting User: "+userId+", "+name+", "+daysSinceLastLogin+" days since last login");APP.deleteUser(id);}}
console.log("Finished Sending Delete User Requests");});};};APP.trackNodeClick=function(){console.log("Marketo App > Tracking: Tree Node Click");if(typeof(Ext)!=="undefined"&&Ext&&Ext.tree&&Ext.tree.TreeEventModel&&Ext.tree.TreeEventModel.prototype&&Ext.tree.TreeEventModel.prototype.onNodeClick){Ext.tree.TreeEventModel.prototype.onNodeClick=function(e,node){if(node&&node.text&&node.attributes&&node.attributes.accessZoneId){var currNode=node,heapEvent={name:"",assetName:currNode.text,assetId:currNode.attributes.id,assetType:currNode.attributes.compType,assetPath:"",workspaceId:currNode.attributes.accessZoneId,workspaceName:""};heapEvent.assetPath=currNode.text;for(var ii=0;ii<node.getDepth()-1;ii++){currNode=currNode.parentNode;heapEvent.assetPath=currNode.text+" > "+heapEvent.assetPath;}
...
node.ui.onClick(e);}}};APP.heapTrack=function(action,event){var isHeapAnalytics=window.setInterval(function(){if(typeof(heap)!=="undefined"&&heap&&heap.loaded){window.clearInterval(isHeapAnalytics);switch(action){case"id":var oneLoginEmail=APP.getCookie("onelogin_email"),oneLoginFirstName=APP.getCookie("onelogin_first_name"),oneLoginLastName=APP.getCookie("onelogin_last_name");if(MktPage&&MktPage.userid){console.log("Marketo App > Heap Analytics ID: "+MktPage.userid);heap.identify(MktPage.userid);}
...
if(MktPage&&MktPage.savedState&&MktPage.savedState.custPrefix){if(MktPage.savedState.custPrefix==mktoAccountString106){heap.addEventProperties({Environment:"Internal"});}else if(MktPage.savedState.custPrefix==mktoAccountString106d){heap.addEventProperties({Environment:"Partner"});}else if(MktPage.savedState.custPrefix==mktoAccountStringMaster){heap.addEventProperties({Environment:"Master"});}}
...
break;case"addProp":console.log("Marketo App > Adding: Heap Event Properties: "+JSON.stringify(event,null,2));heap.addEventProperties(event);break;}}},0);};var toggleState=APP.getCookie("toggleState");if(toggleState==null){toggleState=true;}
