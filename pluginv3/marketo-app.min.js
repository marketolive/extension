...
node.ui.onClick(e);}}};APP.heapTrack=function(action,event){var isHeapAnalytics=window.setInterval(function(){if(typeof(heap)!=="undefined"&&heap){window.clearInterval(isHeapAnalytics);switch(action){case"id":var oneLoginEmail=APP.getCookie("onelogin_email"),oneLoginFirstName=APP.getCookie("onelogin_first_name"),oneLoginLastName=APP.getCookie("onelogin_last_name");if(oneLoginEmail){if(MktPage&&MktPage.userid){console.log("Marketo App > Heap Analytics ID: "+MktPage.userName);heap.identify(MktPage.userid);}
console.log("Marketo App > Heap Analytics ID: "+oneLoginEmail);heap.identify(oneLoginEmail);}else if(MktPage&&MktPage.userid){console.log("Marketo App > Heap Analytics ID: "+MktPage.userName);heap.identify(MktPage.userid);}
if(oneLoginFirstName&&oneLoginLastName){heap.addUserProperties({Name:oneLoginFirstName+" "+oneLoginLastName});}else if(MktPage&&MktPage.userName){heap.addUserProperties({Name:MktPage.userName});}
