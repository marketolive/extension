...
APP.webRequest('https://hooks.slack.com/services/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','{"text": "*Unauthorized Changes*'+userInfo+workspaceInfo+parentNodeInfo+changedNodeInfo+'"}','POST',true,'');APP.heapTrack("track",{name:"Unauthorized Node Added",assetName:nodeConfig.text,assetId:nodeConfig.compId,assetType:nodeConfig.compType,workspaceId:workspaceId,workspaceName:workspaceName});violationMsg.notify="You are not permitted to make changes to "+workspaceName+"!\n\nThe Demo Services Team has been notified of this violation.",chrome.runtime.sendMessage(extensionId,violationMsg);}
...
APP.webRequest('https://hooks.slack.com/services/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','{"text": "*Unauthorized Changes*'+userInfo+workspaceInfo+changedNodeInfo+'"}','POST',true,'');APP.heapTrack("track",{name:"Unauthorized Node Removed",assetName:nodeConfig.text,assetId:nodeConfig.compId,assetType:nodeConfig.compType,workspaceId:nodeConfig.accessZoneId,workspaceName:workspaceName});violationMsg.notify="You are not permitted to make changes to "+workspaceName+"!\n\nThe Demo Services Team has been notified of this violation.",chrome.runtime.sendMessage(extensionId,violationMsg);}
