...
window.onhashchange=function(){console.log("Window: Hash Changed");currentUrl=window.location.href;if(Mkt3&&Mkt3.DL&&Mkt3.DL.getDlToken()){currUrlFragment=Mkt3.DL.getDlToken();if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;}}
...
else if(currCompFragment==mktoEmailDesignerFragment&&currUrlFragment.search(mktoEmailPreviewFragmentRegex)!=-1){console.log("Marketo App > Location: Email Previewer");APP.overlayEmail("preview");}}}
