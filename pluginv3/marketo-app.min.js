...
else if(action=="preview"){console.log("Marketo App > Overlaying: Email Previewer");if(document.getElementsByTagName("iframe")[2].contentWindow.document){if(count>5000||overlay(document.getElementsByTagName("iframe")[2].contentWindow.document)){window.clearInterval(isEmailEditor2);}}}},0);}
