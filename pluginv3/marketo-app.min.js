...
APP.disableFormSaveButtons=function(){console.log("Marketo App > Disabling: Form Window Save Buttons");if(Ext4&&Ext4.Component&&Ext4.Component.prototype&&Ext4.Component.prototype.show){Ext4.Component.prototype.show=function(animateTarget,cb,scope){console.log("Marketo App > Executing: Disable Form Window Save Buttons");if(this.getXType()=="createNamedAccountForm"||this.getXType()=="addToAccountListForm"||this.getXType()=="adminUserInviteWizard"||this.getXType()=="adminSubscriptionInformationForm"||this.getXType()=="adminAccountSettingsForm"||this.getXType()=="localePicker"||this.getXType()=="adminTinyMceSettingForm"||this.getXType()=="emailEditorSettingsForm"||this.getXType()=="emailAddMultipleDomainForm"||this.getXType()=="adminScoreSettingsForm"||this.getXType()=="adminCrmFieldSettingsForm"||this.getXType()=="adminFieldHtmlEncodeForm"||this.getXType()=="mktocustomactivityActivityTypeForm"||this.getXType()=="adminViewEnterpriseKeyForm"||this.getXType()=="adminSpecifyPluginContactForm"||this.getXType()=="mktowsEditIpRestrictionForm"||this.getXType()=="launchpointServiceIntegrationSettingsForm"){var mItems=this.query("[action=submit],");if(mItems){mItems.forEach(function(item){if(item){item.setDisabled(true);}});}}
