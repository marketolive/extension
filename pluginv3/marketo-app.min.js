...
window.onhashchange=function(){console.log("Marketo App > Window: Hash Changed");currentUrl=window.location.href;if(Mkt3&&Mkt3.DL&&Mkt3.DL.getDlToken()){currUrlFragment=Mkt3.DL.getDlToken();console.log("Marketo App > Window: URL Fragment = "+currUrlFragment);if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;}}
