...
return false;}
isEmailEditor2=window.setInterval(function(){if(action=="edit"){console.log("Marketo App > Overlaying: Email Editor");if(overlay(document.getElementsByTagName("iframe")[0].contentWindow.document)||loopCount>6000){console.log("Marketo App > Overlaying: Email Interval is Cleared");window.clearInterval(isEmailEditor2);clearOverlayVars();}}
else if(action=="preview"){console.log("Marketo App > Overlaying: Email Previewer");if(!isDesktopPreviewReplaced&&document.getElementsByTagName("iframe")[2].contentWindow.document&&overlay(document.getElementsByTagName("iframe")[2].contentWindow.document)){isDesktopPreviewReplaced=true;}
if(!isPhonePreviewReplaced&&document.getElementsByTagName("iframe")[3].contentWindow.document&&overlay(document.getElementsByTagName("iframe")[3].contentWindow.document)){console.log("Marketo App > Overlayed: Email Phone Preview");isPhonePreviewReplaced=true;}
