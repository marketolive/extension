...
window.onhashchange=function(){console.log("Marketo App > Window: Hash Changed");currentUrl=window.location.href;var isNewUrlFragment=window.setInterval(function(){if(Mkt3&&Mkt3.DL&&Mkt3.DL.getDlToken()){if(currUrlFragment!=Mkt3.DL.getDlToken()){window.clearInterval(isNewUrlFragment);currUrlFragment=Mkt3.DL.getDlToken();console.log("Marketo App > Loaded: New URL Fragment = "+currUrlFragment);currTitle=document.title.replace(" - "+document.location.protocol+"//"+document.location.host+"/","");if(MktPage&&MktPage.friendlyName){currTitle=currTitle.replace("Marketo",MktPage.friendlyName);}
var heapApp=currTitle.split("|")[0].trimRight(),heapAsset,heapArea;if(currTitle.search("•")!=-1){heapAsset=currTitle.split("|")[1].trimLeft().split("•")[0].trimRight();heapArea=currTitle.split("|")[1].trimLeft().split("•")[1].trimLeft();}
else{heapAsset="Home";heapArea=currTitle.split("|")[1].trimLeft();}
heap.track(currTitle,{app:heapApp,asset:heapAsset,area:heapArea,url:currentUrl});if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;}
...
if(heapEventName){heapEventProps={app:heapApp,asset:heapAssetName,area:heapArea,url:currentUrl};console.log("Marketo App > Tracking: Heap Event "+heapEventName+":\n"+JSON.stringify(heapEventProps,null,2));heap.track(heapEventName,heapEventProps);}
else{currTitle=document.title.replace(" - "+document.location.protocol+"//"+document.location.host+"/","").replace("Marketo | ","");var heapAsset,heapArea;if(currTitle.search("•")!=-1){heapAsset=currTitle.split("|")[1].trimLeft().split("•")[0].trimRight();heapArea=currTitle.split("|")[1].trimLeft().split("•")[1].trimLeft();}
