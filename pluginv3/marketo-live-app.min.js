...
currTitle=currTitle.replace("Marketo | ","");heapEventProps={app:heapApp,asset:heapAsset,area:heapArea,url:currentUrl};console.log("Marketo App > Tracking: Heap Event: "+currTitle+"\n"+JSON.stringify(heapEventProps,null,2));heap.track(currTitle,heapEventProps);}
