...
APP.disableDemoPluginCheck();var heapApp=currTitle.split("|")[0].trimRight(),heapAsset,heapArea;if(currTitle.search("•")!=-1){heapAsset=currTitle.split("|")[1].trimLeft().split("•")[0].trimRight();heapArea=currTitle.split("|")[1].trimLeft().split("•")[1].trimLeft();}
else{heapAsset="Home";heapArea=currTitle.split("|")[1].trimLeft();}
heap.track(currTitle,{app:heapApp,asset:heapAsset,area:heapArea});if(currUrlFragment==mktoMyMarketoFragment){APP.overrideHomeTiles();}
...
heap.track(currTitle,{app:heapApp,asset:heapAsset,area:heapArea});if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;}
