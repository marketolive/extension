...
APP.disableDemoPluginCheck();heap.track(currTitle,{app:currTitle.split("|")[0].trimRight(),asset:currTitle.split("|")[1].trimLeft().split("•")[0].trimRight(),area:currTitle.split("|")[1].trimLeft().split("•")[1].trimLeft()});if(currUrlFragment==mktoMyMarketoFragment){APP.overrideHomeTiles();}
...
window.onhashchange=function(){console.log("Marketo App > Window: Hash Changed");currentUrl=window.location.href;var isNewUrlFragment=window.setInterval(function(){if(Mkt3&&Mkt3.DL&&Mkt3.DL.getDlToken()){if(currUrlFragment!=Mkt3.DL.getDlToken()){window.clearInterval(isNewUrlFragment);currUrlFragment=Mkt3.DL.getDlToken();currTitle=document.title.replace(" - "+document.location.protocol+"//"+document.location.host+"/","");console.log("Marketo App > Loaded: New URL Fragment = "+currUrlFragment);heap.track(currTitle,{app:currTitle.split("|")[0].trimRight(),asset:currTitle.split("|")[1].trimLeft().split("•")[0].trimRight(),area:currTitle.split("|")[1].trimLeft().split("•")[1].trimLeft()});if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;}
