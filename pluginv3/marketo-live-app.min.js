...
assetStore.load({filters:[{property:'id',value:assetIds}],callback:function(assets){for(var i=0;i<assets.length;i++){var asset=assets[i];asset.discard(function(success){if(success){asset.updateNode();}},this);}}});}}};APP.overrideTreeNodeExpand=function(){console.log("Marketo App > Overriding: Tree Node Expand");if(MktAsyncTreeNode&&MktAsyncTreeNode.prototype&&MktAsyncTreeNode.prototype.expand&&userName){MktAsyncTreeNode.prototype.expand=function(){console.log("Marketo App > Executing: Tree Node Expand");var attr=this.attributes,ii;if(this.text==userWorkspaceName||(this.parentNode.text==userWorkspaceName&&this.attributes.system==true)||(this.parentNode.parentNode!=null&&this.parentNode.parentNode.text==userWorkspaceName&&this.attributes.system==true)){for(ii=0;ii<this.childNodes.length;ii++){if(this.childNodes[ii].attributes.system==false){if(this.childNodes[ii].text.toLowerCase()!==userName){this.childNodes[ii].hidden=true;}
else{}}}}
...
MktAsyncTreeNode.superclass.expand.apply(this,arguments);attr.mktExpanded=true;};}};APP.overrideTreeNodeCollapse=function(){console.log("Marketo App > Overriding: Tree Node Collapse");if(MktAsyncTreeNode&&MktAsyncTreeNode.prototype&&MktAsyncTreeNode.prototype.collapse&&userName){MktAsyncTreeNode.prototype.collapse=function(){console.log("Marketo App > Executing: Tree Node Collapse");var attr=this.attributes,ii;if(this.text==userWorkspaceName||(this.parentNode.text==userWorkspaceName&&this.attributes.system==true)||(this.parentNode.parentNode!=null&&this.parentNode.parentNode.text==userWorkspaceName&&this.attributes.system==true)){for(ii=0;ii<this.childNodes.length;ii++){if(this.childNodes[ii].attributes.system==false){if(this.childNodes[ii].text.toLowerCase()!==userName){this.childNodes[ii].ui.elNode.hidden=true;}
else{}}}}
...
var parms=Ext.apply({},this.serializeParms,this.baseParams);MktSession.ajaxRequest(this.submitUrl,{serializeParms:parms,onMySuccess:this.submitSuccessHandler.createDelegate(this),onMyFailure:this.submitFailedHandler.createDelegate(this)});};}};APP.overrideAssetSaveEdit=function(){console.log("Marketo App > Overriding: Asset Save Edit");if(Mkt&&Mkt.widgets&&Mkt.widgets.CanvasHeader&&Mkt.widgets.CanvasHeader.prototype&&Mkt.widgets.CanvasHeader.prototype.saveEdit){Mkt.widgets.CanvasHeader.prototype.saveEdit=function(){if(MktCanvas&&MktCanvas.getActiveTab()&&MktCanvas.getActiveTab().config&&MktCanvas.getActiveTab().config.accessZoneId&&userName){console.log("Marketo App > Executing: Asset Save Edit");var currWorkspaceId=MktCanvas.getActiveTab().config.accessZoneId;if(currWorkspaceId.toString().search(mktoGoldenWorkspacesMatch)==-1){var isFolderEdit=false;if((MktExplorer.getEl().dom.ownerDocument.title.search("Marketing Activities")!=-1&&(this.titleId=="mpTEName"||this.titleId=="cdhTEName"||this.titleId=="pname"))||MktExplorer.getEl().dom.ownerDocument.title.search("Marketing Activities")==-1){if(MktCanvas.getActiveTab().config.accessZoneId==mktoUserWorkspaceId&&this.titleId=="pname"){if(this.titleValue==userName){isFolderEdit=true;}}
...
else{this.onFocus({});if(this.triggerAction=='all'){this.doQuery(this.allQuery,true);if(this&&this.label&&this.label.dom&&this.label.dom.textContent=="Campaign Folder:"&&MktCanvas&&MktCanvas.getActiveTab()&&MktCanvas.getActiveTab().config&&MktCanvas.getActiveTab().config.accessZoneId==mktoUserWorkspaceId){console.log("Marketo App > Executing: Hide Campaign Folders On Program Import via Override");var ii;for(ii=0;ii<this.view.all.elements.length;ii++){if(this.view.all.elements[ii].textContent.toLowerCase()!=userName){this.view.all.elements[ii].hidden=true;}}}}
else{this.doQuery(this.getRawValue());}
this.el.focus();}};}};APP.hidePageGrid=function(){console.log("Marketo App > Hiding: Page Grid via Override");if(MktGrids&&MktGrids.CanvasGridPanel&&MktGrids.CanvasGridPanel.prototype&&MktGrids.CanvasGridPanel.prototype.loadPagedGrid){MktGrids.CanvasGridPanel.prototype.loadPagedGrid=function(){if(MktCanvas&&MktCanvas.getActiveTab()&&MktCanvas.getActiveTab().config&&MktCanvas.getActiveTab().config.accessZoneId==mktoUserWorkspaceId){switch(this.canvas){case"landingCanvasLP":this.hide();break;case"landingCanvasFO":this.hide();break;case"landingCanvasEM":this.hide();break;case"landingCanvasSnippet":this.hide();break;case"landingCanvasIM":this.hide();break;case"ldbCanvasLeadList":this.hide();break;case"campaignCanvasDetailActivityLog":this.hide();break;case"atxCanvasDetailView":break;default:break;}}
...
else{console.log("Marketo App > Skipped: Disable Content & Actions Menus for Marketing Activities > Nurture Program Stream");}};APP.hideToolbarItems=function(){console.log("Marketo App > Hiding: Toolbar Items");if(Ext&&Ext.layout&&Ext.layout.ContainerLayout&&Ext.layout.ContainerLayout.prototype&&Ext.layout.ContainerLayout.prototype.renderItem){Ext.layout.ContainerLayout.prototype.renderItem=function(c,position,target){if(c){if(!c.rendered){c.render(target,position);this.configureItem(c,position);}
...
currPosition=x;}
window.location=pod.valueSet[currPosition].url;});}}}},0);};APP.overrideSaving=function(){console.log("Marketo App > Overriding: Saving for Nurture Streams");if(Mkt3&&Mkt3.data&&Mkt3.data.Store&&Mkt3.data.Store.prototype&&Mkt3.data.Store.prototype.sync){var prevDataStoreSync=Mkt3.data.Store.prototype.sync;Mkt3.data.Store.prototype.sync=function(){console.log("Marketo App > Executing: Override Saving for Nurture Streams (sync)");if(window.location.href.search("\/#"+mktoCalendarFragment)!=-1){Mkt3.data.Store.prototype.sync=prevDataStoreSync;}
...
return me;}
else{console.log("Marketo App > Disabling: Saving for Nurture Streams (destroy)");}};}};APP.enableSaving=function(){console.log("Marketo App > Enabling: Saving for Editors");if(Mkt3&&Mkt3.data&&Mkt3.data.Store&&Mkt3.data.Store.prototype&&Mkt3.data.Store.prototype.sync){Mkt3.data.Store.prototype.sync=function(){console.log("Marketo App > Executing: Enable Saving for Editors (sync)");if(this.autoSyncSuspended){this.autoSync=true;this.autoSyncSuspended=false;}
...
return me;};}};APP.disableSaving=function(){console.log("Marketo App > Disabling: Saving for Editors");if(Mkt3&&Mkt3.data&&Mkt3.data.Store&&Mkt3.data.Store.prototype&&Mkt3.data.Store.prototype.sync){Mkt3.data.Store.prototype.sync=function(){console.log("Marketo App > Executing: Disable Saving for Editors (sync)");};}
...
APP.trackTreeNodeSelection=function(){console.log("Marketo App > Tracking: Tree Node Selection");if(MktExplorer&&MktExplorer.selectTreeNode){MktExplorer.selectTreeNode=function(node){console.log("Marketo App > Executing: Tracking Tree Node Selection")
...
else if(currCompFragment==mktoLandingPageDesignerFragment){console.log("Marketo App > Location: Landing Page Designer");var isLandingPageDesigner=window.setInterval(function(){if(Mkt3&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage")&&Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage").getLandingPage()&&(Mkt3.app.controllers.get("Mkt3.controller.editor.LandingPage").getLandingPage().get("zoneId").toString().search(mktoGoldenWorkspacesMatch)!=-1)){console.log("Marketo App > Loaded: Landing Page Editor");window.clearInterval(isLandingPageDesigner);APP.disablePropertyPanelSaving();if(Ext4&&Ext4.ComponentQuery&&Ext4.ComponentQuery.query){var mItems=Ext4.ComponentQuery.query("lpEditor menu [action=approveAndClose],"+"lpEditor menu [action=disableMobileVersion],"+"lpEditor menu [action=uploadImage],"+"lpEditor menu [action=grabImages],");if(mItems){console.log("Marketo App > Disabling Landing Page Editor Toolbar Actions menus");mItems.forEach(function(item){if(item){item.setDisabled(true);}});}}}},0);return;}
else{console.log("Marketo App > Location: Designers/Wizards");var loadParameters={filters:[{property:'id',value:Mkt3.DL.dl.compId}],callback:function(records){records.forEach(function(record){if(record.get('zoneId')){var currAssetWorkspaceId=record.get('zoneId');console.log("Marketo App > currAssetWorkspaceId = "+currAssetWorkspaceId);if(currAssetWorkspaceId.toString().search(mktoGoldenWorkspacesMatch)!=-1||APP.getCookie("toggleState")=="false"){APP.disableSaving();if(Ext4&&Ext4.ComponentQuery&&Ext4.ComponentQuery.query){var mItems=Ext4.ComponentQuery.query("emailEditor2 menu [action=approveEmail],"+"emailEditor2 menu [action=sendTestEmail],"+"emailEditor2 menu [action=uploadImage],"+"emailEditor2 menu [action=grabImages],"+"emailEditor2 menu [action=saveAsTemplate],"+"inAppMessageEditor menu [action=approveAndClose],");if(mItems){console.log("Marketo App > Disabling Editor Toolbar Actions menus");mItems.forEach(function(item){if(item){item.setDisabled(true);}});}}}}});}};switch(currCompFragment){case mktoEmailDesignerFragment:if(currUrlFragment.search(mktoEmailPreviewFragmentRegex)==-1){console.log("Marketo App > Location: Email Designer");if(Ext4&&Ext4.getStore('Email')&&Ext4.getStore('Email').load){console.log("Marketo App > Callback: Email Editor");Ext4.getStore('Email').load(loadParameters);}}
else{console.log("Marketo App > Location: Email Previewer");}
break;case mktoFormWizardFragment:console.log("Marketo App > Location: Form Wizard");if(Ext4&&Ext4.getStore('Form')&&Ext4.getStore('Form').load){console.log("Marketo App > Callback: Form Editor");Ext4.getStore('Form').load(loadParameters);}
break;case mktoMobilePushNotificationWizardFragment:console.log("Marketo App > Location: Push Notification Wizard");if(Ext4&&Ext4.getStore('MobilePushNotification')&&Ext4.getStore('MobilePushNotification').load){console.log("Marketo App > Callback: Push Notification Editor");Ext4.getStore('MobilePushNotification').load(loadParameters);}
break;case mktoInAppMessageWizardFragment:console.log("Marketo App > Location: In App Message Wizard");if(Ext4&&Ext4.getStore('InAppMessage')&&Ext4.getStore('InAppMessage').load){console.log("Marketo App > Callback: In App Message Editor");Ext4.getStore('InAppMessage').load(loadParameters);}
break;case mktoSocialAppWizardFragment:console.log("Marketo App > Location: Social App Wizard");if(Ext4&&Ext4.getStore('SocialApp')&&Ext4.getStore('SocialApp').load){console.log("Marketo App > Callback: Social App Editor");Ext4.getStore('SocialApp').load(loadParameters);}
break;case mktoABtestWizardFragment:console.log("Marketo App > Location: A/B Test Wizard");var isABtestWizard=window.setInterval(function(){if(Mkt3&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor")&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor()&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record&&(Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record.get("zoneId").toString().search(mktoGoldenWorkspacesMatch)!=-1)){console.log("Marketo App > Loaded: A/B Test Wizard");window.clearInterval(isABtestWizard);APP.disableSaving();}},0);break;case mktoEmailTestWizardFragment:console.log("Marketo App > Location: Email Test Group Wizard");var isEmailTestWizard=window.setInterval(function(){if(Mkt3&&Mkt3.app&&Mkt3.app.controllers&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor")&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor()&&Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record&&(Mkt3.app.controllers.get("Mkt3.controller.editor.wizard.Editor").getEditor().record.get("zoneId").toString().search(mktoGoldenWorkspacesMatch)!=-1)){console.log("Marketo App > Loaded: Email Test Group Wizard");window.clearInterval(isEmailTestWizard);APP.disableSaving();}},0);break;default:break;}}
window.onhashchange=function(){console.log("Marketo App > Window: Hash Changed");currentUrl=window.location.href;var isNewUrlFragment=window.setInterval(function(){if(Mkt3&&Mkt3.DL&&Mkt3.DL.getDlToken()){if(currUrlFragment!=Mkt3.DL.getDlToken()){window.clearInterval(isNewUrlFragment);currUrlFragment=Mkt3.DL.getDlToken();console.log("Marketo App > Loaded: New URL Fragment = "+currUrlFragment);heapTrack("track");if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;}
