...
return emIds;}
var isMktPageApp=window.setInterval(function(){if(typeof(MktPage)!=="undefined"){console.log("Marketo App > Location: Marketo Page");var accountString,userId,currTitle=document.title.replace(" - "+document.location.protocol+"//"+document.location.host+"/","");if(MktPage.savedState&&MktPage.savedState.custPrefix&&MktPage.userid&&Mkt3&&Mkt3.DL&&Mkt3.DL.getDlToken()){window.clearInterval(isMktPageApp);accountString=MktPage.savedState.custPrefix;userId=MktPage.userid.toLowerCase();currUrlFragment=Mkt3.DL.getDlToken();if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;}
if(MktPage.friendlyName){currTitle.replace("Marketo",MktPage.friendlyName);}
...
window.onhashchange=function(){console.log("Marketo App > Window: Hash Changed");currentUrl=window.location.href;var isNewUrlFragment=window.setInterval(function(){if(Mkt3&&Mkt3.DL&&Mkt3.DL.getDlToken()){if(currUrlFragment!=Mkt3.DL.getDlToken()){window.clearInterval(isNewUrlFragment);currUrlFragment=Mkt3.DL.getDlToken();currTitle=document.title.replace(" - "+document.location.protocol+"//"+document.location.host+"/","");console.log("Marketo App > Loaded: New URL Fragment = "+currUrlFragment);var heapApp=currTitle.split("|")[0].trimRight(),heapAsset,heapArea;if(currTitle.search("•")!=-1){heapAsset=currTitle.split("|")[1].trimLeft().split("•")[0].trimRight();heapArea=currTitle.split("|")[1].trimLeft().split("•")[1].trimLeft();}
...
APP.overrideSuperballMenuItems();var isHeapAnalytics=window.setInterval(function(){if(typeof(heap)!=="undefined"){console.log("Marketo App > Loaded: Heap Analytics");window.clearInterval(isHeapAnalytics);if(MktPage&&MktPage.userid&&MktPage.userName){heap.identify(MktPage.userid);heap.addUserProperties({Name:MktPage.userName});}
