...
return emIds;};APP.trackTreeNodeSelection=function(){console.log("Marketo App > Tracking: Tree Node Selection");if(MktExplorer&&MktExplorer.selectTreeNode){MktExplorer.selectTreeNode=function(node){console.log("Marketo App > Executing: Tracking Tree Node Selection")
...
heapEventTitle=heapEventTitle.replace("Marketo | ","");if(currUrlFragment.search("^SOA")!=-1){heapAsset="Social App";heapEventTitle="ANY Social App";}
else if(currUrlFragment.search("^MPN")!=-1){heapAsset="Push Notification";heapEventTitle="ANY Push Notification";}
heapEventProps={app:heapApp,asset:heapAsset,area:heapArea,url:currentUrl};console.log("Marketo App > Tracking: Heap Event: "+heapEventTitle+"\n"+JSON.stringify(heapEventProps,null,2));heap.track(heapEventTitle,heapEventProps);}
...
if(accountString.search(mktoAccountStringsMatch)!=-1||accountString==mktoAccountStringQe||APP.getCookie("toggleState")=="false"){console.log("Marketo App > Location: MarketoLive Instance");if(userId.search("^admin\.?[a-z]{0,2}@mktodemoaccount")!=-1||userId.search("^mktodemoaccount[a-z0-9]*@marketo\.com")!=-1||userId.search("^marketodemo.*@gmail\.com$")!=-1){console.log("Marketo App > User: Admin");APP.disableDemoPluginCheck();if(APP.getCookie("toggleState")!="false"){return;}
