...
window.onhashchange=function(){console.log("Marketo App > Window: Hash Changed");currentUrl=window.location.href;var isNewUrlFragment=window.setInterval(function(){if(Mkt3&&Mkt3.DL&&Mkt3.DL.getDlToken()){if(currUrlFragment!=Mkt3.DL.getDlToken()){window.clearInterval(isNewUrlFragment);currUrlFragment=Mkt3.DL.getDlToken();console.log("Marketo App > Loaded: New URL Fragment = "+currUrlFragment);currTitle=document.title.replace(" - "+document.location.protocol+"//"+document.location.host+"/","");if(MktPage&&MktPage.friendlyName){currTitle.replace("Marketo",MktPage.friendlyName);}
...
currTitle=document.title.replace(" - "+document.location.protocol+"//"+document.location.host+"/","");if(MktPage&&MktPage.friendlyName){currTitle.replace("Marketo",MktPage.friendlyName);}
var heapApp=currTitle.split("|")[0].trimRight(),heapAsset,heapArea;if(currTitle.search("•")!=-1){heapAsset=currTitle.split("|")[1].trimLeft().split("•")[0].trimRight();heapArea=currTitle.split("|")[1].trimLeft().split("•")[1].trimLeft();}
else if(currTitle.search("|")!=-1){heapAsset="Home";heapArea=currTitle.split("|")[1].trimLeft();}
else{heapAsset="Home";heapArea=currTitle;}
heap.track(currTitle,{app:heapApp,asset:heapAsset,area:heapArea,url:currentUrl});}},0);}}},0);