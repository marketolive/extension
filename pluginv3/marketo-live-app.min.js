...
else{return false;}};}};var isMktPageApp=window.setInterval(function(){if(typeof(MktPage)!=="undefined"){console.log("Marketo App > Location: Marketo Page");var accountString,userId,currTitle;if(MktPage.savedState&&MktPage.savedState.custPrefix&&MktPage.userid&&Mkt3&&Mkt3.DL&&Mkt3.DL.getDlToken()){window.clearInterval(isMktPageApp);accountString=MktPage.savedState.custPrefix;userId=MktPage.userid.toLowerCase();currUrlFragment=Mkt3.DL.getDlToken();if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;}
...
if(currUrlFragment.search(mktoAnalyzersFragmentMatch)!=-1){console.log("Marketo App > Location: Analytics");APP.injectAnalyzerNavBar();}
...
else{currTitle=document.title.replace(" - "+document.location.protocol+"//"+document.location.host+"/","");var heapAsset,heapArea;if(currTitle.search("•")!=-1){heapAsset=currTitle.split("|")[1].trimLeft().split("•")[0].trimRight();heapArea=currTitle.split("|")[1].trimLeft().split("•")[1].trimLeft();}
else if(currTitle.search("|")!=-1){heapAsset="Home";heapArea=currTitle.split("|")[1].trimLeft();}
else{heapAsset="Home";heapArea=currTitle;}
if(currUrlFragment.search("^SOA")!=-1){heapAsset="Social App";}
else if(currUrlFragment.search("^MPN")!=-1){heapAsset="Push Notification";}
currTitle=currTitle.replace("Marketo | ","");if(currUrlFragment.search("^SOA")!=-1){heapAsset="Social App";currTitle="ANY Social App";}
else if(currUrlFragment.search("^MPN")!=-1){heapAsset="Push Notification";currTitle="ANY Push Notification";}
heapEventProps={app:heapApp,asset:heapAsset,area:heapArea,url:currentUrl};console.log("Marketo App > Tracking: Heap Event: "+currTitle+"\n"+JSON.stringify(heapEventProps,null,2));heap.track(currTitle,heapEventProps);}
if(Mkt3.DL.dl&&Mkt3.DL.dl.dlCompCode){currCompFragment=Mkt3.DL.dl.dlCompCode;}
if(currUrlFragment==mktoMyMarketoFragment){APP.overrideHomeTiles();}
else if(currUrlFragment.search(mktoDisableButtonsFragmentMatch)!=-1){APP.disableButtons();}
else if(currUrlFragment==mktoAnalyticsDefaultFragment){APP.overrideAnalyticsTiles();}
else if(currUrlFragment.search(mktoAnalyzersFragmentMatch)!=-1){console.log("Marketo App > Location: Analytics");APP.injectAnalyzerNavBar();}}}},0);};APP.overrideSuperballMenuItems();var isHeapAnalytics=window.setInterval(function(){if(typeof(heap)!=="undefined"){console.log("Marketo App > Loaded: Heap Analytics");window.clearInterval(isHeapAnalytics);var oneLoginEmail=APP.getCookie("onelogin_email"),oneLoginFirstName=APP.getCookie("onelogin_first_name"),oneLoginLastName=APP.getCookie("onelogin_last_name");if(oneLoginEmail){heap.identify(oneLoginEmail);}
...
var heapApp,heapArea,heapEventProps;if(MktPage&&MktPage.friendlyName){heapApp=MktPage.friendlyName;}
else{heapApp="Marketo";}
if(MktPage&&MktPage.baseTitle){heapArea=MktPage.baseTitle.split("•")[0].trimRight();}
else{heapArea="Unknown";}
if(heapEventName){heapEventProps={app:heapApp,asset:heapAssetName,area:heapArea,url:currentUrl};console.log("Marketo App > Tracking: Heap Event: "+heapEventName+"\n"+JSON.stringify(heapEventProps,null,2));heap.track(heapEventName,heapEventProps);heapEventName=heapAssetName="";}
...
heapEventProps={app:heapApp,asset:heapAsset,area:heapArea,url:currentUrl};console.log("Marketo App > Tracking: Heap Event: "+currTitle+"\n"+JSON.stringify(heapEventProps,null,2));heap.track(currTitle,heapEventProps);}}},0);}}},0);