...
var devExtensionId = 'dokkjhbgengdlccldgjnbilajdbjlnhm',
  ...
  mktoDesignerHost = 'na-sjqe.marketodesigner.com',
  ...
  demoModelerLink = 'https://engage-qe.marketo.com/?preview=true&approved=true/#RCM83A1',
  ...
  */
  ...
  mktoAccountStringMaster = 'srcempty_case1',
  ...
  mktoAccountStringsMatch =
    '^(' + mktoAccountStringMaster + '|' + mktoAccountString106 + '|' + mktoAccountString106d + '|' + mktoAccountStringDynamics + ')$',
...
APP.validateDemoExtensionCheck = function (isValidExtension) {
  ...
  } else if (MktPage && MktPage.validateDemoExtension) {
...
APP.overrideSuperballMenuItems = function (restoreEmailInsightsMenuItem) {
  ...
  if (typeof MktPage !== 'undefined' && MktPage && MktPage.showSuperMenu) {
...
APP.overrideCanvas = function () {
  ...
  if (
    typeof MktCanvasPanelManager !== 'undefined' &&
...
APP.overrideTreeNodeExpand = function () {
  ...
  if (
    typeof MktAsyncTreeNode !== 'undefined' &&
    MktAsyncTreeNode &&
    ...
    MktAsyncTreeNode.prototype.expand = function () {
      ...
      if (
        ...
        accountString == mktoAccountStringMaster &&
...
APP.overrideNewFolders = function () {
  ...
  if (typeof MktMa !== 'undefined' && MktMa && MktMa.newProgramFolderSubmit && userName) {
  ...
  if (typeof MktFolder !== 'undefined' && MktFolder && MktFolder.newFolderSubmit && userName) {
...
APP.overrideRenamingFolders = function () {
  ...
  if (typeof MktMa !== 'undefined' && MktMa && MktMa.renameProgramFolderSubmit && userName) {
  ...
  if (typeof MktFolder !== 'undefined' && MktFolder && MktFolder.renameFolderSubmit && userName) {
...
APP.disableCheckboxes = function () {
  ...
  $jQ = jQuery.noConflict()
  if ($jQ) $jQ('.x4-form-checkbox').attr('disabled', true)
}
/**************************************************************************************
 *
...
APP.disableMenus = function () {
  ...
  if (typeof Ext4 !== 'undefined' && Ext4 && Ext4.Component && Ext4.Component.prototype && Ext4.Component.prototype.showAt) {
...
APP.overrideDraftEdits = function () {
  ...
  if (typeof MktDsMenu !== 'undefined' && MktDsMenu) {
...
APP.hideOtherToolbarItems = function (itemsToHide) {
  var isTopToolbarActive = window.setInterval(function () {
    ...
    if (typeof MktCanvas !== 'undefined' && MktCanvas && MktCanvas.getActiveTab() && MktCanvas.getActiveTab().getTopToolbar()) {
...
APP.disableDesignerSaving = function (assetType, mode) {
  ...
  isAppController = window.setInterval(function () {
    if (typeof Mkt3 !== 'undefined' && Mkt3 && Mkt3.app && Mkt3.app.controllers && Mkt3.app.controllers.get) {
      window.clearInterval(isAppController)

      var disableDesignerAsset, assetNode, menuItems
      ...
      disableDesignerAsset = function (assetNode, menuItems, disableFunc) {
        ...
        if (assetNode.accessZoneId.toString().search(mktoGoldenWorkspacesMatch) != -1 || toggleState == 'false') {
          ...
          if (typeof Ext4 !== 'undefined' && Ext4 && Ext4.ComponentQuery && Ext4.ComponentQuery.query) {
            ...
            case 'edit':
              var isPushNotificationEditor = window.setInterval(function () {
                if (
                  ...
                  Mkt3.app.controllers
                    .get('Mkt3.controller.editor.mobilePushNotification.MobilePushNotification')
                    .getMobilePushNotification() &&
                  Mkt3.app.controllers
                    .get('Mkt3.controller.editor.mobilePushNotification.MobilePushNotification')
                    .getMobilePushNotification()
                    .getNodeJson()
                  ...
                  assetNode = Mkt3.app.controllers
                    .get('Mkt3.controller.editor.mobilePushNotification.MobilePushNotification')
                    .getMobilePushNotification()
                    .getNodeJson()
                  menuItems = [
            ...
            case 'preview':
              var isPushNotificationPreview = window.setInterval(function () {
                if (
                  ...
                  assetNode = Mkt3.app.controllers
                    .get('Mkt3.controller.previewer.MobilePushNotification')
                    .getMobilePushNotification()
                    .getNodeJson()
                  menuItems = [
                    // Toolbar Menu
...
APP.disableFormSaveButtons = function () {
  ...
  if (typeof Ext4 !== 'undefined' && Ext4 && Ext4.Component && Ext4.Component.prototype && Ext4.Component.prototype.show) {
...
APP.disableFormDeleteButtons = function () {
  ...
  if (
    ...
    Ext4.window.MessageBox.prototype.confirmDelete = function (cfg, msg, fn, scope) {
      var menuItems, mItems, toDisable
...
APP.disableHarmfulSaveButtons = function () {
  ...
  if (typeof Ext !== 'undefined' && Ext && Ext.Window && Ext.Window.prototype && Ext.Window.prototype.show) {
...
APP.overrideSaving = function () {
  ...
  if (typeof Mkt3 !== 'undefined' && Mkt3 && Mkt3.data && Mkt3.data.Store && Mkt3.data.Store.prototype && Mkt3.data.Store.prototype.sync) {
...
APP.disableSaving = function () {
  ...
  if (typeof Mkt3 !== 'undefined' && Mkt3 && Mkt3.controller && Mkt3.controller.editor) {
    if (
      Mkt3.controller.editor.email2 &&
...
APP.disableRequests = function () {
  ...
  if (typeof MktSession !== 'undefined' && MktSession && MktSession.ajaxRequest) {
...
APP.heapTrack = function (action, event) {
  var isHeapAnalytics = window.setInterval(function () {
    if (typeof heap !== 'undefined' && heap && heap.loaded) {
