...
getNewProgramAssetDetailsResponse=APP.cloneSmartCampaignState(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,scForceActivate);APP.setProgramReportFilter(getNewProgramAssetDetailsResponse);}}}}}
APP.reloadMarketingActivites();waitMsg.close();}},0);});massCloneForm.show();massCloneForm.setWidth(525);massCloneForm.setHeight(530);massCloneForm.items.last().setText("Programs that have a folder depth greater than 1 will not be cloned.<br><br><ins>This will execute the following cloning actions</ins><br>&nbsp;&nbsp; - Folders<br>&nbsp;&nbsp; - Programs<br>&nbsp;&nbsp; - A Program's first Period Cost amount for the next 24 months<br>&nbsp;&nbsp; - Stream Cadences<br>&nbsp;&nbsp; - Activation state of trigger Smart Campaigns<br>&nbsp;&nbsp; - Recurring schedule of batch Smart Campaigns<br>&nbsp;&nbsp; - Sets the asset filter for contained reports to the destination folder");massCloneForm.items.last().setVisible(true);periodCostMonthField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; Months:";periodCostMonthField.label.setVisible(false);periodCostOffsetField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; Cost Offset (+/-):";periodCostOffsetField.label.setVisible(false);tagValueField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; New Tag Value:";tagValueField.label.setVisible(false);}},0);});}
