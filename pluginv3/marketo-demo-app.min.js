...
if(MktPage&&MktPage.savedState&&MktPage.savedState.custPrefix){heap.addUserProperties({Environment:MktPage.savedState.custPrefix});}
...
if(event){heapEventProps={app:heapApp,assetName:event.assetName,assetId:event.assetId,assetType:event.assetType,assetPath:event.assetPath,workspaceId:event.workspaceId,workspaceName:event.workspaceName,userFolder:event.userFolder,area:"",environment:"",url:window.location.href};if(event.assetArea){heapEventProps.area=event.assetArea;}else{heapEventProps.area=heapArea;}
if(MktPage&&MktPage.savedState&&MktPage.savedState.custPrefix){heapEventProps.environment=MktPage.savedState.custPrefix;}
...
break;}}}}}},0);};APP.overrideSuperballMenuItems();APP.heapTrack("id");}},0);