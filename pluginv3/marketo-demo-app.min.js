...
getNewProgramAssetDetailsResponse=APP.cloneSmartCampaignState(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,scForceActivate);APP.setProgramReportFilter(getOrigProgramSettingsResponse,getNewProgramAssetDetailsResponse);}}}}}
APP.reloadMarketingActivites();waitMsg.close();}},0);});massCloneForm.show();massCloneForm.setWidth(525);massCloneForm.setHeight(530);massCloneForm.items.last().setText("Programs that have a folder depth greater than 1 will not be cloned.");massCloneForm.items.last().setVisible(true);periodCostMonthField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; Months:";periodCostMonthField.label.setVisible(false);periodCostOffsetField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; Cost Offset (+/-):";periodCostOffsetField.label.setVisible(false);tagValueField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; New Tag Value:";tagValueField.label.setVisible(false);}},0);});}
