...
return getNewProgramAssetDetailsResponse;};APP.setProgramReportFilter=function(getNewProgramAssetDetailsResponse,cloneToFolderId,newProgramCompId){var applyProgramReportFilter;applyProgramReportFilter=function(getNewProgramAssetDetailsResponse,cloneToFolderId){var currNewReport;for(var ii=0;ii<getNewProgramAssetDetailsResponse.assetList[0].tree.length;ii++){currNewReport=getNewProgramAssetDetailsResponse.assetList[0].tree[ii];if(currNewReport.compType=="Report"){var reportFilterType,selectedNodes;switch(currNewReport.text){case(/^Email/i).test(currNewReport.text):reportFilterType="maEmail";selectedNodes='["'+cloneToFolderId+'"]';break;case(/^(Engagement|Nurtur)/i).test(currNewReport.text):reportFilterType="nurtureprogram";selectedNodes='["'+cloneToFolderId+'"]';break;case(/^Landing/i).test(currNewReport.text):reportFilterType="maLanding";selectedNodes='["'+cloneToFolderId+'"]';break;case(/^Program/i).test(currNewReport.text):reportFilterType="program";selectedNodes='["'+cloneToFolderId+'"]';break;case"LeadPerformance":break;case"CompanyWebActivity":break;case"WebPageActivity":break;}
