...
massCloneForm.close();waitMsgShow=waitMsg.show();var isWaitMsgShow=window.setInterval(function(){if(waitMsgShow){window.clearInterval(isWaitMsgShow);var currTreeNode,cloneFolderResponse,cloneProgramResponse,getOrigProgramSettingsResponse,getNewProgramSettingsResponse,getNewProgramAssetDetailsResponse;if(_this.currNode.attributes.compType=="Marketing Folder"){for(var ii=0;_this.currNode.attributes.children&&ii<_this.currNode.attributes.children.length;ii++){currTreeNode=_this.currNode.attributes.children[ii];if(currTreeNode.compType=="Marketing Folder"){waitMsg.update('<b>Cloning Folder:</b>  <i>'+currTreeNode.text+waitMsgAffix);cloneFolderResponse=APP.cloneFolder(currTreeNode.text,cloneToAffix,cloneToFolderId);if(cloneFolderResponse){for(var jj=0;currTreeNode.children&&jj<currTreeNode.children.length;jj++){if(currTreeNode.children[jj].compType=="Marketing Folder"){var currFolderTreeNode=currTreeNode.children[jj];waitMsg.update('<b>Cloning Folder:</b>  <i>'+currFolderTreeNode.text+waitMsgAffix);cloneFolderResponse=APP.cloneFolder(currFolderTreeNode.text,cloneToAffix,currFolderTreeNode.id);if(cloneFolderResponse){var currOrigProgramTreeNode;for(var kk=0;currFolderTreeNode.children&&kk<currFolderTreeNode.children.length;kk++){currOrigProgramTreeNode=currFolderTreeNode.children[kk];waitMsg.update('<b>Cloning Program:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);cloneProgramResponse=APP.cloneProgram(cloneToAffix,cloneFolderResponse.JSONResults.actions[0].parameters[0][0].id,currOrigProgramTreeNode);if(cloneProgramResponse){getOrigProgramSettingsResponse=APP.getProgramSettings(currOrigProgramTreeNode);if(getOrigProgramSettingsResponse&&getOrigProgramSettingsResponse.data&&(inheritPeriodCost||numOfPeriodCostMonths>0)){waitMsg.update('<b>Cloning Program Period Costs:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.clonePeriodCost(getOrigProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,numOfPeriodCostMonths,parseInt(periodCostOffset),inheritPeriodCost);}
getNewProgramSettingsResponse=APP.getProgramSettings({"compId":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,"compType":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType});if(getNewProgramSettingsResponse&&getNewProgramSettingsResponse.data&&tagName&&tagValue){waitMsg.update('<b>Setting Program Tag:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.setProgramTag(getNewProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,tagName,tagValue);}
if(cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType=="Nurture Program"){waitMsg.update('<b>Cloning Nurture Cadences:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.cloneNurtureCadence(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId);}
waitMsg.update('<b>Cloning Smart Campaign States:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);getNewProgramAssetDetailsResponse=APP.cloneSmartCampaignState(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,scForceActivate);APP.setProgramReportFilter(getNewProgramAssetDetailsResponse,cloneToFolderId);}}}}else{currOrigProgramTreeNode=currTreeNode.children[jj];waitMsg.update('<b>Cloning Program:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);cloneProgramResponse=APP.cloneProgram(cloneToAffix,cloneFolderResponse.JSONResults.actions[0].parameters[0][0].id,currOrigProgramTreeNode);if(cloneProgramResponse){getOrigProgramSettingsResponse=APP.getProgramSettings(currOrigProgramTreeNode);if(getOrigProgramSettingsResponse&&getOrigProgramSettingsResponse.data&&(inheritPeriodCost||numOfPeriodCostMonths>0)){waitMsg.update('<b>Cloning Program Period Costs:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.clonePeriodCost(getOrigProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,numOfPeriodCostMonths,parseInt(periodCostOffset),inheritPeriodCost);}
getNewProgramSettingsResponse=APP.getProgramSettings({"compId":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,"compType":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType});if(getNewProgramSettingsResponse&&getNewProgramSettingsResponse.data&&tagName&&tagValue){waitMsg.update('<b>Setting Program Tag:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.setProgramTag(getNewProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,tagName,tagValue);}
if(cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType=="Nurture Program"){waitMsg.update('<b>Cloning Nurture Cadences:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.cloneNurtureCadence(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId);}
waitMsg.update('<b>Cloning Smart Campaign States:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);getNewProgramAssetDetailsResponse=APP.cloneSmartCampaignState(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,scForceActivate);APP.setProgramReportFilter(getNewProgramAssetDetailsResponse,cloneToFolderId);}}}}}else{var currOrigProgramTreeNode=currTreeNode;waitMsg.update('<b>Cloning Program:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);cloneProgramResponse=APP.cloneProgram(cloneToAffix,cloneToFolderId,currOrigProgramTreeNode);if(cloneProgramResponse){getOrigProgramSettingsResponse=APP.getProgramSettings(currOrigProgramTreeNode);if(getOrigProgramSettingsResponse&&getOrigProgramSettingsResponse.data&&(inheritPeriodCost||numOfPeriodCostMonths>0)){waitMsg.update('<b>Cloning Program Period Costs:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.clonePeriodCost(getOrigProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,numOfPeriodCostMonths,parseInt(periodCostOffset),inheritPeriodCost);}
getNewProgramSettingsResponse=APP.getProgramSettings({"compId":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,"compType":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType});if(getNewProgramSettingsResponse&&getNewProgramSettingsResponse.data&&tagName&&tagValue){waitMsg.update('<b>Setting Program Tag:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.setProgramTag(getNewProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,tagName,tagValue);}
if(cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType=="Nurture Program"){waitMsg.update('<b>Cloning Nurture Cadences:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.cloneNurtureCadence(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId);}
waitMsg.update('<b>Cloning Smart Campaign States:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);getNewProgramAssetDetailsResponse=APP.cloneSmartCampaignState(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,scForceActivate);APP.setProgramReportFilter(getNewProgramAssetDetailsResponse,cloneToFolderId);}}}}else{var currOrigProgramTreeNode=_this.currNode.attributes;waitMsg.update('<b>Cloning Program:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);cloneProgramResponse=APP.cloneProgram(cloneToAffix,cloneToFolderId,currOrigProgramTreeNode);if(cloneProgramResponse){getOrigProgramSettingsResponse=APP.getProgramSettings(currOrigProgramTreeNode);if(getOrigProgramSettingsResponse&&getOrigProgramSettingsResponse.data&&(inheritPeriodCost||numOfPeriodCostMonths>0)){waitMsg.update('<b>Cloning Program Period Costs:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.clonePeriodCost(getOrigProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,numOfPeriodCostMonths,parseInt(periodCostOffset),inheritPeriodCost);}
getNewProgramSettingsResponse=APP.getProgramSettings({"compId":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,"compType":cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType});if(getNewProgramSettingsResponse&&getNewProgramSettingsResponse.data&&tagName&&tagValue){waitMsg.update('<b>Setting Program Tag:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.setProgramTag(getNewProgramSettingsResponse.data,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,tagName,tagValue);}
if(cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compType=="Nurture Program"){waitMsg.update('<b>Cloning Nurture Cadences:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);APP.cloneNurtureCadence(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId);}
waitMsg.update('<b>Cloning Smart Campaign States:</b>  <i>'+currOrigProgramTreeNode.text+waitMsgAffix);getNewProgramAssetDetailsResponse=APP.cloneSmartCampaignState(currOrigProgramTreeNode.compId,cloneProgramResponse.JSONResults.actions[0].parameters[0][0].compId,scForceActivate);APP.setProgramReportFilter(getNewProgramAssetDetailsResponse,cloneToFolderId);}}
APP.reloadMarketingActivites();waitMsg.close();}},0);});massCloneForm.show();massCloneForm.setWidth(525);massCloneForm.setHeight(530);massCloneForm.items.last().setText("Programs that have a folder depth greater than 2 will not be cloned.");massCloneForm.items.last().setVisible(true);periodCostMonthField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; Months:";periodCostMonthField.label.setVisible(false);periodCostOffsetField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; Cost Offset (+/-):";periodCostOffsetField.label.setVisible(false);tagValueField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; New Tag Value:";tagValueField.label.setVisible(false);customTags=APP.getTags();currCustomTagName=tagNameField.store.data.items[0].copy(0);currCustomTagValue=tagValueField.store.data.items[0].copy(0);tagNameField.store.removeAll(true);tagValueField.store.removeAll(true);var isCustomTags=window.setInterval(function(){if(customTags){window.clearInterval(isCustomTags);for(var ii=0;ii<customTags.length;ii++){currCustomTag=customTags[ii];currCustomTagName=currCustomTagName.copy(currCustomTag.name);currCustomTagName.set("text",currCustomTag.name);currCustomTagName.data.id=currCustomTag.name;tagNameField.store.add(currCustomTagName);for(var jj=0;jj<currCustomTag.values.length;jj++){currCustomTagValue=currCustomTagValue.copy(currCustomTag.values[jj].value);currCustomTagValue.set("text",currCustomTag.values[jj].value);currCustomTagValue.data.id=currCustomTag.values[jj].value;tagValueField.store.add(currCustomTagValue);}}}},0);}},0);});}
if(this.get(massCloneItemId)){if((this.currNode.attributes.compType=="Marketing Folder"&&!this.currNode.attributes.marketingProgramId&&currExpNode&&currExpNode.isExpandable())||(this.currNode.attributes.compType=="Marketing Program"||this.currNode.attributes.compType=="Nurture Program"||this.currNode.attributes.compType=="Marketing Event"||this.currNode.attributes.compType=="Email Batch Program"||this.currNode.attributes.compType=="In-App Program")){this.get(massCloneItemId).setVisible(true);}else{this.get(massCloneItemId).setVisible(false);}}else if((this.currNode.attributes.compType=="Marketing Folder"&&!this.currNode.attributes.marketingProgramId&&currExpNode&&currExpNode.isExpandable())||(this.currNode.attributes.compType=="Marketing Program"||this.currNode.attributes.compType=="Nurture Program"||this.currNode.attributes.compType=="Marketing Event"||this.currNode.attributes.compType=="Email Batch Program"||this.currNode.attributes.compType=="In-App Program")){this.addItem(massCloneItem);}}};if(typeof(Ext)!=="undefined"&&Ext&&Ext.menu&&Ext.menu.Menu&&Ext.menu.Menu.prototype&&Ext.menu.Menu.prototype.showAt){console.log("Marketo Demo App > Executing: Applying Mass Clone Menu Item");if(!origMenuShowAtFunc){origMenuShowAtFunc=Ext.menu.Menu.prototype.showAt;}
