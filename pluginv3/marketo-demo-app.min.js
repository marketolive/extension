...
APP.overlayLandingPage = function (action) {
    ...
    if (logo != null) {
        company = logo.split("https:companyName=company.charAt(0).toUpperCase()+company.slice(1);mktoMainText=companyName+" Invites "+mktoMainText;}else{mktoMainText="We Invite "+mktoMainText;}
