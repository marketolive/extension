...
APP.reloadMarketingActivites();waitMsg.close();}},0);});massCloneForm.show();showMoreOptionsField.onSelect(showMoreOptionsField.findRecord("text","No"));scActivationField.onSelect(scActivationField.findRecord("text","Inherit State"));periodCostCloneField.onSelect(periodCostCloneField.findRecord("text","Inherit Data"));massCloneForm.setWidth(525);massCloneForm.setHeight(560);massCloneForm.items.last().setText("Programs that have a folder depth greater than 2 will not be cloned.");massCloneForm.items.last().setVisible(true);tagValueField.label.setVisible(false);tagNameField.label.setVisible(false);periodCostMonthField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; Months:";periodCostMonthField.label.setVisible(false);periodCostOffsetField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; Cost Offset (+/-):";periodCostOffsetField.label.setVisible(false);tagValueField.label.dom.innerHTML="&nbsp;&nbsp;&nbsp; New Tag Value:";periodCostCloneField.label.setVisible(false);scActivationField.label.setVisible(false);currCustomTagName=tagNameField.store.data.items[0].copy(0);currCustomTagValue=tagValueField.store.data.items[0].copy(0);tagNameField.store.removeAll(true);tagValueField.store.removeAll(true);}},0);});}
