...
PODS.Pod = function(id) {
    ...
    switch (this.id) {
        case "app-sjp":
            ...
            this.funnelAnalysis = this.appUrl + "?preview=true&approved=true/#RCM39B2!";
            //        this.valueSet[0].url = this.appUrl+'?preview=true&approved=true/#RCM39A1!';
        ...
        case "app-ab07":
            ...
            //        this.valueSet[0].url = this.appUrl+'#RCM5A1!';
        ...
        case "app-ab08":
            this.intelligentNurturing = this.appUrl + "#NP5170B2";
            this.funnelAnalysis = this.appUrl + "#RCM5A1!";
            //        this.valueSet[0].url = this.appUrl+'?preview=true&approved=true/#RCM5A1!';
