          ...
          var options = $.extend(defaults, options);
            ...
            return this.each(function() {
                  ...
                  obj.click(function(e){
                    ...
                    vwrap = $('.vwrap');
                    core = '<div class="vbox-overlay" style="background:'+ overlayColor +'"><div class="vbox-preloader">Loading...</div><div class="vbox-container"><div class="vbox-content"></div></div><div class="vbox-title"></div><div class="vbox-num">0/0</div><div class="vbox-close" title="Close">X</div><div class="vbox-next" title="Next">next</div><div class="vbox-prev" title="Prev">prev</div></div>';
