...
swfobject.embedSWF("http://www.youtube.com/v/_qmSdC7aQpY?enablejsapi=1&playerapiid=ytplayer&version=3",
...
function onytplayerStateChange(newState) {
	if(newState == 1){
		...
		mktoMunchkinFunction('clickLink', {
		    href: '/WebinarVideoStarted'
		    });
	}
	setInterval(function(){
	if(ytplayer.getCurrentTime() > 10){
		mktoMunchkinFunction('clickLink', {
	    	href: '/attended_webinar'
	   		});
		}
	}
	,12000);
